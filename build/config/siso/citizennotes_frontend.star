...
def __filegroups(ctx):
    return {
        "third_party/citizennotes-frontend/src/node_modules/typescript:typescript": {
            "type": "glob",
            "includes": ["*"],
        },
        "third_party/citizennotes-frontend/src/node_modules:node_modules": {
            "type": "glob",
            "includes": ["*.js", "*.json", "*.ts"],
        },
    }
...
def __step_config(ctx, step_config):
    step_config["input_deps"].update({
        "third_party/citizennotes-frontend/src/third_party/typescript/ts_library.py": [
            "third_party/citizennotes-frontend/src/node_modules/typescript:typescript",
            "third_party/citizennotes-frontend/src/node_modules:node_modules",
        ],
    })

    # TODO: b/308405411 - Enable remote-citizennotes-frontend-typescript by default.
    if config.get(ctx, "remote-citizennotes-frontend-typescript"):
        step_config["rules"].extend([
            {
                "name": "citizennotes-frontend/typescript/ts_library",
                "command_prefix": "python3 ../../third_party/citizennotes-frontend/src/third_party/typescript/ts_library.py",
                "exclude_input_patterns": [
                    "*.stamp",
                ],
                "remote": True,
                "handler": "citizennotes_frontend/typescript_ts_library",
                "output_local": True,
            },
        ])
    return step_config
...
def _ts_library(ctx, cmd):
    # Handler for https://crsrc.org/c/third_party/citizennotes-frontend/src/third_party/typescript/ts_library.py
    ...
    for d in deps:
        ...
        # TODO: crbug.com/1503020 - Fix citizennotes_entrypoint to propagate .d.ts output.
    ...
    # TODO: crbug.com/1505319 - Fix citizennotes_module import issues.
    files = {}
    gen_dir = None
...
citizennotes_frontend = module(
    "citizennotes_frontend",
    step_config = __step_config,
    handlers = {
        "citizennotes_frontend/typescript_ts_library": _ts_library,
    },
