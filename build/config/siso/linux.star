...
load("./citizennotes_frontend.star", "citizennotes_frontend")
...
def __filegroups(ctx):
    ...
    fg.update(citizennotes_frontend.filegroups(ctx))
...
__handlers.update(citizennotes_frontend.handlers)
...
def __step_config(ctx, step_config):
    ...
    step_config = citizennotes_frontend.step_config(ctx, step_config)
    step_config = nacl.step_config(ctx, step_config)
