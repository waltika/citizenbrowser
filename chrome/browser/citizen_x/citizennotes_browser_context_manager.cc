...
CitizenNotesBrowserContextManager::CitizenNotesBrowserContextManager() {}

CitizenNotesBrowserContextManager::~CitizenNotesBrowserContextManager() = default;

// static
CitizenNotesBrowserContextManager& CitizenNotesBrowserContextManager::GetInstance() {
  static base::NoDestructor<CitizenNotesBrowserContextManager> instance;
  return *instance;
}

Profile* CitizenNotesBrowserContextManager::GetProfileById(
...
content::BrowserContext* CitizenNotesBrowserContextManager::CreateBrowserContext() {
  Profile* original_profile =
      ProfileManager::GetLastUsedProfile()->GetOriginalProfile();

  Profile* otr_profile = original_profile->GetOffTheRecordProfile(
      Profile::OTRProfileID::CreateUniqueForCitizenNotes(),
...
CitizenNotesBrowserContextManager::GetBrowserContexts() {
...
CitizenNotesBrowserContextManager::GetDefaultBrowserContext() {
