...
CitizenNotesContentsResizingStrategy::CitizenNotesContentsResizingStrategy()
...
void CitizenNotesContentsResizingStrategy::CopyFrom(
...
bool CitizenNotesContentsResizingStrategy::Equals(
    const CitizenNotesContentsResizingStrategy& strategy) {
...
void ApplyCitizenNotesContentsResizingStrategy(
  ...
  new_citizennotes_bounds->SetRect(
