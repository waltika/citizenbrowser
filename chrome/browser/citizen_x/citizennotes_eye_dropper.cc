...
CitizenNotesEyeDropper::CitizenNotesEyeDropper(content::WebContents* web_contents,
  ...
  mouse_event_callback_ = base::BindRepeating(
      &CitizenNotesEyeDropper::HandleMouseEvent, base::Unretained(this));
  if (web_contents->GetPrimaryMainFrame()->IsRenderFrameLive())
    AttachToHost(web_contents->GetPrimaryMainFrame());
}

CitizenNotesEyeDropper::~CitizenNotesEyeDropper() {
  if (host_) {
...
void CitizenNotesEyeDropper::AttachToHost(content::RenderFrameHost* frame_host) {
...
void CitizenNotesEyeDropper::DetachFromHost() {
...
void CitizenNotesEyeDropper::RenderFrameCreated(
...
void CitizenNotesEyeDropper::RenderFrameDeleted(
    content::RenderFrameHost* frame_host) {
...
void CitizenNotesEyeDropper::RenderFrameHostChanged(
...
void CitizenNotesEyeDropper::ResetFrame() {
  frame_.reset();
  last_cursor_x_ = -1;
  last_cursor_y_ = -1;
}

bool CitizenNotesEyeDropper::HandleMouseEvent(const blink::WebMouseEvent& event) {
...
void CitizenNotesEyeDropper::UpdateCursor() {
...
void CitizenNotesEyeDropper::OnFrameCaptured(
...
void CitizenNotesEyeDropper::OnNewSubCaptureTargetVersion(
    uint32_t sub_capture_target_version) {}

void CitizenNotesEyeDropper::OnFrameWithEmptyRegionCapture() {}

void CitizenNotesEyeDropper::OnStopped() {}
