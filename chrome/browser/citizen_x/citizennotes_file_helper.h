...
#ifndef CHROME_BROWSER_CITIZENNOTES_CITIZENNOTES_FILE_HELPER_H_
#define CHROME_BROWSER_CITIZENNOTES_CITIZENNOTES_FILE_HELPER_H_
...
class CitizenNotesFileHelper {
 public:
  ...
  CitizenNotesFileHelper(content::WebContents* web_contents, Profile* profile,
                     Delegate* delegate);

  CitizenNotesFileHelper(const CitizenNotesFileHelper&) = delete;
  CitizenNotesFileHelper& operator=(const CitizenNotesFileHelper&) = delete;

  ~CitizenNotesFileHelper();
 ...
 private:
  ...
  RAW_PTR_EXCLUSION CitizenNotesFileHelper::Delegate* delegate_;
  typedef std::map<std::string, base::FilePath> PathsMap;
  PathsMap saved_files_;
  PrefChangeRegistrar pref_change_registrar_;
  using PathToType = std::map<std::string, std::string>;
  PathToType file_system_paths_;
  std::unique_ptr<CitizenNotesFileWatcher, CitizenNotesFileWatcher::Deleter>
      file_watcher_;
  scoped_refptr<base::SequencedTaskRunner> file_task_runner_;
  base::WeakPtrFactory<CitizenNotesFileHelper> weak_factory_{this};
};

#endif  // CHROME_BROWSER_CITIZENNOTES_CITIZENNOTES_FILE_HELPER_H_
