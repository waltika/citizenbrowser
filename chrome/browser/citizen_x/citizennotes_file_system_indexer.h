...
#ifndef CHROME_BROWSER_CITIZENNOTES_CITIZENNOTES_FILE_SYSTEM_INDEXER_H_
#define CHROME_BROWSER_CITIZENNOTES_CITIZENNOTES_FILE_SYSTEM_INDEXER_H_
...
class CitizenNotesFileSystemIndexer
    : public base::RefCountedThreadSafe<CitizenNotesFileSystemIndexer> {
 public:
  ...
  class FileSystemIndexingJob
   ...
   private:
    ...
    friend class CitizenNotesFileSystemIndexer;
  ...
  CitizenNotesFileSystemIndexer();

  CitizenNotesFileSystemIndexer(const CitizenNotesFileSystemIndexer&) = delete;
  CitizenNotesFileSystemIndexer& operator=(const CitizenNotesFileSystemIndexer&) =
      delete;
 ...
 private:
  friend class base::RefCountedThreadSafe<CitizenNotesFileSystemIndexer>;

  virtual ~CitizenNotesFileSystemIndexer();
...
#endif  // CHROME_BROWSER_CITIZENNOTES_CITIZENNOTES_FILE_SYSTEM_INDEXER_H_
