...
// CitizenNotesFileWatcher::SharedFileWatcher --------------------------------------

class CitizenNotesFileWatcher::SharedFileWatcher
    : public base::RefCounted<SharedFileWatcher>,
      public base::trace_event::MemoryDumpProvider {
 public:
  SharedFileWatcher();

  void AddListener(CitizenNotesFileWatcher* watcher);
  void RemoveListener(CitizenNotesFileWatcher* watcher);
 ...
 private:
  ...
  std::vector<CitizenNotesFileWatcher*> listeners_;
...
CitizenNotesFileWatcher::SharedFileWatcher::SharedFileWatcher()
    : last_dispatch_cost_(base::Milliseconds(kDefaultThrottleTimeout)) {
  CitizenNotesFileWatcher::s_shared_watcher_ = this;
  base::trace_event::MemoryDumpManager::GetInstance()
      ->RegisterDumpProviderWithSequencedTaskRunner(
          this, "CitizenNotes", base::SequencedTaskRunner::GetCurrentDefault(),
...
CitizenNotesFileWatcher::SharedFileWatcher::~SharedFileWatcher() {
  ...
  base::trace_event::MemoryDumpManager::GetInstance()->UnregisterDumpProvider(
      this);
  CitizenNotesFileWatcher::s_shared_watcher_ = nullptr;
}

bool CitizenNotesFileWatcher::SharedFileWatcher::OnMemoryDump(
    const base::trace_event::MemoryDumpArgs& args,
  ...
  for (auto& file_path : file_path_times_) {
    ...
    auto* dump = process_memory_dump->CreateAllocatorDump(
        base::StringPrintf("citizennotes/file_watcher_0x%x", index++));
...
void CitizenNotesFileWatcher::SharedFileWatcher::AddListener(
    CitizenNotesFileWatcher* watcher) {
  DCHECK_CALLED_ON_VALID_SEQUENCE(sequence_checker_);
  listeners_.push_back(watcher);
}

void CitizenNotesFileWatcher::SharedFileWatcher::RemoveListener(
    CitizenNotesFileWatcher* watcher) {
  DCHECK_CALLED_ON_VALID_SEQUENCE(sequence_checker_);
...
void CitizenNotesFileWatcher::SharedFileWatcher::AddWatch(
...
CitizenNotesFileWatcher::SharedFileWatcher::FilePathTimesMap
CitizenNotesFileWatcher::SharedFileWatcher::GetModificationTimes(
    const base::FilePath& path) {
...
void CitizenNotesFileWatcher::SharedFileWatcher::RemoveWatch(
    const base::FilePath& path) {
  DCHECK_CALLED_ON_VALID_SEQUENCE(sequence_checker_);
...
void CitizenNotesFileWatcher::SharedFileWatcher::DirectoryChanged(
    const base::FilePath& path,
    bool error) {
  DCHECK_CALLED_ON_VALID_SEQUENCE(sequence_checker_);
  ...
  base::SequencedTaskRunner::GetCurrentDefault()->PostDelayedTask(
      FROM_HERE,
      base::BindOnce(
          &CitizenNotesFileWatcher::SharedFileWatcher::DispatchNotifications, this),
      shedule_for);
  last_event_time_ = now;
}

void CitizenNotesFileWatcher::SharedFileWatcher::DispatchNotifications() {
  DCHECK_CALLED_ON_VALID_SEQUENCE(sequence_checker_);
...
// static
CitizenNotesFileWatcher::SharedFileWatcher* CitizenNotesFileWatcher::s_shared_watcher_;

// static
void CitizenNotesFileWatcher::Deleter::operator()(const CitizenNotesFileWatcher* ptr) {
  impl_task_runner()->PostTask(
      FROM_HERE,
      base::BindOnce(&CitizenNotesFileWatcher::Destroy, base::Unretained(ptr)));
}

CitizenNotesFileWatcher::CitizenNotesFileWatcher(
    WatchCallback callback,
    scoped_refptr<base::SequencedTaskRunner> callback_task_runner)
    : callback_(std::move(callback)),
      client_task_runner_(std::move(callback_task_runner)) {
  impl_task_runner()->PostTask(
      FROM_HERE, base::BindOnce(&CitizenNotesFileWatcher::InitSharedWatcher,
                                base::Unretained(this)));
}
...
void CitizenNotesFileWatcher::InitSharedWatcher() {
  if (!CitizenNotesFileWatcher::s_shared_watcher_)
    new SharedFileWatcher();
  shared_watcher_ = CitizenNotesFileWatcher::s_shared_watcher_;
  shared_watcher_->AddListener(this);
}

void CitizenNotesFileWatcher::AddWatch(base::FilePath path) {
  impl_task_runner()->PostTask(
      FROM_HERE, base::BindOnce(&CitizenNotesFileWatcher::AddWatchOnImpl,
                                base::Unretained(this), std::move(path)));
}

void CitizenNotesFileWatcher::RemoveWatch(base::FilePath path) {
  impl_task_runner()->PostTask(
      FROM_HERE, base::BindOnce(&CitizenNotesFileWatcher::RemoveWatchOnImpl,
                                base::Unretained(this), std::move(path)));
}

void CitizenNotesFileWatcher::AddWatchOnImpl(base::FilePath path) {
  shared_watcher_->AddWatch(std::move(path));
}

void CitizenNotesFileWatcher::RemoveWatchOnImpl(base::FilePath path) {
