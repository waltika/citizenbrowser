...
#ifndef CHROME_BROWSER_CITIZENNOTES_GLOBAL_CONFIRM_INFO_BAR_H_
#define CHROME_BROWSER_CITIZENNOTES_GLOBAL_CONFIRM_INFO_BAR_H_
...
// CNGlobalConfirmInfoBar is shown for every tab in every browser until it
...
class CNGlobalConfirmInfoBar : public TabStripModelObserver,
 ...
 public:
  ...
  static CNGlobalConfirmInfoBar* Show(
      std::unique_ptr<ConfirmInfoBarDelegate> delegate);

  CNGlobalConfirmInfoBar(const CNGlobalConfirmInfoBar&) = delete;
  CNGlobalConfirmInfoBar& operator=(const CNGlobalConfirmInfoBar&) = delete;
 ...
 private:
  ...
  explicit CNGlobalConfirmInfoBar(
      std::unique_ptr<ConfirmInfoBarDelegate> delegate);
  ~CNGlobalConfirmInfoBar() override;
  ...
  base::WeakPtrFactory<CNGlobalConfirmInfoBar> weak_factory_{this};
};

#endif  // CHROME_BROWSER_CITIZENNOTES_GLOBAL_CONFIRM_INFO_BAR_H_
