...
void CNAdbDeviceProvider::QueryDeviceInfo(const std::string& serial,
                                        DeviceInfoCallback callback) {
  CNAndroidDeviceManager::QueryDeviceInfo(base::BindOnce(&RunCommand, serial),
                                        std::move(callback));
}

void CNAdbDeviceProvider::OpenSocket(const std::string& serial,
...
CNAdbDeviceProvider::~CNAdbDeviceProvider() {
}
