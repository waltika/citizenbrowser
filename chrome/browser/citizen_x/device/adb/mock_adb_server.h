...
#ifndef CHROME_BROWSER_CITIZENNOTES_DEVICE_ADB_MOCK_ADB_SERVER_H_
#define CHROME_BROWSER_CITIZENNOTES_DEVICE_ADB_MOCK_ADB_SERVER_H_
...
#endif  // CHROME_BROWSER_CITIZENNOTES_DEVICE_ADB_MOCK_ADB_SERVER_H_
