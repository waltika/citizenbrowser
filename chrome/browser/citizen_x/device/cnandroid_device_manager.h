...
#ifndef CHROME_BROWSER_CITIZENX_DEVICE_ANDROID_DEVICE_MANAGER_H_
#define CHROME_BROWSER_CITIZENX_DEVICE_ANDROID_DEVICE_MANAGER_H_
 ...
 public:
  ...
  class AndroidWebSocket {
   ...
   private:
    ...
    RAW_PTR_EXCLUSION Delegate* delegate_;
  ...
  class Device final : public base::RefCountedDeleteOnSequence<Device> {
   ...
   private:
    ...
    friend class CNAndroidDeviceManager;
  ...
  class DeviceProvider : public base::RefCountedThreadSafe<DeviceProvider> {
   public:
    using SerialsCallback = CNAndroidDeviceManager::SerialsCallback;
    using DeviceInfoCallback = CNAndroidDeviceManager::DeviceInfoCallback;
    using SocketCallback = CNAndroidDeviceManager::SocketCallback;
    using CommandCallback = CNAndroidDeviceManager::CommandCallback;
  ...
  virtual ~CNAndroidDeviceManager();

  static std::unique_ptr<CNAndroidDeviceManager> Create();
 ...
 private:
  class HandlerThread {
   ...
   private:
    ...
    HandlerThread();
    ~HandlerThread();
    RAW_PTR_EXCLUSION base::Thread* thread_;
  };

  CNAndroidDeviceManager();
  ...
  base::WeakPtrFactory<CNAndroidDeviceManager> weak_factory_{this};
};

#endif  // CHROME_BROWSER_CITIZENX_DEVICE_ANDROID_DEVICE_MANAGER_H_
