...
#ifndef CHROME_BROWSER_CITIZENNOTES_PROTOCOL_AUTOFILL_HANDLER_H_
#define CHROME_BROWSER_CITIZENNOTES_PROTOCOL_AUTOFILL_HANDLER_H_
...
class CNAutofillHandler : public protocol::Autofill::Backend,
                        autofill::AutofillManager::Observer {
 public:
  CNAutofillHandler(protocol::UberDispatcher* dispatcher,
                  const std::string& target_id);

  CNAutofillHandler(const CNAutofillHandler&) = delete;
  CNAutofillHandler& operator=(const CNAutofillHandler&) = delete;

  ~CNAutofillHandler() override;
 ...
 private:
  ...
  autofill::ScopedAutofillManagersObservation autofill_managers_observation_{
      this};
  base::WeakPtrFactory<CNAutofillHandler> weak_ptr_factory_{this};
};

#endif  // CHROME_BROWSER_CITIZENNOTES_PROTOCOL_AUTOFILL_HANDLER_H_
