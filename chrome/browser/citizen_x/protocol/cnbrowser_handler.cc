...
CNBrowserHandler::CNBrowserHandler(protocol::UberDispatcher* dispatcher,
...
Response CNBrowserHandler::GetWindowForTarget(
...
Response CNBrowserHandler::GetWindowBounds(
    int window_id,
    std::unique_ptr<protocol::Browser::Bounds>* out_bounds) {
...
Response CNBrowserHandler::Close() {
  ChromeCitizenNotesManagerDelegate::CloseBrowserSoon();
  return Response::Success();
}

Response CNBrowserHandler::SetWindowBounds(
    int window_id,
...
protocol::Response CNBrowserHandler::SetDockTile(
...
protocol::Response CNBrowserHandler::ExecuteBrowserCommand(
