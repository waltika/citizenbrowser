...
#ifndef CHROME_BROWSER_CITIZENNOTES_PROTOCOL_BROWSER_HANDLER_H_
...
class CNBrowserHandler : public protocol::Browser::Backend {
 public:
  CNBrowserHandler(protocol::UberDispatcher* dispatcher,
...
#endif  // CHROME_BROWSER_CITIZENNOTES_PROTOCOL_BROWSER_HANDLER_H_
