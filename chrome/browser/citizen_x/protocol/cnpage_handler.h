...
#ifndef CHROME_BROWSER_CITIZENNOTES_PROTOCOL_PAGE_HANDLER_H_
#define CHROME_BROWSER_CITIZENNOTES_PROTOCOL_PAGE_HANDLER_H_
...
class CNPageHandler : public protocol::Page::Backend {
 public:
  CNPageHandler(scoped_refptr<content::CitizenNotesAgentHost> agent_host,
 ...
 private:
  ...
  base::WeakPtrFactory<CNPageHandler> weak_ptr_factory_{this};
};

#endif  // CHROME_BROWSER_CITIZENNOTES_PROTOCOL_PAGE_HANDLER_H_
