...
#ifndef CHROME_BROWSER_CITIZENNOTES_PROTOCOL_TARGET_HANDLER_H_
#define CHROME_BROWSER_CITIZENNOTES_PROTOCOL_TARGET_HANDLER_H_

#include <set>

#include "chrome/browser/citizen_x/protocol/target.h"
...
class CNTargetHandler : public protocol::Target::Backend {
 public:
  CNTargetHandler(protocol::UberDispatcher* dispatcher, bool is_trusted);
...
#endif  // CHROME_BROWSER_CITIZENNOTES_PROTOCOL_TARGET_HANDLER_H_
