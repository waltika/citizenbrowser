...
#ifndef CHROME_BROWSER_EXTENSIONS_CITIZENNOTES_UTIL_H_
#define CHROME_BROWSER_EXTENSIONS_CITIZENNOTES_UTIL_H_
...
#endif  // CHROME_BROWSER_EXTENSIONS_CITIZENNOTES_UTIL_H_
