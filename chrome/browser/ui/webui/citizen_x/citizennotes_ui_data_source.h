...
#ifndef CHROME_BROWSER_UI_WEBUI_CITIZENNOTES_CITIZENNOTES_UI_DATA_SOURCE_H_
#define CHROME_BROWSER_UI_WEBUI_CITIZENNOTES_CITIZENNOTES_UI_DATA_SOURCE_H_
...
class CitizenNotesDataSource : public content::URLDataSource {
 public:
  ...
  explicit CitizenNotesDataSource(
      scoped_refptr<network::SharedURLLoaderFactory> url_loader_factory);

  CitizenNotesDataSource(const CitizenNotesDataSource&) = delete;
  CitizenNotesDataSource& operator=(const CitizenNotesDataSource&) = delete;

  ~CitizenNotesDataSource() override;
...
#endif  // CHROME_BROWSER_UI_WEBUI_CITIZENNOTES_CITIZENNOTES_UI_DATA_SOURCE_H_
