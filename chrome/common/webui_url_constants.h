...
extern const char kChromeUICitizenNotesBlankPath[];
extern const char kChromeUIDevToolsBundledPath[];
extern const char kChromeUICitizenNotesBundledPath[];
extern const char kChromeUIDevToolsCustomPath[];
extern const char kChromeUICitizenNotesCustomPath[];
extern const char kChromeUIDevToolsHost[];
extern const char kChromeUICitizenNotesHost[];
extern const char kChromeUIDevToolsRemotePath[];
extern const char kChromeUICitizenNotesRemotePath[];
