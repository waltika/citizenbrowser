...
function checkTarget(targets, url, type, opt_title, opt_faviconUrl) {
  ...
  var wsAddress = REMOTE_DEBUGGER_HOST + '/citizennotes/page/' + target.id;

  chrome.test.assertEq(
      '/citizennotes/inspector.html?ws=' + wsAddress,
      target.citizennotesFrontendUrl);
...
function runNewPageTest(citizennotesUrl, expectedUrl) {
  var json;
  var newTab;
  var pendingCount = 2;
...
var extensionTabId;
var extensionCitizennotesFrontendUrl;
...
chrome.test.runTests([
    ...
    waitForTab(
        ...
        function() {
          requestUrl('/json', function(text) {
            ...
            extensionCitizennotesFrontendUrl = target.citizennotesFrontendUrl;
  ...
  function checkDebuggerUI() {
    requestUrl(extensionCitizennotesFrontendUrl, function(text) {
