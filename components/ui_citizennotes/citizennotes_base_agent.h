...
#ifndef COMPONENTS_UI_CITIZENNOTES_CITIZENNOTES_BASE_AGENT_H_
#define COMPONENTS_UI_CITIZENNOTES_CITIZENNOTES_BASE_AGENT_H_

#include "components/ui_citizennotes/protocol.h"

namespace ui_citizennotes {

class UiCitizenNotesAgent {
 public:
  UiCitizenNotesAgent() {}
  virtual ~UiCitizenNotesAgent() {}
...
class UiCitizenNotesBaseAgent : public UiCitizenNotesAgent,
                            public DomainMetainfo::BackendClass {
 public:
  UiCitizenNotesBaseAgent(const UiCitizenNotesBaseAgent&) = delete;
  UiCitizenNotesBaseAgent& operator=(const UiCitizenNotesBaseAgent&) = delete;
 ...
 protected:
  UiCitizenNotesBaseAgent() = default;
...
#endif  // COMPONENTS_UI_CITIZENNOTES_CITIZENNOTES_BASE_AGENT_H_
