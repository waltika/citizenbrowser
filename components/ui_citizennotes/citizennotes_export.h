...
#ifndef COMPONENTS_UI_CITIZENNOTES_CITIZENNOTES_EXPORT_H_
#define COMPONENTS_UI_CITIZENNOTES_CITIZENNOTES_EXPORT_H_
...
#endif  // COMPONENTS_UI_CITIZENNOTES_CITIZENNOTES_EXPORT_H_
