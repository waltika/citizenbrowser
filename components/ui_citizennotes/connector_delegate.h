...
#ifndef COMPONENTS_UI_CITIZENNOTES_CONNECTOR_DELEGATE_H_
#define COMPONENTS_UI_CITIZENNOTES_CONNECTOR_DELEGATE_H_
...
#endif  // COMPONENTS_UI_CITIZENNOTES_CONNECTOR_DELEGATE_H_
