...
#include "components/ui_citizennotes/ui_citizennotes_features.h"
...
bool FindMatchInStylesProperty(const std::string& query,
                               ui_citizennotes::UIElement* node) {
...
bool FindMatchByID(const std::string& query, ui_citizennotes::UIElement* node) {
