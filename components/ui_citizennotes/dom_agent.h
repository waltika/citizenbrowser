...
#ifndef COMPONENTS_UI_CITIZENNOTES_DOM_AGENT_H_
#define COMPONENTS_UI_CITIZENNOTES_DOM_AGENT_H_
...
class UI_CITIZENNOTES_EXPORT DOMAgent
    : public UiCitizenNotesBaseAgent<protocol::DOM::Metainfo>,
...
#endif  // COMPONENTS_UI_CITIZENNOTES_DOM_AGENT_H_
