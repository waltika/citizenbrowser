...
#ifndef COMPONENTS_UI_CITIZENNOTES_ROOT_ELEMENT_H_
#define COMPONENTS_UI_CITIZENNOTES_ROOT_ELEMENT_H_

#include "components/ui_citizennotes/ui_element.h"

namespace ui_citizennotes {

class UI_CITIZENNOTES_EXPORT RootElement : public UIElement {
 public:
...
#endif  // COMPONENTS_UI_CITIZENNOTES_ROOT_ELEMENT_H_
