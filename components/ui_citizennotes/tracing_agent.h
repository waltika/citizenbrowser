...
#ifndef COMPONENTS_UI_CITIZENNOTES_TRACING_AGENT_H_
#define COMPONENTS_UI_CITIZENNOTES_TRACING_AGENT_H_
...
#include "components/ui_citizennotes/tracing.h"
...
// This class is used for tracing in the ui_citizennotes performance panel.
// A lot of the code is based on TracingHandler from
// content/browser/citizen_x/protocol/tracing_handler.h.
class UI_CITIZENNOTES_EXPORT TracingAgent
    : public UiCitizenNotesBaseAgent<protocol::Tracing::Metainfo> {
 public:
 ...
 private:
  class CitizenNotesTraceEndpointProxy;
  ...
  // Edits tracing data to use the normal citizennotes frontend logic to display
  // the performance metrics. Without this, it will use the citizennotes generic
  ...
  // consumer.
  void StopTracing(const scoped_refptr<CitizenNotesTraceEndpointProxy>& endpoint,
...
#endif  // COMPONENTS_UI_CITIZENNOTES_TRACING_AGENT_H_
