...
#ifndef COMPONENTS_UI_CITIZENNOTES_UI_ELEMENT_H_
#define COMPONENTS_UI_CITIZENNOTES_UI_ELEMENT_H_
...
class UI_CITIZENNOTES_EXPORT UIElement {
 public:
  struct UI_CITIZENNOTES_EXPORT UIProperty {
  ...
  struct UI_CITIZENNOTES_EXPORT ClassProperties {
  ...
  struct UI_CITIZENNOTES_EXPORT Source {
 ...
 private:
  ...
  RAW_PTR_EXCLUSION UIElement* parent_;
  RAW_PTR_EXCLUSION UIElementDelegate* delegate_;
...
#endif  // COMPONENTS_UI_CITIZENNOTES_UI_ELEMENT_H_
