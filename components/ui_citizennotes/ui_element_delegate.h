...
#ifndef COMPONENTS_UI_CITIZENNOTES_UI_ELEMENT_DELEGATE_H_
#define COMPONENTS_UI_CITIZENNOTES_UI_ELEMENT_DELEGATE_H_
...
#endif  // COMPONENTS_UI_CITIZENNOTES_UI_ELEMENT_DELEGATE_H_
