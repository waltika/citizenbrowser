...
#ifndef CONTENT_BROWSER_CITIZENNOTES_CITIZENNOTES_IO_CONTEXT_H_
#define CONTENT_BROWSER_CITIZENNOTES_CITIZENNOTES_IO_CONTEXT_H_
...
class CitizenNotesIOContext : public base::SupportsWeakPtr<CitizenNotesIOContext> {
 public:
  class Stream : public base::RefCountedDeleteOnSequence<Stream> {
   ...
   protected:
    friend class base::DeleteHelper<content::CitizenNotesIOContext::Stream>;
    ...
    void Register(CitizenNotesIOContext* context, const std::string& handle);
    // We generate handle for the caller and return it.
    std::string Register(CitizenNotesIOContext* context);
  };

  CitizenNotesIOContext();
  ~CitizenNotesIOContext();
...
#endif  // CONTENT_BROWSER_CITIZENNOTES_CITIZENNOTES_IO_CONTEXT_H_
