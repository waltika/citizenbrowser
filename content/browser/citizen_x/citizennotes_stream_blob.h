...
#ifndef CONTENT_BROWSER_CITIZENNOTES_CITIZENNOTES_STREAM_BLOB_H_
#define CONTENT_BROWSER_CITIZENNOTES_CITIZENNOTES_STREAM_BLOB_H_
...
class CitizenNotesStreamBlob : public CitizenNotesIOContext::Stream {
 public:
  using OpenCallback = base::OnceCallback<void(bool)>;

  static scoped_refptr<CitizenNotesIOContext::Stream> Create(
 ...
 private:
  ...
  ~CitizenNotesStreamBlob() override;
...
#endif  // CONTENT_BROWSER_CITIZENNOTES_CITIZENNOTES_STREAM_BLOB_H_
