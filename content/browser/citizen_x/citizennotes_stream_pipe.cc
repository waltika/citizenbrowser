...
struct CitizenNotesStreamPipe::ReadRequest {
  ReadRequest() = delete;
...
// static
scoped_refptr<CitizenNotesStreamPipe> CitizenNotesStreamPipe::Create(
    CitizenNotesIOContext* context,
    mojo::ScopedDataPipeConsumerHandle pipe,
    bool is_binary) {
  return new CitizenNotesStreamPipe(context, std::move(pipe), is_binary);
}

CitizenNotesStreamPipe::CitizenNotesStreamPipe(CitizenNotesIOContext* context,
                                       mojo::ScopedDataPipeConsumerHandle pipe,
                                       bool is_binary)
    : CitizenNotesIOContext::Stream(base::SequencedTaskRunner::GetCurrentDefault()),
  ...
  MojoResult res = pipe_watcher_.Watch(
      ...
      base::BindRepeating(&CitizenNotesStreamPipe::OnPipeSignalled,
                          base::Unretained(this)));
  DCHECK_EQ(MOJO_RESULT_OK, res);
}

CitizenNotesStreamPipe::~CitizenNotesStreamPipe() = default;

bool CitizenNotesStreamPipe::SupportsSeek() const {
  return false;
}

void CitizenNotesStreamPipe::Read(off_t position,
                              size_t max_size,
...
void CitizenNotesStreamPipe::OnPipeSignalled(
    MojoResult result,
...
void CitizenNotesStreamPipe::DispatchResponse() {
...
void CitizenNotesStreamPipe::DispatchEOFOrError(bool is_eof) {
