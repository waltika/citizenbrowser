...
CNInterceptedRequestInfo::CNInterceptedRequestInfo() = default;

CNInterceptedRequestInfo::~CNInterceptedRequestInfo() = default;

CitizenNotesURLLoaderInterceptor::AuthChallengeResponse::AuthChallengeResponse(
...
CitizenNotesURLLoaderInterceptor::FilterEntry::FilterEntry(
...
CitizenNotesURLLoaderInterceptor::FilterEntry::FilterEntry(FilterEntry&&) = default;
CitizenNotesURLLoaderInterceptor::FilterEntry::~FilterEntry() = default;

CitizenNotesURLLoaderInterceptor::Modifications::Modifications() = default;

CitizenNotesURLLoaderInterceptor::Modifications::Modifications(
...
CitizenNotesURLLoaderInterceptor::Pattern::~Pattern() = default;

CitizenNotesURLLoaderInterceptor::Pattern::Pattern(const Pattern& other) = default;

CitizenNotesURLLoaderInterceptor::Pattern::Pattern(
...
bool CitizenNotesURLLoaderInterceptor::Pattern::Matches(
...
using RequestInterceptedCallback =
    CitizenNotesURLLoaderInterceptor::RequestInterceptedCallback;
...
using TakeResponseBodyPipeCallback =
    CitizenNotesURLLoaderInterceptor::TakeResponseBodyPipeCallback;
using Modifications = CitizenNotesURLLoaderInterceptor::Modifications;
using InterceptionStage = CitizenNotesURLLoaderInterceptor::InterceptionStage;
...
class CNInterceptionJob : public network::mojom::URLLoaderClient,
                        public network::mojom::URLLoader {
 public:
  static CNInterceptionJob* FindByRequestId(
      const GlobalRequestID& global_req_id) {
    const auto& map = GetCNInterceptionJobMap();
    auto it = map.find(global_req_id);
    return it == map.end() ? nullptr : it->second;
  }

  CNInterceptionJob(
      CitizenNotesURLLoaderInterceptor* interceptor,
      const std::string& id,
  ...
  CNInterceptionJob(const CNInterceptionJob&) = delete;
  CNInterceptionJob& operator=(const CNInterceptionJob&) = delete;
  ...
  void OnAuthRequest(
      ...
      CitizenNotesURLLoaderInterceptor::HandleAuthRequestCallback callback);

 private:
  static std::map<GlobalRequestID, CNInterceptionJob*>& GetCNInterceptionJobMap() {
    static base::NoDestructor<std::map<GlobalRequestID, CNInterceptionJob*>> inst;
    return *inst;
  }

  ~CNInterceptionJob() override {
    if (registered_in_global_request_map_) {
      size_t erased = GetCNInterceptionJobMap().erase(global_req_id_);
  ...
  void ProcessAuthResponse(
      const CitizenNotesURLLoaderInterceptor::AuthChallengeResponse&
  ...
  std::unique_ptr<CNInterceptedRequestInfo> BuildRequestInfo(
      const network::mojom::URLResponseHeadPtr& head);
  void NotifyClient(std::unique_ptr<CNInterceptedRequestInfo> request_info);
  void FetchCookies(
      network::mojom::CookieManager::GetCookieListCallback callback);
  void NotifyClientWithCookies(
      std::unique_ptr<CNInterceptedRequestInfo> request_info,
  ...
  RAW_PTR_EXCLUSION CitizenNotesURLLoaderInterceptor* interceptor_;
  ...
  CitizenNotesURLLoaderInterceptor::HandleAuthRequestCallback
...
void CitizenNotesURLLoaderInterceptor::CreateJob(
    const base::UnguessableToken& frame_token,
    int32_t process_id,
    bool is_download,
    const absl::optional<std::string>& renderer_request_id,
...
InterceptionStage CitizenNotesURLLoaderInterceptor::GetInterceptionStage(
    const GURL& url,
    blink::mojom::ResourceType resource_type) const {
  InterceptionStage stage = InterceptionStage::DONT_INTERCEPT;
  std::string unused;
  std::string url_str = protocol::CNNetworkHandler::ExtractFragment(url, &unused);
...
class CitizenNotesURLLoaderFactoryProxy : public network::mojom::URLLoaderFactory {
 public:
  CitizenNotesURLLoaderFactoryProxy(
      const base::UnguessableToken& frame_token,
      int32_t process_id,
      bool is_download,
      ...
      mojo::PendingRemote<network::mojom::CookieManager> cookie_manager,
      base::WeakPtr<CitizenNotesURLLoaderInterceptor> interceptor);
  ~CitizenNotesURLLoaderFactoryProxy() override;
 ...
 private:
  ...
  mojo::Remote<network::mojom::URLLoaderFactory> target_factory_;
  mojo::Remote<network::mojom::CookieManager> cookie_manager_;
  base::WeakPtr<CitizenNotesURLLoaderInterceptor> interceptor_;
...
CitizenNotesURLLoaderFactoryProxy::CitizenNotesURLLoaderFactoryProxy(
    const base::UnguessableToken& frame_token,
    int32_t process_id,
    bool is_download,
    mojo::PendingReceiver<network::mojom::URLLoaderFactory> loader_receiver,
  ...
  target_factory_.set_disconnect_handler(
      base::BindOnce(&CitizenNotesURLLoaderFactoryProxy::OnTargetFactoryError,
                     base::Unretained(this)));

  receivers_.Add(this, std::move(loader_receiver));
  receivers_.set_disconnect_handler(
      base::BindRepeating(&CitizenNotesURLLoaderFactoryProxy::OnProxyBindingError,
                          base::Unretained(this)));
...
CitizenNotesURLLoaderFactoryProxy::~CitizenNotesURLLoaderFactoryProxy() = default;

void CitizenNotesURLLoaderFactoryProxy::CreateLoaderAndStart(
    mojo::PendingReceiver<network::mojom::URLLoader> loader,
    int32_t request_id,
    uint32_t options,
    const network::ResourceRequest& request,
  ...
  CitizenNotesURLLoaderInterceptor* interceptor = interceptor_.get();
  ...
  interceptor->CreateJob(
      frame_token_, process_id_, is_download_, request.devtools_request_id, //TODO: Change
      std::move(creation_params), std::move(loader), std::move(client),
      std::move(factory_clone), std::move(cookie_manager_clone));
}

void CitizenNotesURLLoaderFactoryProxy::Clone(
    mojo::PendingReceiver<network::mojom::URLLoaderFactory> receiver) {
  DCHECK_CALLED_ON_VALID_SEQUENCE(sequence_checker_);
  receivers_.Add(this, std::move(receiver));
}

void CitizenNotesURLLoaderFactoryProxy::OnTargetFactoryError() {
  delete this;
}

void CitizenNotesURLLoaderFactoryProxy::OnProxyBindingError() {
  if (receivers_.empty())
    delete this;
}

// static
void CitizenNotesURLLoaderInterceptor::HandleAuthRequest(
    GlobalRequestID req_id,
    const net::AuthChallengeInfo& auth_info,
    HandleAuthRequestCallback callback) {
  if (auto* job = CNInterceptionJob::FindByRequestId(req_id))
    job->OnAuthRequest(auth_info, std::move(callback));
  else
    std::move(callback).Run(true, absl::nullopt);
}

CitizenNotesURLLoaderInterceptor::CitizenNotesURLLoaderInterceptor(
    RequestInterceptedCallback callback)
...
void CitizenNotesURLLoaderInterceptor::SetPatterns(
    std::vector<CitizenNotesURLLoaderInterceptor::Pattern> patterns,
    bool handle_auth) {
...
void CitizenNotesURLLoaderInterceptor::GetResponseBody(
    const std::string& interception_id,
    std::unique_ptr<GetResponseBodyCallback> callback) {
  if (CNInterceptionJob* job = FindJob(interception_id, &callback))
    job->GetResponseBody(std::move(callback));
}

void CitizenNotesURLLoaderInterceptor::TakeResponseBodyPipe(
    const std::string& interception_id,
    CitizenNotesURLLoaderInterceptor::TakeResponseBodyPipeCallback callback) {
...
void CitizenNotesURLLoaderInterceptor::ContinueInterceptedRequest(
    const std::string& interception_id,
    std::unique_ptr<Modifications> modifications,
    std::unique_ptr<ContinueInterceptedRequestCallback> callback) {
  if (CNInterceptionJob* job = FindJob(interception_id, &callback)) {
...
bool CitizenNotesURLLoaderInterceptor::CreateProxyForInterception(
    int process_id,
  ...
  new CitizenNotesURLLoaderFactoryProxy(
...
CNInterceptionJob::CNInterceptionJob(
    CitizenNotesURLLoaderInterceptor* interceptor,
    const std::string& id,
    const base::UnguessableToken& frame_token,
    int process_id,
  ...
  loader_receiver_.set_disconnect_handler(
      base::BindOnce(&CNInterceptionJob::Shutdown, base::Unretained(this)));

  auto& job_map = GetCNInterceptionJobMap();
...
bool CNInterceptionJob::StartJobAndMaybeNotify() {
  UpdateCORSFlag();
...
network::mojom::FetchResponseType CNInterceptionJob::CalculateResponseTainting() {
  if (fetch_cors_flag_)
...
network::ResourceRequest CNInterceptionJob::GetResourceRequestForCookies() {
...
void CNInterceptionJob::UpdateCORSFlag() {
  if (fetch_cors_flag_)
    return;
...
bool CNInterceptionJob::CanGetResponseBody(std::string* error_reason) {
...
void CNInterceptionJob::GetResponseBody(
    std::unique_ptr<GetResponseBodyCallback> callback) {
  ...
  if (!body_reader_) {
    body_reader_ = std::make_unique<BodyReader>(base::BindOnce(
        &CNInterceptionJob::ResponseBodyComplete, base::Unretained(this)));
...
void CNInterceptionJob::TakeResponseBodyPipe(
...
void CNInterceptionJob::ContinueInterceptedRequest(
    std::unique_ptr<Modifications> modifications,
    std::unique_ptr<ContinueInterceptedRequestCallback> callback) {
...
Response CNInterceptionJob::InnerContinueRequest(
    std::unique_ptr<Modifications> modifications) {
  if (!waiting_for_resolution_) {
  ...
  if (modifications->error_reason) {
    ...
    if (modifications->error_reason == net::ERR_BLOCKED_BY_CLIENT) {
      // So we know that these modifications originated from citizennotes
...
void CNInterceptionJob::ApplyModificationsToRequest(
    std::unique_ptr<Modifications> modifications) {
...
void CNInterceptionJob::ProcessAuthResponse(
    const CitizenNotesURLLoaderInterceptor::AuthChallengeResponse& response) {
  DCHECK_EQ(kAuthRequired, state_);
  switch (response.response_type) {
    case CitizenNotesURLLoaderInterceptor::AuthChallengeResponse::kDefault:
      std::move(pending_auth_callback_).Run(true, absl::nullopt);
      break;
    case CitizenNotesURLLoaderInterceptor::AuthChallengeResponse::kCancelAuth:
      std::move(pending_auth_callback_).Run(false, absl::nullopt);
      break;
    case CitizenNotesURLLoaderInterceptor::AuthChallengeResponse::
        kProvideCredentials:
...
Response CNInterceptionJob::ProcessResponseOverride(
    scoped_refptr<net::HttpResponseHeaders> headers,
    scoped_refptr<base::RefCountedMemory> body,
    size_t response_body_offset) {
  CancelRequest();
  ...
  if (head->headers->IsRedirect(&location)) {
    ...
    if (redirect_url.is_valid()) {
      continue_after_cookies_set =
          base::BindOnce(&CNInterceptionJob::ProcessRedirectByClient,
                         base::Unretained(this), std::move(redirect_url));
    }
  }
  if (!continue_after_cookies_set) {
    continue_after_cookies_set =
        base::BindOnce(&CNInterceptionJob::SendResponse, base::Unretained(this),
...
void CNInterceptionJob::ProcessSetCookies(const net::HttpResponseHeaders& headers,
                                        base::OnceClosure callback) {
...
void CNInterceptionJob::ProcessRedirectByClient(const GURL& redirect_url) {
...
void CNInterceptionJob::SendResponse(scoped_refptr<base::RefCountedMemory> body,
                                   size_t offset) {
...
void CNInterceptionJob::ResponseBodyComplete() {
  if (waiting_for_resolution_)
    return;
...
void CNInterceptionJob::StartRequest() {
  DCHECK_EQ(State::kNotStarted, state_);
  DCHECK(!response_metadata_);
...
void CNInterceptionJob::CancelRequest() {
...
std::unique_ptr<CNInterceptedRequestInfo> CNInterceptionJob::BuildRequestInfo(
    const network::mojom::URLResponseHeadPtr& head) {
  auto result = std::make_unique<CNInterceptedRequestInfo>();
...
void CNInterceptionJob::FetchCookies(
    network::mojom::CookieManager::GetCookieListCallback callback) {
...
void CNInterceptionJob::NotifyClient(
    std::unique_ptr<CNInterceptedRequestInfo> request_info) {
  DCHECK_CALLED_ON_VALID_SEQUENCE(sequence_checker_);
  DCHECK(!waiting_for_resolution_);
  FetchCookies(base::BindOnce(&CNInterceptionJob::NotifyClientWithCookies,
                              base::Unretained(this), std::move(request_info)));
}

void CNInterceptionJob::NotifyClientWithCookies(
    std::unique_ptr<CNInterceptedRequestInfo> request_info,
    const net::CookieAccessResultList& cookies_with_access_result,
    const net::CookieAccessResultList& excluded_cookies) {
  DCHECK_CALLED_ON_VALID_SEQUENCE(sequence_checker_);
...
void CNInterceptionJob::CompleteRequest(
    const network::URLLoaderCompletionStatus& status) {
  client_->OnComplete(status);
  Shutdown();
}

void CNInterceptionJob::Shutdown() {
  if (interceptor_)
...
// URLLoader methods
void CNInterceptionJob::FollowRedirect(
    const std::vector<std::string>& removed_headers,
    const net::HttpRequestHeaders& modified_headers,
    const net::HttpRequestHeaders& modified_cors_exempt_headers,
...
void CNInterceptionJob::SetPriority(net::RequestPriority priority,
...
void CNInterceptionJob::PauseReadingBodyFromNet() {
  if (!body_reader_ && loader_ && state_ != State::kResponseTaken)
    loader_->PauseReadingBodyFromNet();
}

void CNInterceptionJob::ResumeReadingBodyFromNet() {
  if (!body_reader_ && loader_ && state_ != State::kResponseTaken)
    loader_->ResumeReadingBodyFromNet();
}

// URLLoaderClient methods
void CNInterceptionJob::OnReceiveEarlyHints(
    network::mojom::EarlyHintsPtr early_hints) {
  client_->OnReceiveEarlyHints(std::move(early_hints));
}

void CNInterceptionJob::OnReceiveResponse(
    network::mojom::URLResponseHeadPtr head,
    mojo::ScopedDataPipeConsumerHandle body,
    absl::optional<mojo_base::BigBuffer> cached_metadata) {
...
void CNInterceptionJob::OnReceiveRedirect(
  ...
  std::unique_ptr<CNInterceptedRequestInfo> request_info = BuildRequestInfo(head);
  request_info->redirect_url = redirect_info.new_url.spec();
  NotifyClient(std::move(request_info));
}

void CNInterceptionJob::OnUploadProgress(int64_t current_position,
                                       int64_t total_size,
...
void CNInterceptionJob::OnTransferSizeUpdated(int32_t transfer_size_diff) {
...
void CNInterceptionJob::StartLoadingResponseBody(
    mojo::ScopedDataPipeConsumerHandle body) {
...
void CNInterceptionJob::OnComplete(
    const network::URLLoaderCompletionStatus& status) {
...
void CNInterceptionJob::OnAuthRequest(
    const net::AuthChallengeInfo& auth_info,
    CitizenNotesURLLoaderInterceptor::HandleAuthRequestCallback callback) {
...
CitizenNotesURLLoaderFactoryAdapter::CitizenNotesURLLoaderFactoryAdapter(
    mojo::PendingRemote<network::mojom::URLLoaderFactory> factory)
    : factory_(std::move(factory)) {}

CitizenNotesURLLoaderFactoryAdapter::~CitizenNotesURLLoaderFactoryAdapter() = default;

void CitizenNotesURLLoaderFactoryAdapter::CreateLoaderAndStart(
    mojo::PendingReceiver<network::mojom::URLLoader> loader,
    int32_t request_id,
    uint32_t options,
    const network::ResourceRequest& request,
...
void CitizenNotesURLLoaderFactoryAdapter::Clone(
    mojo::PendingReceiver<network::mojom::URLLoaderFactory> receiver) {
