...
#ifndef CONTENT_BROWSER_CITIZENNOTES_CITIZENNOTES_URL_LOADER_INTERCEPTOR_H_
#define CONTENT_BROWSER_CITIZENNOTES_CITIZENNOTES_URL_LOADER_INTERCEPTOR_H_
...
class CitizenNotesURLLoaderInterceptor {
 public:
  using RequestInterceptedCallback =
      base::RepeatingCallback<void(std::unique_ptr<CNInterceptedRequestInfo>)>;
  ...
  explicit CitizenNotesURLLoaderInterceptor(RequestInterceptedCallback callback);

  CitizenNotesURLLoaderInterceptor(const CitizenNotesURLLoaderInterceptor&) = delete;
  CitizenNotesURLLoaderInterceptor& operator=(const CitizenNotesURLLoaderInterceptor&) =
      delete;

  ~CitizenNotesURLLoaderInterceptor();
 ...
 private:
  friend class CNInterceptionJob;
  friend class CitizenNotesURLLoaderFactoryProxy;
  ...
  CNInterceptionJob* FindJob(const std::string& id,
  ...
  void AddJob(const std::string& id, CNInterceptionJob* job) {
  ...
  std::map<std::string, CNInterceptionJob*> jobs_;

  base::WeakPtrFactory<CitizenNotesURLLoaderInterceptor> weak_factory_;
};
...
// rather than exposing original CitizenNotesURLLoaderFactoryProxy because
// this takes care of thread hopping when necessary.
class CitizenNotesURLLoaderFactoryAdapter
    : public network::mojom::URLLoaderFactory {
 public:
  CitizenNotesURLLoaderFactoryAdapter() = delete;
  explicit CitizenNotesURLLoaderFactoryAdapter(
      mojo::PendingRemote<network::mojom::URLLoaderFactory> factory);
  ~CitizenNotesURLLoaderFactoryAdapter() override;
...
inline CitizenNotesURLLoaderInterceptor::InterceptionStage& operator|=(
    CitizenNotesURLLoaderInterceptor::InterceptionStage& a,
    const CitizenNotesURLLoaderInterceptor::InterceptionStage& b) {
  a = static_cast<CitizenNotesURLLoaderInterceptor::InterceptionStage>(a | b);
  return a;
}

}  // namespace content

#endif  // CONTENT_BROWSER_CITIZENNOTES_CITIZENNOTES_URL_LOADER_INTERCEPTOR_H_
