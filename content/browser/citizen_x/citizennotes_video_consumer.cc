...
// static
constexpr gfx::Size CitizenNotesVideoConsumer::kDefaultMinFrameSize;

// static
constexpr gfx::Size CitizenNotesVideoConsumer::kDefaultMaxFrameSize;

CitizenNotesVideoConsumer::CitizenNotesVideoConsumer(OnFrameCapturedCallback callback)
...
CitizenNotesVideoConsumer::~CitizenNotesVideoConsumer() = default;

// static
SkBitmap CitizenNotesVideoConsumer::GetSkBitmapFromFrame(
...
void CitizenNotesVideoConsumer::StartCapture() {
  if (capturer_)
    return;
  InnerStartCapture(CreateCapturer());
}

void CitizenNotesVideoConsumer::StopCapture() {
  if (!capturer_)
    return;
  capturer_.reset();
}

void CitizenNotesVideoConsumer::SetFrameSinkId(
...
void CitizenNotesVideoConsumer::SetMinCapturePeriod(
...
void CitizenNotesVideoConsumer::SetMinAndMaxFrameSize(gfx::Size min_frame_size,
...
void CitizenNotesVideoConsumer::SetFormat(media::VideoPixelFormat format) {
...
void CitizenNotesVideoConsumer::InnerStartCapture(
...
bool CitizenNotesVideoConsumer::IsValidMinAndMaxFrameSize(
...
void CitizenNotesVideoConsumer::OnFrameCaptured(
...
void CitizenNotesVideoConsumer::OnStopped() {}
