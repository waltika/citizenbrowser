...
#ifndef CONTENT_BROWSER_CITIZENNOTES_CITIZENNOTES_VIDEO_CONSUMER_H_
#define CONTENT_BROWSER_CITIZENNOTES_CITIZENNOTES_VIDEO_CONSUMER_H_
...
class CONTENT_EXPORT CitizenNotesVideoConsumer
    : public viz::mojom::FrameSinkVideoConsumer {
 public:
  using OnFrameCapturedCallback =
      base::RepeatingCallback<void(scoped_refptr<media::VideoFrame> frame)>;

  explicit CitizenNotesVideoConsumer(OnFrameCapturedCallback callback);

  CitizenNotesVideoConsumer(const CitizenNotesVideoConsumer&) = delete;
  CitizenNotesVideoConsumer& operator=(const CitizenNotesVideoConsumer&) = delete;

  ~CitizenNotesVideoConsumer() override;
 ...
 private:
  friend class CitizenNotesVideoConsumerTest;
...
#endif  // CONTENT_BROWSER_CITIZENNOTES_CITIZENNOTES_VIDEO_CONSUMER_H_
