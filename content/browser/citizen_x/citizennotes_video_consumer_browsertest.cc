...
class CitizenNotesVideoConsumerTest : public ContentBrowserTest {
 public:
  CitizenNotesVideoConsumerTest() {}

  void SetUpOnMainThread() override {
    consumer_ = std::make_unique<CitizenNotesVideoConsumer>(base::BindRepeating(
        &CitizenNotesVideoConsumerTest::OnFrameFromVideoConsumer,
...
IN_PROC_BROWSER_TEST_F(CitizenNotesVideoConsumerTest,
  ...
  NavigateToURLBlockUntilNavigationsComplete(
      shell(), embedded_test_server()->GetURL("/citizennotes/navigation.html"), 1);
