...
const char kCitizenNotesDownloadManagerDelegateName[] =
    "citizennotes_download_manager_delegate";

CitizenNotesDownloadManagerDelegate::CitizenNotesDownloadManagerDelegate(
...
// static
CitizenNotesDownloadManagerDelegate*
CitizenNotesDownloadManagerDelegate::GetOrCreateInstance(BrowserContext* context) {
  DCHECK_CURRENTLY_ON(BrowserThread::UI);
  if (!CitizenNotesDownloadManagerDelegate::GetInstance(context)) {
    auto delegate_owned =
        base::WrapUnique(new CitizenNotesDownloadManagerDelegate(context));
    context->SetUserData(kCitizenNotesDownloadManagerDelegateName,
                         std::move(delegate_owned));
  }
  return CitizenNotesDownloadManagerDelegate::GetInstance(context);
}

// static
CitizenNotesDownloadManagerDelegate* CitizenNotesDownloadManagerDelegate::GetInstance(
    BrowserContext* context) {
  return static_cast<CitizenNotesDownloadManagerDelegate*>(
      context->GetUserData(kCitizenNotesDownloadManagerDelegateName));
}

void CitizenNotesDownloadManagerDelegate::Shutdown() {
...
bool CitizenNotesDownloadManagerDelegate::DetermineDownloadTarget(
  ...
  FilenameDeterminedCallback filename_determined_callback = base::BindOnce(
      &CitizenNotesDownloadManagerDelegate::OnDownloadPathGenerated,
      base::Unretained(this), item->GetId(), std::move(*callback));
  base::ThreadPool::PostTask(
      FROM_HERE,
      {base::MayBlock(), base::TaskShutdownBehavior::SKIP_ON_SHUTDOWN,
       base::TaskPriority::USER_VISIBLE},
      base::BindOnce(&CitizenNotesDownloadManagerDelegate::GenerateFilename,
...
bool CitizenNotesDownloadManagerDelegate::ShouldOpenDownload(
    download::DownloadItem* item,
...
void CitizenNotesDownloadManagerDelegate::GetNextId(
...
// static
void CitizenNotesDownloadManagerDelegate::GenerateFilename(
    const GURL& url,
...
void CitizenNotesDownloadManagerDelegate::OnDownloadPathGenerated(
...
download::DownloadItem* CitizenNotesDownloadManagerDelegate::GetDownloadByGuid(
