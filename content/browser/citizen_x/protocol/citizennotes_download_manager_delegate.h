...
#ifndef CONTENT_BROWSER_CITIZENNOTES_PROTOCOL_CITIZENNOTES_DOWNLOAD_MANAGER_DELEGATE_H_
#define CONTENT_BROWSER_CITIZENNOTES_PROTOCOL_CITIZENNOTES_DOWNLOAD_MANAGER_DELEGATE_H_
...
class CitizenNotesDownloadManagerDelegate
 ...
 public:
  ...
  // delegate if it cannot find any CitizenNotesDownloadManagerHelper associated
  // with the download.
  static CitizenNotesDownloadManagerDelegate* GetOrCreateInstance(
      content::BrowserContext* browser_Context);
  static CitizenNotesDownloadManagerDelegate* GetInstance(
      content::BrowserContext* browser_Context);

  CitizenNotesDownloadManagerDelegate(const CitizenNotesDownloadManagerDelegate&) =
      delete;
  CitizenNotesDownloadManagerDelegate& operator=(
      const CitizenNotesDownloadManagerDelegate&) = delete;

  ~CitizenNotesDownloadManagerDelegate() override = default;
 ...
 private:
  friend class base::RefCounted<CitizenNotesDownloadManagerDelegate>;

  explicit CitizenNotesDownloadManagerDelegate(BrowserContext* browser_context);
  ...
  RAW_PTR_EXCLUSION content::DownloadManagerDelegate* original_download_delegate_;
...
#endif  // CONTENT_BROWSER_CITIZENNOTES_PROTOCOL_CITIZENNOTES_DOWNLOAD_MANAGER_DELEGATE_H_
