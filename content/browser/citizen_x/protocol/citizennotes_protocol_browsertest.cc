...
#include "content/browser/citizen_x/protocol/browser_handler.h"
#include "content/browser/citizen_x/protocol/citizennotes_download_manager_delegate.h"
#include "content/browser/citizen_x/protocol/citizennotes_protocol_test_support.h"
#include "content/browser/citizen_x/protocol/system_info.h"
...
class SitePerProcessCitizenNotesProtocolTest : public CitizenNotesProtocolTest {
 public:
  void SetUpCommandLine(base::CommandLine* command_line) override {
    CitizenNotesProtocolTest::SetUpCommandLine(command_line);
    IsolateAllSitesForTesting(command_line);
  }
};

class SyntheticKeyEventTest : public CitizenNotesProtocolTest {
 protected:
...
class PrerenderCitizenNotesProtocolTest : public CitizenNotesProtocolTest {
 public:
  PrerenderCitizenNotesProtocolTest() {
    prerender_helper_ = std::make_unique<test::PrerenderTestHelper>(
        base::BindRepeating(&PrerenderCitizenNotesProtocolTest::web_contents,
...
class MultiplePrerendersCitizenNotesProtocolTest
    : public PrerenderCitizenNotesProtocolTest {
 public:
  MultiplePrerendersCitizenNotesProtocolTest() = default;

 private:
  test::ScopedPrerenderFeatureList prerender_feature_list_;
};

class SyntheticMouseEventTest : public CitizenNotesProtocolTest {
 public:
...
IN_PROC_BROWSER_TEST_F(SyntheticMouseEventTest, MouseEventCoordinates) {
  ...
  GURL test_url = embedded_test_server()->GetURL("/citizen_x/zoom.html");
...
class CaptureScreenshotTest : public CitizenNotesProtocolTest {
 protected:
 ...
 private:
  ...
  void SetUp() override {
    EnablePixelOutput();
    CitizenNotesProtocolTest::SetUp();
  }
#endif
};
...
IN_PROC_BROWSER_TEST_F(CitizenNotesProtocolTest, DISABLED_SynthesizePinchGesture) {
  GURL test_url = GetTestUrl("citizennotes", "synthetic_gesture_tests.html");
  NavigateToURLBlockUntilNavigationsComplete(shell(), test_url, 1);
  Attach();
...
IN_PROC_BROWSER_TEST_F(CitizenNotesProtocolTest, DISABLED_SynthesizeScrollGesture) {
  GURL test_url = GetTestUrl("citizennotes", "synthetic_gesture_tests.html");
  NavigateToURLBlockUntilNavigationsComplete(shell(), test_url, 1);
  Attach();
...
IN_PROC_BROWSER_TEST_F(CitizenNotesProtocolTest, DISABLED_SynthesizeTapGesture) {
  GURL test_url = GetTestUrl("citizennotes", "synthetic_gesture_tests.html");
  NavigateToURLBlockUntilNavigationsComplete(shell(), test_url, 1);
  Attach();
...
IN_PROC_BROWSER_TEST_F(CitizenNotesProtocolTest, DISABLED_PageCrash) {
  ASSERT_TRUE(embedded_test_server()->Start());
  GURL test_url = embedded_test_server()->GetURL("/citizen_x/navigation.html");
  NavigateToURLBlockUntilNavigationsComplete(shell(), test_url, 1);
  Attach();
...
#endif
IN_PROC_BROWSER_TEST_F(SitePerProcessCitizenNotesProtocolTest,
                       MAYBE_PageCrashInFrame) {
  ASSERT_TRUE(embedded_test_server()->Start());
  GURL test_url =
      embedded_test_server()->GetURL("/citizen_x/page-with-oopif.html");
  NavigateToURLBlockUntilNavigationsComplete(shell(), test_url, 1);
  Attach();
...
IN_PROC_BROWSER_TEST_F(CitizenNotesProtocolTest, PageCrashClearsPendingCommands) {
  ASSERT_TRUE(embedded_test_server()->Start());
  GURL test_url = embedded_test_server()->GetURL("/citizen_x/navigation.html");
  NavigateToURLBlockUntilNavigationsComplete(shell(), test_url, 1);
  Attach();
...
// la-cros
IN_PROC_BROWSER_TEST_F(CitizenNotesProtocolTest,
  ...
  base::Value::Dict params;
  test_url = GetTestUrl("citizennotes", "navigation.html");
...
IN_PROC_BROWSER_TEST_F(CitizenNotesProtocolTest,
  ...
  base::Value::Dict params;
  GURL test_url = GetTestUrl("citizennotes", "navigation.html");
  params.Set("url", test_url.spec());
...
IN_PROC_BROWSER_TEST_F(CitizenNotesProtocolTest, DISABLED_CrossSiteNavigation) {
  content::SetupCrossSiteRedirector(embedded_test_server());
  ASSERT_TRUE(embedded_test_server()->Start());

  GURL test_url1 =
      embedded_test_server()->GetURL("A.com", "/citizen_x/navigation.html");
  NavigateToURLBlockUntilNavigationsComplete(shell(), test_url1, 1);
  Attach();
  SendCommandAsync("Page.enable");

  GURL test_url2 =
      embedded_test_server()->GetURL("B.com", "/citizen_x/navigation.html");
  base::Value::Dict params;
...
IN_PROC_BROWSER_TEST_F(CitizenNotesProtocolTest, CrossSiteCrash) {
...
IN_PROC_BROWSER_TEST_F(CitizenNotesProtocolTest, InspectorTargetCrashedNavigate) {
  set_agent_host_can_close();
  ASSERT_TRUE(embedded_test_server()->Start());
...
IN_PROC_BROWSER_TEST_F(CitizenNotesProtocolTest, TargetGetTargetsAfterCrash) {
  set_agent_host_can_close();
  ASSERT_TRUE(embedded_test_server()->Start());
  GURL url_a = embedded_test_server()->GetURL("a.com", "/title1.html");
...
// Same as in CitizenNotesProtocolTest.InspectorTargetCrashedNavigate, but with a
...
IN_PROC_BROWSER_TEST_F(CitizenNotesProtocolTest, ReconnectPreservesState) {
  ASSERT_TRUE(embedded_test_server()->Start());
  GURL test_url = embedded_test_server()->GetURL("/citizen_x/navigation.html");
  NavigateToURLBlockUntilNavigationsComplete(shell(), test_url, 1);
...
IN_PROC_BROWSER_TEST_F(CitizenNotesProtocolTest, CrossSitePauseInBeforeUnload) {
  content::SetupCrossSiteRedirector(embedded_test_server());
  ASSERT_TRUE(embedded_test_server()->Start());

  NavigateToURLBlockUntilNavigationsComplete(shell(),
      embedded_test_server()->GetURL("A.com", "/citizen_x/navigation.html"), 1);
  Attach();
  SendCommandSync("Debugger.enable");
...
IN_PROC_BROWSER_TEST_F(CitizenNotesProtocolTest, InspectDuringFrameSwap) {
  content::SetupCrossSiteRedirector(embedded_test_server());
  ASSERT_TRUE(embedded_test_server()->Start());
  ...
  agent_host_ = CitizenNotesAgentHost::GetOrCreateFor(new_shell->web_contents());
...
IN_PROC_BROWSER_TEST_F(CitizenNotesProtocolTest, DoubleCrash) {
  set_agent_host_can_close();
  ASSERT_TRUE(embedded_test_server()->Start());
  GURL test_url = embedded_test_server()->GetURL("/citizen_x/navigation.html");
  NavigateToURLBlockUntilNavigationsComplete(shell(), GURL("about:blank"), 1);
...
IN_PROC_BROWSER_TEST_F(CitizenNotesProtocolTest, ReloadBlankPage) {
...
IN_PROC_BROWSER_TEST_F(CitizenNotesProtocolTest, EvaluateInBlankPage) {
  NavigateToURLBlockUntilNavigationsComplete(shell(), GURL("about:blank"), 1);
  Attach();
  base::Value::Dict params;
...
IN_PROC_BROWSER_TEST_F(CitizenNotesProtocolTest, JavaScriptDialogNotifications) {
  NavigateToURLBlockUntilNavigationsComplete(shell(), GURL("about:blank"), 1);
  Attach();
...
IN_PROC_BROWSER_TEST_F(CitizenNotesProtocolTest, JavaScriptDialogInterop) {
  NavigateToURLBlockUntilNavigationsComplete(shell(), GURL("about:blank"), 1);
  Attach();
  TestJavaScriptDialogManager dialog_manager;
  WebContentsImpl* wc = static_cast<WebContentsImpl*>(shell()->web_contents());
...
IN_PROC_BROWSER_TEST_F(CitizenNotesProtocolTest, PageDisableWithOpenedDialog) {
  NavigateToURLBlockUntilNavigationsComplete(shell(), GURL("about:blank"), 1);
  Attach();
  TestJavaScriptDialogManager dialog_manager;
  WebContentsImpl* wc = static_cast<WebContentsImpl*>(shell()->web_contents());
...
IN_PROC_BROWSER_TEST_F(CitizenNotesProtocolTest, PageDisableWithNoDialogManager) {
  NavigateToURLBlockUntilNavigationsComplete(shell(), GURL("about:blank"), 1);
  Attach();
  WebContentsImpl* wc = static_cast<WebContentsImpl*>(shell()->web_contents());
  wc->SetDelegate(nullptr);
...
IN_PROC_BROWSER_TEST_F(CitizenNotesProtocolTest, BeforeUnloadDialog) {
  NavigateToURLBlockUntilNavigationsComplete(shell(), GURL("about:blank"), 1);
  Attach();
  TestJavaScriptDialogManager dialog_manager;
...
IN_PROC_BROWSER_TEST_F(CitizenNotesProtocolTest, BrowserCreateAndCloseTarget) {
  NavigateToURLBlockUntilNavigationsComplete(shell(), GURL("about:blank"), 1);
  Attach();
...
IN_PROC_BROWSER_TEST_F(CitizenNotesProtocolTest, BrowserGetTargets) {
  NavigateToURLBlockUntilNavigationsComplete(shell(), GURL("about:blank"), 1);
  Attach();
  SendCommandSync("Target.getTargets");
...
IN_PROC_BROWSER_TEST_F(CitizenNotesProtocolTest, VirtualTimeTest) {
  NavigateToURLBlockUntilNavigationsComplete(shell(), GURL("about:blank"), 1);
  Attach();
...
IN_PROC_BROWSER_TEST_F(CitizenNotesProtocolTest, CertificateError) {
  net::EmbeddedTestServer https_server(net::EmbeddedTestServer::TYPE_HTTPS);
  https_server.SetSSLConfig(net::EmbeddedTestServer::CERT_EXPIRED);
  https_server.ServeFilesFromSourceDirectory(GetTestDataFilePath());
  ASSERT_TRUE(https_server.Start());
  GURL test_url = https_server.GetURL("/citizen_x/navigation.html");
  base::Value::Dict command_params;
...
IN_PROC_BROWSER_TEST_F(CitizenNotesProtocolTest, CertificateErrorBrowserTarget) {
  net::EmbeddedTestServer https_server(net::EmbeddedTestServer::TYPE_HTTPS);
  https_server.SetSSLConfig(net::EmbeddedTestServer::CERT_EXPIRED);
  https_server.ServeFilesFromSourceDirectory(GetTestDataFilePath());
  ASSERT_TRUE(https_server.Start());
...
IN_PROC_BROWSER_TEST_F(CitizenNotesProtocolTest, SubresourceWithCertificateError) {
  net::EmbeddedTestServer https_server(net::EmbeddedTestServer::TYPE_HTTPS);
  https_server.SetSSLConfig(net::EmbeddedTestServer::CERT_EXPIRED);
  https_server.ServeFilesFromSourceDirectory("content/test/data/citizennotes");
  ASSERT_TRUE(https_server.Start());
...
IN_PROC_BROWSER_TEST_F(CitizenNotesProtocolTest, TargetDiscovery) {
  std::set<std::string> ids;
  base::Value::Dict command_params;

  ASSERT_TRUE(embedded_test_server()->Start());
  GURL first_url = embedded_test_server()->GetURL("/citizen_x/navigation.html");
  NavigateToURLBlockUntilNavigationsComplete(shell(), first_url, 1);

  GURL second_url = embedded_test_server()->GetURL("/citizen_x/navigation.html");
  Shell* second = CreateBrowser();
  ...
  GURL third_url = embedded_test_server()->GetURL("/citizen_x/navigation.html");
...
IN_PROC_BROWSER_TEST_F(CitizenNotesProtocolTest, SetAndGetCookies) {
  ASSERT_TRUE(embedded_test_server()->Start());
...
IN_PROC_BROWSER_TEST_F(CitizenNotesProtocolTest,
  ...
  // Attach to CitizenNotes after subframe starts navigating (but before it
  // finishes).
  Attach();

  CitizenNotesAgentHostImpl* main_frame_agent =
      RenderFrameCitizenNotesAgentHost::GetFor(main_frame);
  ...
  // shouldn't have its own CitizenNotesAgentHost yet.
  FrameTreeNode* child = main_frame->child_at(0);
  EXPECT_NE(child, nullptr);
  EXPECT_EQ(RenderFrameCitizenNotesAgentHost::GetFor(child), main_frame_agent);
  ...
  EXPECT_NE(RenderFrameCitizenNotesAgentHost::GetFor(child), main_frame_agent);
  EXPECT_THAT(notification.FindBool("waitingForDebugger"),
              testing::Optional(false));
}

class CitizenNotesProtocolDeviceEmulationTest : public CitizenNotesProtocolTest {
 public:
  ~CitizenNotesProtocolDeviceEmulationTest() override {}
...
#endif
IN_PROC_BROWSER_TEST_F(CitizenNotesProtocolDeviceEmulationTest, MAYBE_DeviceSize) {
  content::SetupCrossSiteRedirector(embedded_test_server());
  ASSERT_TRUE(embedded_test_server()->Start());
...
#endif
IN_PROC_BROWSER_TEST_F(CitizenNotesProtocolDeviceEmulationTest,
...
class CitizenNotesProtocolDeviceEmulationPrerenderTest
    : public CitizenNotesProtocolDeviceEmulationTest {
 public:
  CitizenNotesProtocolDeviceEmulationPrerenderTest()
      : prerender_helper_(base::BindRepeating(
            &CitizenNotesProtocolDeviceEmulationPrerenderTest::GetWebContents,
            base::Unretained(this))) {}
  ~CitizenNotesProtocolDeviceEmulationPrerenderTest() override = default;

  void SetUpOnMainThread() override {
    CitizenNotesProtocolDeviceEmulationTest::SetUpOnMainThread();
...
#define MAYBE_DeviceSize DeviceSize
#endif
IN_PROC_BROWSER_TEST_F(CitizenNotesProtocolDeviceEmulationPrerenderTest,
                       MAYBE_DeviceSize) {
  ...
  GURL prerender_url =
      embedded_test_server()->GetURL("/citizen_x/navigation.html?prerender");
...
class CitizenNotesProtocolTouchTest : public CitizenNotesProtocolTest {
 public:
  ~CitizenNotesProtocolTouchTest() override {}
...
IN_PROC_BROWSER_TEST_F(CitizenNotesProtocolTouchTest, EnableTouch) {
  base::Value::Dict params;

  content::SetupCrossSiteRedirector(embedded_test_server());
  ASSERT_TRUE(embedded_test_server()->Start());
  GURL test_url1 =
      embedded_test_server()->GetURL("A.com", "/citizen_x/enable_touch.html");
  GURL test_url2 =
      embedded_test_server()->GetURL("B.com", "/citizen_x/enable_touch.html");
  NavigateToURLBlockUntilNavigationsComplete(shell(), test_url1, 1);
  Attach();
...
class CitizenNotesProtocolBackForwardCacheTest : public CitizenNotesProtocolTest {
 public:
  CitizenNotesProtocolBackForwardCacheTest() {
    feature_list_.InitWithFeaturesAndParameters(
        GetDefaultEnabledBackForwardCacheFeaturesForTesting(
            /*ignore_outstanding_network_request=*/false),
        GetDefaultDisabledBackForwardCacheFeaturesForTesting());
  }
  ~CitizenNotesProtocolBackForwardCacheTest() override = default;
...
// This test checks that the CitizenNotes continue to work when the page is stored
...
// messages.
IN_PROC_BROWSER_TEST_F(CitizenNotesProtocolBackForwardCacheTest, Basic) {
  ASSERT_TRUE(embedded_test_server()->Start());
  GURL url_a(embedded_test_server()->GetURL("a.com", "/title1.html"));
  GURL url_b(embedded_test_server()->GetURL("b.com", "/title1.html"));
  ...
  // 2) Attach CitizenNotes session.
  Attach();

  // 3) Extract the state via the CitizenNotes protocol.
  ...
  // 4) Ensure that the CitizenNotes protocol commands are handled by the new page
...
class CitizenNotesDownloadContentTest : public CitizenNotesProtocolTest {
 protected:
  void SetUpOnMainThread() override {
...
IN_PROC_BROWSER_TEST_F(CitizenNotesDownloadContentTest, SingleDownload) {
  base::ScopedAllowBlockingForTesting allow_blocking;
...
IN_PROC_BROWSER_TEST_F(CitizenNotesDownloadContentTest, DownloadCancelled) {
  base::ScopedAllowBlockingForTesting allow_blocking;
  SetupEnsureNoPendingDownloads();
  NavigateToURLBlockUntilNavigationsComplete(shell(), GURL("about:blank"), 1);
  Attach();
...
IN_PROC_BROWSER_TEST_F(CitizenNotesDownloadContentTest, DeniedDownload) {
  base::ScopedAllowBlockingForTesting allow_blocking;
  SetupEnsureNoPendingDownloads();
  NavigateToURLBlockUntilNavigationsComplete(shell(), GURL("about:blank"), 1);
  Attach();
...
IN_PROC_BROWSER_TEST_F(CitizenNotesDownloadContentTest, DefaultDownload) {
  base::ScopedAllowBlockingForTesting allow_blocking;
  SetupEnsureNoPendingDownloads();
  NavigateToURLBlockUntilNavigationsComplete(shell(), GURL("about:blank"), 1);
  Attach();
...
// download delegate.
IN_PROC_BROWSER_TEST_F(CitizenNotesDownloadContentTest, DefaultDownloadHeadless) {
  base::ScopedAllowBlockingForTesting allow_blocking;
  SetupEnsureNoPendingDownloads();
  NavigateToURLBlockUntilNavigationsComplete(shell(), GURL("about:blank"), 1);
  Attach();
...
// Check that defaulting downloads cancels when there's no proxy
// download delegate.
IN_PROC_BROWSER_TEST_F(CitizenNotesDownloadContentTest,
...
// corrupted files.
IN_PROC_BROWSER_TEST_F(CitizenNotesDownloadContentTest, DISABLED_MultiDownload) {
  base::ScopedAllowBlockingForTesting allow_blocking;
  base::ScopedTempDir temp_dir;
  ASSERT_TRUE(temp_dir.CreateUniqueTempDir());
...
IN_PROC_BROWSER_TEST_F(CitizenNotesProtocolTest, UnsafeOperations) {
  NavigateToURLBlockUntilNavigationsComplete(shell(), GURL("about:blank"), 1);
  Attach();
...
IN_PROC_BROWSER_TEST_F(CitizenNotesProtocolTest, TracingWithPerfettoConfig) {
...
IN_PROC_BROWSER_TEST_F(CitizenNotesProtocolTest, NavigateToAboutBlankLoaderId) {
  NavigateToURLBlockUntilNavigationsComplete(shell(), GURL("about:blank"), 1);
  Attach();
...
class SystemTracingCitizenNotesProtocolTest : public CitizenNotesProtocolTest {
 protected:
...
IN_PROC_BROWSER_TEST_F(SystemTracingCitizenNotesProtocolTest,
                       StartSystemTracingFailsWhenSystemConsumerDisabled) {
  EXPECT_FALSE(StartSystemTrace());
}

#if BUILDFLAG(IS_POSIX)
class PosixSystemTracingCitizenNotesProtocolTest
    : public SystemTracingCitizenNotesProtocolTest {
 public:
  PosixSystemTracingCitizenNotesProtocolTest() {
  ...
  ~PosixSystemTracingCitizenNotesProtocolTest() override {
...
class InvalidSystemTracingCitizenNotesProtocolTest
    : public PosixSystemTracingCitizenNotesProtocolTest {
 public:
  void SetUp() override {
    ...
    PosixSystemTracingCitizenNotesProtocolTest::SetUp();
  }
};

IN_PROC_BROWSER_TEST_F(InvalidSystemTracingCitizenNotesProtocolTest,
                       StartTracingFailsWithInvalidSockets) {
  EXPECT_FALSE(StartSystemTrace());
}

class FakeSystemTracingCitizenNotesProtocolTest
    : public PosixSystemTracingCitizenNotesProtocolTest {
 public:
  FakeSystemTracingCitizenNotesProtocolTest()
  ...
  void PreRunTestOnMainThread() override {
    ...
    PosixSystemTracingCitizenNotesProtocolTest::PreRunTestOnMainThread();
  }
...
#endif
IN_PROC_BROWSER_TEST_F(FakeSystemTracingCitizenNotesProtocolTest,
...
class FakeSystemTracingForbiddenCitizenNotesProtocolTest
    : public PosixSystemTracingCitizenNotesProtocolTest {
 public:
  void SetUp() override {
    tracing::PerfettoTracedProcess::Get()
...
#endif
IN_PROC_BROWSER_TEST_F(FakeSystemTracingForbiddenCitizenNotesProtocolTest,
                       MAYBE_SystemConsumerForbidden) {
  EXPECT_FALSE(StartSystemTrace());
}
#endif  // BUILDFLAG(IS_POSIX)

class NetworkResponseProtocolTest : public CitizenNotesProtocolTest {
 protected:
...
IN_PROC_BROWSER_TEST_F(PrerenderCitizenNotesProtocolTest,
                       RenderFrameCitizenNotesAgentHostCacheEvictionCrash) {
  ASSERT_TRUE(embedded_test_server()->Start());
  const GURL kInitialUrl = GetUrl("/empty.html");
  const GURL kPrerenderingUrl = GetUrl("/empty.html?prerender");
  ...
  auto old_host = CitizenNotesAgentHost::GetOrCreateFor(web_contents_impl);
...
IN_PROC_BROWSER_TEST_F(CitizenNotesProtocolTest, ResponseAfterReload) {
  ASSERT_TRUE(embedded_test_server()->Start());
...
class SharedStorageCitizenNotesProtocolTest : public CitizenNotesProtocolTest {
 public:
  SharedStorageCitizenNotesProtocolTest() {
    feature_list_
...
IN_PROC_BROWSER_TEST_F(SharedStorageCitizenNotesProtocolTest,
