...
#ifndef CONTENT_BROWSER_CITIZENNOTES_PROTOCOL_BROWSER_HANDLER_H_
#define CONTENT_BROWSER_CITIZENNOTES_PROTOCOL_BROWSER_HANDLER_H_
...
class CNBrowserHandler : public CitizenNotesDomainHandler,
                       public Browser::Backend,
                       public download::DownloadItem::Observer {
 public:
  explicit CNBrowserHandler(bool allow_set_download_behavior);

  CNBrowserHandler(const CNBrowserHandler&) = delete;
  CNBrowserHandler& operator=(const CNBrowserHandler&) = delete;

  ~CNBrowserHandler() override;

  static Response FindBrowserContext(
      const Maybe<std::string>& browser_context_id,
      BrowserContext** browser_context);

  static std::vector<CNBrowserHandler*> ForAgentHost(CitizenNotesAgentHostImpl* host);
...
#endif  // CONTENT_BROWSER_CITIZENNOTES_PROTOCOL_BROWSER_HANDLER_H_
