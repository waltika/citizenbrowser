...
#ifndef CONTENT_BROWSER_CITIZENNOTES_PROTOCOL_EMULATION_HANDLER_H_
#define CONTENT_BROWSER_CITIZENNOTES_PROTOCOL_EMULATION_HANDLER_H_

#include <memory>

#include "base/containers/flat_map.h"
#include "content/browser/citizen_x/protocol/citizennotes_domain_handler.h"
#include "content/browser/citizen_x/protocol/emulation.h"
...
class CNEmulationHandler : public CitizenNotesDomainHandler,
 ...
 public:
  ...
  static std::vector<CNEmulationHandler*> ForAgentHost(
...
#endif  // CONTENT_BROWSER_CITIZENNOTES_PROTOCOL_EMULATION_HANDLER_H_
