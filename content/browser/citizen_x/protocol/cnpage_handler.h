...
#ifndef CONTENT_BROWSER_CITIZENNOTES_PROTOCOL_PAGE_HANDLER_H_
#define CONTENT_BROWSER_CITIZENNOTES_PROTOCOL_PAGE_HANDLER_H_
...
class CNPageHandler : public CitizenNotesDomainHandler,
                      public Page::Backend,
                      public RenderWidgetHostObserver,
                      public download::DownloadItem::Observer {
 public:
  CNPageHandler(CNEmulationHandler* emulation_handler,
  ...
  CNPageHandler(const CNPageHandler&) = delete;
  CNPageHandler& operator=(const CNPageHandler&) = delete;

  ~CNPageHandler() override;

  static std::vector<CNPageHandler*> EnabledForWebContents(
      WebContentsImpl* contents);
  static std::vector<CNPageHandler*> ForAgentHost(CitizenNotesAgentHostImpl* host);
 ...
 private:
  ...
  // and provides CNPageHandler with these frames via OnFrameFromVideoConsumer.
  ...
  RAW_PTR_EXCLUSION CNEmulationHandler* emulation_handler_;
  RAW_PTR_EXCLUSION CNBrowserHandler* browser_handler_;
  ...
  // Maps CitizenNotes navigation tokens to pending NavigateCallbacks.
  ...
  base::WeakPtrFactory<CNPageHandler> weak_factory_{this};
};

}  // namespace protocol
}  // namespace content

#endif  // CONTENT_BROWSER_CITIZENNOTES_PROTOCOL_PAGE_HANDLER_H_
