...
#ifndef CONTENT_BROWSER_CITIZENNOTES_PROTOCOL_STORAGE_HANDLER_H_
#define CONTENT_BROWSER_CITIZENNOTES_PROTOCOL_STORAGE_HANDLER_H_
...
class CNStorageHandler
 ...
 public:
  explicit CNStorageHandler(bool client_is_trusted);
  ...
  static std::vector<CNStorageHandler*> ForAgentHost(CitizenNotesAgentHostImpl* host);

  // content::protocol::CitizenNotesDomainHandler
 ...
 private:
  ...
  RAW_PTR_EXCLUSION StoragePartition* storage_partition_{nullptr};
  ...
  base::WeakPtrFactory<CNStorageHandler> weak_ptr_factory_{this};
};

}  // namespace protocol
}  // namespace content

#endif  // CONTENT_BROWSER_CITIZENNOTES_PROTOCOL_STORAGE_HANDLER_H_
