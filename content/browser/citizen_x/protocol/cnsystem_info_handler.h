...
#ifndef CONTENT_BROWSER_CITIZENNOTES_PROTOCOL_SYSTEM_INFO_HANDLER_H_
#define CONTENT_BROWSER_CITIZENNOTES_PROTOCOL_SYSTEM_INFO_HANDLER_H_
...
class CNSystemInfoHandler : public CitizenNotesDomainHandler,
                          public SystemInfo::Backend {
 public:
  explicit CNSystemInfoHandler(bool is_browser_session);
 ...
 private:
  ...
  friend class CNSystemInfoHandlerGpuObserver;
};

}  // namespace protocol
}  // namespace content

#endif  // CONTENT_BROWSER_CITIZENNOTES_PROTOCOL_SYSTEM_INFO_HANDLER_H_
