...
#ifndef CONTENT_BROWSER_CITIZENNOTES_PROTOCOL_WEBAUTHN_HANDLER_H_
#define CONTENT_BROWSER_CITIZENNOTES_PROTOCOL_WEBAUTHN_HANDLER_H_
...
class CNWebAuthnHandler : public CitizenNotesDomainHandler,
                        public WebAuthn::Backend,
                        public VirtualAuthenticator::Observer {
 public:
  CONTENT_EXPORT CNWebAuthnHandler();
  CONTENT_EXPORT ~CNWebAuthnHandler() override;
  CNWebAuthnHandler(const CNWebAuthnHandler&) = delete;
  CNWebAuthnHandler operator=(const CNWebAuthnHandler&) = delete;
...
#endif  // CONTENT_BROWSER_CITIZENNOTES_PROTOCOL_WEBAUTHN_HANDLER_H_
