...
// Use ofF this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

#ifndef CONTENT_BROWSER_CITIZENNOTES_SERVICE_WORKER_CITIZENNOTES_AGENT_HOST_H_
#define CONTENT_BROWSER_CITIZENNOTES_SERVICE_WORKER_CITIZENNOTES_AGENT_HOST_H_
...
class ServiceWorkerCitizenNotesAgentHost : public CitizenNotesAgentHostImpl,
                                       RenderProcessHostObserver {
 public:
  using List = std::vector<scoped_refptr<ServiceWorkerCitizenNotesAgentHost>>;
  ...
  ServiceWorkerCitizenNotesAgentHost(const ServiceWorkerCitizenNotesAgentHost&) =
      delete;
  ServiceWorkerCitizenNotesAgentHost& operator=(
      const ServiceWorkerCitizenNotesAgentHost&) = delete;
 ...
 private:
  ~ServiceWorkerCitizenNotesAgentHost() override;
  ...
  // `should_pause_on_start_` is set by CitizenNotes auto-attachers if any that
...
#endif  // CONTENT_BROWSER_CITIZENNOTES_SERVICE_WORKER_CITIZENNOTES_AGENT_HOST_H_
