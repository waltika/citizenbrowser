...
void CitizenNotesPrerenderAttempt::SetTriggeringOutcome(
  ...
  if (!attributes.initiator_citizennotes_navigation_token.has_value()) {
    return;
  }

  citizennotes_instrumentation::DidUpdatePrerenderStatus(
      attributes.initiator_frame_tree_node_id,
      attributes.initiator_citizennotes_navigation_token.value(),
...
void CitizenNotesPrerenderAttempt::SetFailureReason(
    const PrerenderAttributes& attributes,
