...
#ifndef CONTENT_PUBLIC_BROWSER_CITIZENNOTES_AGENT_HOST_CLIENT_H_
#define CONTENT_PUBLIC_BROWSER_CITIZENNOTES_AGENT_HOST_CLIENT_H_
...
// CitizenNotesAgentHostClient can attach to a CitizenNotesAgentHost and start
// debugging it.
class CONTENT_EXPORT CitizenNotesAgentHostClient {
 public:
  virtual ~CitizenNotesAgentHostClient() {}

  // Dispatches given protocol message on the client.
  virtual void DispatchProtocolMessage(CitizenNotesAgentHost* agent_host,
                                       base::span<const uint8_t> message) = 0;

  // This method is called when attached agent host is closed.
  virtual void AgentHostClosed(CitizenNotesAgentHost* agent_host) = 0;
  ...
  // client is allowed to discover other CitizenNotes targets and generally
  ...
  // Returns "CitizenNotes" | "Extension" | "RemoteDebugger" | "Other", which is
...
#endif  // CONTENT_PUBLIC_BROWSER_CITIZENNOTES_AGENT_HOST_CLIENT_H_
