...
#ifndef CONTENT_PUBLIC_BROWSER_CITIZENNOTES_BACKGROUND_SERVICES_CONTEXT_H_
#define CONTENT_PUBLIC_BROWSER_CITIZENNOTES_BACKGROUND_SERVICES_CONTEXT_H_
...
enum class CitizenNotesBackgroundService {
  kBackgroundFetch = 2,
  kBackgroundSync = 3,
  kPushMessaging = 4,
  kNotifications = 5,
...
class CONTENT_EXPORT CitizenNotesBackgroundServicesContext {
 public:
  CitizenNotesBackgroundServicesContext() = default;

  CitizenNotesBackgroundServicesContext(const CitizenNotesBackgroundServicesContext&) =
      delete;
  CitizenNotesBackgroundServicesContext& operator=(
      const CitizenNotesBackgroundServicesContext&) = delete;

  virtual ~CitizenNotesBackgroundServicesContext() = default;

  // Whether events related to |service| should be recorded.
  virtual bool IsRecording(CitizenNotesBackgroundService service) = 0;
...
#endif  // CONTENT_PUBLIC_BROWSER_CITIZENNOTES_BACKGROUND_SERVICES_CONTEXT_H_
