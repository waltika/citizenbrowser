...
#ifndef CONTENT_PUBLIC_BROWSER_CITIZENNOTES_EXTERNAL_AGENT_PROXY_DELEGATE_H_
#define CONTENT_PUBLIC_BROWSER_CITIZENNOTES_EXTERNAL_AGENT_PROXY_DELEGATE_H_
...
class CitizenNotesExternalAgentProxy;

// Describes the interface for sending messages to an external CitizenNotes agent.
class CitizenNotesExternalAgentProxyDelegate {
 public:
  virtual ~CitizenNotesExternalAgentProxyDelegate() {}

  // Informs the agent that a client has attached.
  virtual void Attach(CitizenNotesExternalAgentProxy* proxy) = 0;

  // Informs the agent that a client has detached.
  virtual void Detach(CitizenNotesExternalAgentProxy* proxy) = 0;

  // Sends a message to the agent from a client.
  virtual void SendMessageToBackend(CitizenNotesExternalAgentProxy* proxy,
...
#endif  // CONTENT_PUBLIC_BROWSER_CITIZENNOTES_EXTERNAL_AGENT_PROXY_DELEGATE_H_
