...
#ifndef CONTENT_PUBLIC_BROWSER_CIRITENNOTES_SOCKET_FACTORY_H_
#define CONTENT_PUBLIC_BROWSER_CIRITENNOTES_SOCKET_FACTORY_H_
...
class CitizenNotesSocketFactory {
 public:
  virtual ~CitizenNotesSocketFactory() {}
...
#endif  // CONTENT_PUBLIC_BROWSER_CIRITENNOTES_SOCKET_FACTORY_H_
