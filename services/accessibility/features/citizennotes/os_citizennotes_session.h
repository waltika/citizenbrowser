...
#ifndef SERVICES_ACCESSIBILITY_FEATURES_CITIZENNOTES_OS_CITIZENNOTES_SESSION_H_
#define SERVICES_ACCESSIBILITY_FEATURES_CITIZENNOTES_OS_CITIZENNOTES_SESSION_H_
...
// This is a citizennotes session implementation for the accessibility service. It
// is owned by OSCitizenNotesAgent.
class OSCitizenNotesSession : public blink::mojom::CitizenNotesSession,
                          public crdtp::FrontendChannel,
                          public v8_inspector::V8Inspector::Channel {
 public:
  using SessionDestroyedCallback = base::OnceCallback<void(OSCitizenNotesSession*)>;

  OSCitizenNotesSession(
  ...
  OSCitizenNotesSession(const OSCitizenNotesSession&) = delete;
  OSCitizenNotesSession& operator=(const OSCitizenNotesSession&) = delete;
  ~OSCitizenNotesSession() override;
  ...
  // blink::mojom::CitizenNotesSession
 ...
 private:
  ...
  blink::mojom::CitizenNotesMessagePtr FinalizeMessage(
  ...
  mojo::AssociatedRemote<blink::mojom::CitizenNotesSessionHost> host_;
  mojo::AssociatedReceiver<blink::mojom::CitizenNotesSession> receiver_{this};
  ...
  base::WeakPtrFactory<OSCitizenNotesSession> weak_ptr_factory_{this};
};
}  // namespace ax
