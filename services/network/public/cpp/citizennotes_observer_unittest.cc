...
TEST(CitizenNotesObserverUtilTest, ExtractURLResponseHead) {
  ...
  mojom::URLResponseHeadCitizenNotesInfoPtr head_info = ExtractCitizenNotesInfo(head);
...
TEST(CitizenNotesObserverUtilTest, ExtractResourceRequest) {
  base::test::SingleThreadTaskEnvironment task_environment;
  ...
  mojom::URLRequestCitizenNotesInfoPtr request_info = ExtractCitizenNotesInfo(request);
