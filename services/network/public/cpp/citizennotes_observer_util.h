...
#ifndef SERVICES_NETWORK_PUBLIC_CPP_CITIZENNOTES_OBSERVER_UTIL_H_
#define SERVICES_NETWORK_PUBLIC_CPP_CITIZENNOTES_OBSERVER_UTIL_H_
...
#endif  // SERVICES_NETWORK_PUBLIC_CPP_CITIZENNOTES_OBSERVER_UTIL_H_
