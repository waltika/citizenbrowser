...
#include "third_party/blink/renderer/modules/filesystem/citizen_notes_host_file_system.h"
...
DOMFileSystem* CitizenNotesHostFileSystem::isolatedFileSystem(
    CitizenNotesHost& host,
...
void CitizenNotesHostFileSystem::upgradeDraggedFileSystemPermissions(
    CitizenNotesHost& host,
