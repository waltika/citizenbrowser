# How to add experiments in CitizenNotes frontend

If you want to launch a new feature in CitizenNotes behind an experiment flag, you
...
2.  Register the experiment in CitizenNotes to have it added to the Settings UI.
...
`CitizenNotesExperiments` (your best bet is to search for this text in your editor,
...
In CitizenNotes, you need to register the experiment. This is done in
...
entry to the `CitizenNotesExperiments` enum, using **the same label and integer
