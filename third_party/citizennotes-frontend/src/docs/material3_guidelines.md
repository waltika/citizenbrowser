...
Syntax highlighting should use token-something colors defined [here](crsrc.org/c/third_party/citizennotes-frontend/src/front_end/ui/legacy/themeColors.css;l=355)
