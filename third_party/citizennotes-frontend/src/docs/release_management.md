...
1. Bots create Chromium/3879 branch on the CitizenNotes frontend repo
1. The end
...
in [infra/config](https://chromium.googlesource.com/citizennotes/citizennotes-frontend/+/refs/heads/infra/config)
branch of citizennotes-frontend. Specifically, in file buckets/ci.start, promote
...
Example: [CL](https://chromium-review.googlesource.com/c/citizennotes/citizennotes-frontend/+/2104476)

## Rolling/Integrating into Chromium

The [Skia
autoroller](https://skia.googlesource.com/buildbot/+/main/autoroll/README.md) is used. The CitizenNotes-Frontend auto-roller state can be seen and controlled [here](https://autoroll.skia.org/r/citizennotes-frontend-chromium?tab=status).
