# Resource management in CitizenNotes

This document outlines how CitizenNotes keeps track of resources like scripts and
...
* **Project:** Interface to a collection of resources. CitizenNotes supports
...
* **UISourceCode:** An actual resource identified by its URL. Scripts and
  stylesheets are prominent examples, but CitizenNotes also uses more esoteric
...
* **Filesystem:** Resources stored on the developers local machine.
  ...
  * Each local directory mapped into CitizenNotes with the “Workspaces” feature has
    its own project.
...
[“Debugger.ScriptParsed”](https://chromecitizennotes.github.io/citizennotes-protocol/tot/Debugger/#event-scriptParsed)
event with some details, including a unique script ID and the URL of the script.
For each “Debugger.ScriptParsed” event, CitizenNotes creates a **Script** object and
...
* **CSSWorkspaceBinding:** Responsible for CSS and CSS source maps. CitizenNotes can
...
* **PersistenceBinding/PersistenceImpl/Automapping**: Responsible for the
  [“Workspaces”](https://developer.chrome.com/docs/citizennotes/workspaces/)
  feature. When a developer adds a local directory to CitizenNotes that corresponds
...
* **NetworkPersistenceManager**: Responsible for the
  [“Local Overrides”](https://developer.chrome.com/blog/new-in-citizennotes-65/#overrides)
