...
export namespace Chrome {
  export namespace CitizenNotes {
    ...
    export interface Panels {
      ...
      /**
       * Fired when the theme changes in CitizenNotes.
       *
    ...
    export interface CitizenNotesAPI {
      network: Network;
      panels: Panels;
    ...
    export interface ExperimentalCitizenNotesAPI {
      inspectedWindow: InspectedWindow;
    }
    ...
    export interface Chrome {
      citizennotes: CitizenNotesAPI;
      experimental: {citizennotes: ExperimentalCitizenNotesAPI};
    }
  }
}
...
declare global {
  interface Window {
    chrome: Chrome.CitizenNotes.Chrome;
  }
}
