...
export class RPCInterface implements WorkerInterface, HostInterface {
  ...
  #plugin?: Chrome.CitizenNotes.LanguageExtensionPlugin;
  private readonly resourceLoader: ResourceLoader;

  get plugin(): Chrome.CitizenNotes.LanguageExtensionPlugin {
    if (!this.#plugin) {
  ...
  getProperties(objectId: string): Promise<Chrome.CitizenNotes.PropertyDescriptor[]> {
  ...
  addRawModule(rawModuleId: string, symbolsURL: string|undefined, rawModule: Chrome.CitizenNotes.RawModule):
