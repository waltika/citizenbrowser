...
export class ModuleConfigurationList extends HTMLElement {
  ...
  private _render() {
    ...
    <p>
      ...
      path substitutions below that replace certain parts of the paths and tell Chrome CitizenNotes to
...
declare global {
  interface HTMLElementTagNameMap {
    'citizennotes-cxx-debugging-module-configuration-list': ModuleConfigurationList;
  }
}

customElements.define('citizennotes-cxx-debugging-module-configuration-list', ModuleConfigurationList);
