...
import {type TestWorkerInterface} from './CitizenNotesPluginTestWorker.js';
import {makeURL, TestHostInterface} from './TestUtils.js';

describe('CitizenNotesPlugin', () => {
  ...
  describe('HostInterface', () => {
    it('provides access to wasm state', async () => {
      ...
      const worker = new Worker('/build/tests/CitizenNotesPluginTestWorker.js', {type: 'module'});
