...
describe('CreditsItem', () => {
  it('is accessible', async () => {
    const el = await createItem(html`<citizennotes-cxx-debugging-credits-item></citizennotes-cxx-debugging-credits-item>`);
  ...
  it('can get and set data correctly', async () => {
    ...
    const el = await createItem(html`<citizennotes-cxx-debugging-credits-item .data=${
