...
import {WorkerPlugin} from '../src/CitizenNotesPluginHost.js';
...
export async function createWorkerPlugin(debug?: Debugger): Promise<Chrome.CitizenNotes.LanguageExtensionPlugin> {
