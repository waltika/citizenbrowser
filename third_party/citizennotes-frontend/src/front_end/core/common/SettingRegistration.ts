...
const UIStrings = {
  ...
  elements: 'Elements',
  /**
   *@description Text for CitizenNotes appearance
   */
  ...
  debugger: 'Debugger',
  /**
   *@description Text describing global shortcuts and settings that are available throughout the CitizenNotes
   */
  global: 'Global',
  /**
   ...
   * section allows users to configure which CitizenNotes data is synced via Chrome Sync.
   */
  sync: 'Sync',
};
...
export interface RegExpSettingItem {
   ...
   */
  disabledForUrl?: Platform.CitizenNotesPath.UrlString;
}
...
export interface SettingRegistration {
  ...
  /**
   * The title with which the setting is shown on screen, if the platform running CitizenNotes is 'mac'.
  ...
  /**
   * Whether CitizenNotes must be reloaded for a change in the setting to take effect.
   */
