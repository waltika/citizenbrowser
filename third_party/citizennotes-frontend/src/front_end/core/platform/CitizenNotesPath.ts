...
/**
 * File paths in CitizenNotes that are represented as URLs
 * @example
...
/**
 * File paths in CitizenNotes that are represented as unencoded absolute
 * or relative paths
 * @example
 * “/Hello World/file.js”
 */
...
/**
 * File paths in CitizenNotes that are represented as encoded paths
 * @example
