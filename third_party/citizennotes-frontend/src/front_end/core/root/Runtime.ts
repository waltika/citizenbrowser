...
export function getRemoteBase(location: string = self.location.toString()): {
  ...
  return {base: `citizennotes://citizennotes/remote/serve_file/${version[1]}/`, version: version[1]};
}
...
export class ExperimentsSupport {
  ...
  register(
    ...
    this.#experiments.push(new Experiment(
        ...
        docLink as Platform.CitizenNotesPath.UrlString ?? Platform.CitizenNotesPath.EmptyUrlString,
        feedbackLink as Platform.CitizenNotesPath.UrlString ?? Platform.CitizenNotesPath.EmptyUrlString));
  }
...
export class Experiment {
  ...
  title: string;
  unstable: boolean;
  docLink?: Platform.CitizenNotesPath.UrlString;
  readonly feedbackLink?: Platform.CitizenNotesPath.UrlString;
  readonly #experiments: ExperimentsSupport;
  constructor(
      experiments: ExperimentsSupport, name: string, title: string, unstable: boolean,
      docLink: Platform.CitizenNotesPath.UrlString, feedbackLink: Platform.CitizenNotesPath.UrlString) {
    this.name = name;
    this.title = title;
