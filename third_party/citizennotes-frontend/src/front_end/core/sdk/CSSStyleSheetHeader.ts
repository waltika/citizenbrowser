...
export class CSSStyleSheetHeader implements TextUtils.ContentProvider.ContentProvider, FrameAssociated {
  ...
  sourceMapURL: Platform.CitizenNotesPath.UrlString|undefined;
  ...
  constructor(cssModel: CSSModel, payload: Protocol.CSS.CSSStyleSheetHeader) {
    ...
    this.sourceURL = payload.sourceURL as Platform.CitizenNotesPath.UrlString;
    ...
    this.sourceMapURL = payload.sourceMapURL as Platform.CitizenNotesPath.UrlString;
  ...
  setSourceMapURL(sourceMapURL?: Platform.CitizenNotesPath.UrlString): void {
  ...
  resourceURL(): Platform.CitizenNotesPath.UrlString {
  ...
  private viaInspectorResourceURL(): Platform.CitizenNotesPath.UrlString {
    return `inspector://${this.getFrameURLPath()}inspector-stylesheet` as Platform.CitizenNotesPath.UrlString;
  }

  private dynamicStyleURL(): Platform.CitizenNotesPath.UrlString {
    return `stylesheet://${this.getFrameURLPath()}style#${this.id}` as Platform.CitizenNotesPath.UrlString;
  }
  ...
  createPageResourceLoadInitiator(): PageResourceLoadInitiator {
    return {
      ...
      initiatorUrl: this.hasSourceURL ? Platform.CitizenNotesPath.EmptyUrlString : this.sourceURL,
    };
  }
}
