...
export class DOMDebuggerModel extends SDKModel<EventTypes> {
  ...
  private currentURL(): Platform.CitizenNotesPath.UrlString {
    const domDocument = this.#domModel.existingDocument();
    return domDocument ? domDocument.documentURL : Platform.CitizenNotesPath.EmptyUrlString;
  }
  ...
  private async documentUpdated(): Promise<void> {
    ...
    const currentURL = document ? document.documentURL : Platform.CitizenNotesPath.EmptyUrlString;
...
export class EventListener {
  ...
  readonly #sourceURLInternal: Platform.CitizenNotesPath.UrlString;
  ...
  constructor(
    ...
    this.#sourceURLInternal = script ? script.contentURL() : Platform.CitizenNotesPath.EmptyUrlString;
