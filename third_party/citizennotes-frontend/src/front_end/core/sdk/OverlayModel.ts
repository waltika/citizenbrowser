...
export class OverlayModel extends SDKModel<EventTypes> implements ProtocolProxyApi.OverlayDispatcher {
  ...
  async hasStyleSheetText(url: Platform.CitizenNotesPath.UrlString): Promise<boolean> {
...
export class WindowControls {
  ...
  #currentUrl: Platform.CitizenNotesPath.UrlString|undefined;
  ...
  async initializeStyleSheetText(url: Platform.CitizenNotesPath.UrlString): Promise<boolean> {
  ...
  #fetchCssSourceUrl(url: Platform.CitizenNotesPath.UrlString): Platform.CitizenNotesPath.UrlString|undefined {
  ...
  #fetchCurrentStyleSheet(cssSourceUrl: Platform.CitizenNotesPath.UrlString): Protocol.CSS.StyleSheetId|undefined {
