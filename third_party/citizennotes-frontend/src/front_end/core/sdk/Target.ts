...
export class Target extends ProtocolClient.InspectorBackend.TargetBase {
  ...
  #nameInternal: string;
  #inspectedURLInternal: Platform.CitizenNotesPath.UrlString;
  ...
  constructor(
    ...
    this.#inspectedURLInternal = Platform.CitizenNotesPath.EmptyUrlString;
    ...
    switch (type) {
      case Type.Frame:
        ...
        if (parentTarget?.type() !== Type.Frame) {
          ...
          if (Common.ParsedURL.schemeIs(targetInfo?.url as Platform.CitizenNotesPath.UrlString, 'chrome-extension:')) {
  ...
  inspectedURL(): Platform.CitizenNotesPath.UrlString {
    return this.#inspectedURLInternal;
  }

  setInspectedURL(inspectedURL: Platform.CitizenNotesPath.UrlString): void {
