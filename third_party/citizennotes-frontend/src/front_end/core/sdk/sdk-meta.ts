...
const UIStrings = {
   ...
   * @description Title of a setting under the Network category that can be invoked through the Command Menu
   */
  disableCache: 'Disable cache (while CitizenNotes is open)',
  /**
  ...
  /**
   * @description Label of a checkbox in the CitizenNotes settings UI.
   */
  enableRemoteFileLoading:
      'Allow `CitizenNotes` to load resources, such as source maps, from remote file paths. Disabled by default for security reasons.',
};
