...
const UIStrings = {
   ...
   * CitizenNotes is connected to. This text is used in various places in the UI as a label/name to inform
   * the user which target/webpage they are currently connected to, as CitizenNotes may connect to multiple
   ...
   * CitizenNotes is connected to. This text is used in various places in the UI as a label/name to inform
   * the user which target they are currently connected to, as CitizenNotes may connect to multiple
   * targets at the same time in some scenarios.
   */
  tab: 'Tab',
  /**
   * @description A warning shown to the user when JavaScript is disabled on the webpage that
   * CitizenNotes is connected to.
   */
  javascriptIsDisabled: 'JavaScript is disabled',
  /**
   * @description A message that prompts the user to open citizennotes for a specific environment (Node.js)
   */
  openDedicatedTools: 'Open dedicated CitizenNotes for `Node.js`',
};
