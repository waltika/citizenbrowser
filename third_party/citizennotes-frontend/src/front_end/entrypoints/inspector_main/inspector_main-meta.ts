...
const UIStrings = {
   ...
   * website.
   * https://developer.chrome.com/docs/citizennotes/evaluate-performance/reference#rendering
   */
  rendering: 'Rendering',
  /**
  ...
  /**
   * @description A command available in the command menu to automatically open CitizenNotes when
   * webpages create new popup windows.
   */
  autoOpenCitizenNotes: 'Auto-open CitizenNotes for popups',
  /**
   * @description A command available in the command menu to stop automatically opening CitizenNotes when
   * webpages create new popup windows.
   */
  doNotAutoOpen: 'Do not auto-open CitizenNotes for popups',
  /**
   * @description Title of a setting under the Appearance category in Settings. When the webpage is
   * paused by citizennotes, an overlay is shown on top of the page to indicate that it is paused. The
...
Common.Settings.registerSettingExtension({
  ...
  title: i18nLazyString(UIStrings.autoOpenCitizenNotes),
