...
export const UIStrings = {
  ...
  /**
   * @description A deprecation warning shown to developers in the CitizenNotes Issues tab when code tries to use the deprecated hostCandidate field, guiding developers to use the equivalent information in the .address and .port fields instead.
   */
  ...
  /**
   * @description A deprecation warning shown in the CitizenNotes Issues tab, when a service worker reads one of the fields from an event named 'canmakepayment'.
   */
  ...
  /**
   * @description A deprecation warning shown in the CitizenNotes Issues tab. It's shown when a video conferencing website attempts to use a non-standard crypto method when performing a handshake to set up a connection with another endpoint.
   */
  ...
  /**
   * @description A deprecation warning shown in the CitizenNotes Issues tab. It's shown when a video conferencing website uses a non-standard API for controlling the crypto method used, but is not having an effect because the desired behavior is already enabled-by-default.
   */
  ...
  /**
   * @description A deprecation warning shown in the CitizenNotes Issues tab. It's shown then a video conferencing website attempts to use the `RTCP MUX` policy.
   */
  RtcpMuxPolicyNegotiate: "The `rtcpMuxPolicy` option is deprecated and will be removed.",
  /**
   * @description A deprecation warning shown in the CitizenNotes Issues tab. The placeholder is always the noun 'SharedArrayBuffer' which refers to a JavaScript construct.
   */
  ...
  /**
   * @description A deprecation warning shown in the CitizenNotes Issues tab. It's shown when the speech synthesis API is called before the page receives a user activation.
   */
  TextToSpeech_DisallowedByAutoplay: "`speechSynthesis.speak()` without user activation is deprecated and will be removed.",
  /**
   * @description A deprecation warning shown in the CitizenNotes Issues tab. The placeholder is always the noun 'SharedArrayBuffer' which refers to a JavaScript construct. 'Extensions' refers to Chrome extensions. The warning is shown when Chrome Extensions attempt to use 'SharedArrayBuffer's under insecure circumstances.
   */
  ...
  /**
   * @description A deprecation warning shown in the CitizenNotes Issues tab. 'window-placement' and 'window-management' are the name of the javascript descriptors (do not translate). The warning is shown when web pages attempt to use 'window-placement' in permission APIs (e.g. navigator.permissions.query(...))
   */
  ...
  /**
   * @description A deprecation warning shown in the CitizenNotes Issues tab. 'window-placement' and 'window-management' are the name of the policy descriptors (do not translate). The warning is shown when web pages attempt to use 'window-placement' as a permission policy (parsed in iframe or header).
   */
