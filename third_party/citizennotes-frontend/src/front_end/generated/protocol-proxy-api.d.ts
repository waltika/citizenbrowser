...
declare namespace ProtocolProxyApi {
  ...
  export interface BrowserApi {
    ...
    /**
     * Get the browser window that contains the citizennotes target.
     */
  ...
  export interface SecurityApi {
     ...
     * be handled by the CitizenNotes client and should be answered with `handleCertificateError` commands.
     */
  ...
  export interface TargetApi {
     ...
     */
    invoke_exposeCitizenNotesProtocol(params: Protocol.Target.ExposeCitizenNotesProtocolRequest): Promise<Protocol.ProtocolResponseWithError>;
