...
export namespace Audits {
   ...
   * third_party/blink/public/mojom/citizennotes/inspector_issue.mojom to include
   ...
   * third_party/blink/public/mojom/citizennotes/inspector_issue.mojom.
   */
  ...
  /**
   * A unique id for a CitizenNotes inspector issue. Allows other entities (e.g.
...
export namespace Browser {
  ...
  export interface GetWindowForTargetRequest {
    /**
     * Citizennotes agent host id. If called as a part of the session, associated targetId is used.
     */
...
export namespace CSS {
  ...
  export interface CSSStyleSheetHeader {
     ...
     * `<link>` element's stylesheets become mutable only if CitizenNotes modifies them.
...
/**
 * Input/Output operations for streams produced by CitizenNotes.
 */
export namespace IO {
...
export namespace Storage {
  ...
  export interface SharedStorageAccessedEvent {
    ...
    /**
     * CitizenNotes Frame Token for the primary frame tree's root.
     */
...
export namespace Target {
  ...
  export interface ExposeCitizenNotesProtocolRequest {
    targetId: TargetID;
    /**
  ...
  export interface CreateTargetRequest {
    ...
    browserContextId?: Browser.BrowserContextID;
    /**
     * Whether BeginFrames for this target will be controlled via CitizenNotes (headless chrome only,
...
export namespace Preload {
  ...
  export const enum PrerenderFinalStatus {
    ...
    PrerenderingDisabledByCitizenNotes = 'PrerenderingDisabledByCitizenNotes',
