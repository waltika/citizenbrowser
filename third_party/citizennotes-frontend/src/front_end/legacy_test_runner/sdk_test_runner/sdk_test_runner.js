...
SDKTestRunner.PageMock = class {
  ...
  dispatch(sessionId, id, methodName, params) {
    ...
    this.sendResponse(
        id, undefined,
        {message: 'Can\'t handle command ' + methodName, code: ProtocolClient.InspectorBackend.CitizenNotesStubErrorCode});
  }
  ...
  sendResponse(id, result, error) {
    ...
    if (this.root) {
      ...
      this.root.connection.sendMessageToCitizenNotes(message);
    } else {
      this.connection.sendMessageToCitizenNotes(message);
    }
  }
...
class MockPageConnection {
  ...
  sendMessageToCitizenNotes(message) {
