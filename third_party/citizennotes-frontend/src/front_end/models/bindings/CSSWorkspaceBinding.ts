...
export class ModelInfo {
  ...
  readonly #unboundLocations: Platform.MapUtilities.Multimap<Platform.CitizenNotesPath.UrlString, LiveLocation>;
  ...
  addSourceMap(sourceUrl: Platform.CitizenNotesPath.UrlString, sourceMapUrl: Platform.CitizenNotesPath.UrlString): void {
