...
export class IgnoreListManager implements SDK.TargetManager.SDKModelObserver<SDK.DebuggerModel.DebuggerModel> {
  ...
  isUserIgnoreListedURL(url: Platform.CitizenNotesPath.UrlString|null, options?: IgnoreListGeneralRules): boolean {
  ...
  private uiSourceCodeURL(uiSourceCode: Workspace.UISourceCode.UISourceCode): Platform.CitizenNotesPath.UrlString|null {
  ...
  ignoreListURL(url: Platform.CitizenNotesPath.UrlString): void {
  ...
  private ignoreListRegex(regexValue: string, disabledForUrl?: Platform.CitizenNotesPath.UrlString): void {
  ...
  unIgnoreListURL(url: Platform.CitizenNotesPath.UrlString|null, options?: IgnoreListGeneralRules): void {
  ...
  private urlToRegExpString(url: Platform.CitizenNotesPath.UrlString): string {
  ...
  getIgnoreListFolderContextMenuItems(url: Platform.CitizenNotesPath.UrlString, options?: IgnoreListGeneralRules):
