...
export class WorkspaceSettingsTab extends UI.Widget.VBox {
  ...
  private readonly elementByPath: Map<Platform.CitizenNotesPath.UrlString, Element>;
  private readonly mappingViewByPath: Map<Platform.CitizenNotesPath.UrlString, EditFileSystemView>;
  private constructor() {
    super();
