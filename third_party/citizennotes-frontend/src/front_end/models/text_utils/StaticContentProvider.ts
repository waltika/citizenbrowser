...
export class StaticContentProvider implements ContentProvider {
  private readonly contentURLInternal: Platform.CitizenNotesPath.UrlString;
  ...
  constructor(
      contentURL: Platform.CitizenNotesPath.UrlString, contentType: Common.ResourceType.ResourceType,
