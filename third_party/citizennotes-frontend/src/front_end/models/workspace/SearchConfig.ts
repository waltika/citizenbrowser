...
export class SearchConfig {
  ...
  filePathMatchesFileQuery(filePath: Platform.CitizenNotesPath.RawPathString|
                           Platform.CitizenNotesPath.EncodedPathString|Platform.CitizenNotesPath.UrlString): boolean {
