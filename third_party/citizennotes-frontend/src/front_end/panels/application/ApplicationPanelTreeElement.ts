...
export class ApplicationPanelTreeElement extends UI.TreeOutline.TreeElement {
  ...
  get itemURL(): Platform.CitizenNotesPath.UrlString {
  ...
  override onselect(selectedByUser: boolean|undefined): boolean {
    ...
    const path: Platform.CitizenNotesPath.UrlString[] = [];
...
export class ExpandableApplicationPanelTreeElement extends ApplicationPanelTreeElement {
  ...
  protected categoryLink: Platform.CitizenNotesPath.UrlString|null;
  ...
  override get itemURL(): Platform.CitizenNotesPath.UrlString {
    return 'category://' + this.categoryName as Platform.CitizenNotesPath.UrlString;
  }

  setLink(link: Platform.CitizenNotesPath.UrlString): void {
