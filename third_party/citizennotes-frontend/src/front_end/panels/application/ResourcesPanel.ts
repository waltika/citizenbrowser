...
export class ResourcesPanel extends UI.Panel.PanelWithSidebar {
  private readonly resourcesLastSelectedItemSetting: Common.Settings.Setting<Platform.CitizenNotesPath.UrlString[]>;
  ...
  lastSelectedItemPath(): Platform.CitizenNotesPath.UrlString[] {
    return this.resourcesLastSelectedItemSetting.get();
  }

  setLastSelectedItemPath(path: Platform.CitizenNotesPath.UrlString[]): void {
  ...
  showCategoryView(categoryName: string, categoryLink: Platform.CitizenNotesPath.UrlString|null): void {
    ...
    const learnMoreLink = categoryName === 'Web SQL' ?
        'https://developer.chrome.com/blog/deprecating-web-sql/' as Platform.CitizenNotesPath.UrlString :
        Platform.CitizenNotesPath.EmptyUrlString;
