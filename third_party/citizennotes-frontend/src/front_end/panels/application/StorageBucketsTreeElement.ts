...
export class StorageBucketsTreeParentElement extends ExpandableApplicationPanelTreeElement {
  ...
  constructor(storagePanel: ResourcesPanel) {
    ...
    this.setLink(
        'https://github.com/WICG/storage-buckets/blob/gh-pages/explainer.md' as Platform.CitizenNotesPath.UrlString);
  }
  ...
  override get itemURL(): Platform.CitizenNotesPath.UrlString {
    return 'storage-buckets-group://' as Platform.CitizenNotesPath.UrlString;
  }
...
export class StorageBucketsTreeElement extends ExpandableApplicationPanelTreeElement {
  ...
  override get itemURL(): Platform.CitizenNotesPath.UrlString {
    const {bucket} = this.bucketInfo;
    return `storage-buckets-group://${bucket.name}/${bucket.storageKey}` as Platform.CitizenNotesPath.UrlString;
  }
