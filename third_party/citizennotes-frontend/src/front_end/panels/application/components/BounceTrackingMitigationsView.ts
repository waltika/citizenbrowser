...
export class BounceTrackingMitigationsView extends LegacyWrapper.LegacyWrapper.WrappableComponent {
  static readonly litTagName = LitHtml.literal`citizennotes-bounce-tracking-mitigations-view`;
  ...
  async #renderMainFrameInformation(): Promise<LitHtml.TemplateResult> {
    ...
    if (this.#screenStatus === ScreenStatusType.Disabled) {
      ...
      mitigationsFlagLink.href = 'chrome://flags/#bounce-tracking-mitigations' as Platform.CitizenNotesPath.UrlString;
...
ComponentHelpers.CustomElements.defineComponent(
    'citizennotes-bounce-tracking-mitigations-view', BounceTrackingMitigationsView);
