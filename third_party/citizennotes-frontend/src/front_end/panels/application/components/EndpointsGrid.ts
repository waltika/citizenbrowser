...
export class EndpointsGrid extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-resources-endpoints-grid`;
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-resources-endpoints-grid', EndpointsGrid);

declare global {
  interface HTMLElementTagNameMap {
    'citizennotes-resources-endpoints-grid': EndpointsGrid;
  }
}
