...
export class FrameDetailsReportView extends LegacyWrapper.LegacyWrapper.WrappableComponent {
  static readonly litTagName = LitHtml.literal`citizennotes-resources-frame-details-view`;
  ...
  #maybeRenderAdStatus(): LitHtml.LitTemplate {
    ...
    const adScriptLinkElement = this.#target ? this.#linkifier.linkifyScriptLocation(
                                                   ...
                                                   Platform.CitizenNotesPath.EmptyUrlString, undefined, undefined) :
                                               null;
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-resources-frame-details-view', FrameDetailsReportView);

declare global {
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  interface HTMLElementTagNameMap {
    'citizennotes-resources-frame-details-view': FrameDetailsReportView;
  }
}
