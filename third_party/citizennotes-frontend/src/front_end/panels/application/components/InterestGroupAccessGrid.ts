...
export class InterestGroupAccessGrid extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-interest-group-access-grid`;
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-interest-group-access-grid', InterestGroupAccessGrid);

declare global {
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  interface HTMLElementTagNameMap {
    'citizennotes-interest-group-access-grid': InterestGroupAccessGrid;
  }
}
