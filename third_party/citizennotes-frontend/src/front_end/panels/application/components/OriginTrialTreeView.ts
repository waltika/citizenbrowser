...
export class Badge extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-resources-origin-trial-tree-view-badge`;
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-resources-origin-trial-tree-view-badge', Badge);
...
export class OriginTrialTokenRows extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-resources-origin-trial-token-rows`;
  readonly #shadow = this.attachShadow({mode: 'open'});
  ...
  #dateFormatter: Intl.DateTimeFormat = new Intl.DateTimeFormat(
      i18n.CitizenNotesLocale.CitizenNotesLocale.instance().locale,
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-resources-origin-trial-token-rows', OriginTrialTokenRows);
...
export class OriginTrialTreeView extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-resources-origin-trial-tree-view`;
  readonly #shadow = this.attachShadow({mode: 'open'});
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-resources-origin-trial-tree-view', OriginTrialTreeView);

declare global {
  interface HTMLElementTagNameMap {
    'citizennotes-resources-origin-trial-tree-view': OriginTrialTreeView;
    'citizennotes-resources-origin-trial-token-rows': OriginTrialTokenRows;
    'citizennotes-resources-origin-trial-tree-view-badge': Badge;
  }
}
