...
export class PermissionsPolicySection extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-resources-permissions-policy-section`;
...
ComponentHelpers.CustomElements.defineComponent(
    'citizennotes-resources-permissions-policy-section', PermissionsPolicySection);
