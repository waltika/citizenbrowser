...
export interface ProtocolHandlersData {
  ...
  manifestLink: Platform.CitizenNotesPath.UrlString;
}

export class ProtocolHandlersView extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-protocol-handlers-view`;
  readonly #shadow = this.attachShadow({mode: 'open'});
  #protocolHandlers: ProtocolHandler[] = [];
  #manifestLink: Platform.CitizenNotesPath.UrlString = Platform.CitizenNotesPath.EmptyUrlString;
  ...
  #renderProtocolTest(): LitHtml.LitTemplate {
    ...
    return LitHtml.html`
       <div class="protocol-handlers-row">
        ...
        <input .value=${this.#queryInputState} class="citizennotes-text-input" type="text" @change=${
  ...
  #handleTestProtocolClick = (): void => {
    const protocolURL = `${this.#selectedProtocolState}://${this.#queryInputState}` as Platform.CitizenNotesPath.UrlString;
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-protocol-handlers-view', ProtocolHandlersView);

declare global {
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  interface HTMLElementTagNameMap {
    'citizennotes-protocol-handlers-view': ProtocolHandlersView;
  }
}
