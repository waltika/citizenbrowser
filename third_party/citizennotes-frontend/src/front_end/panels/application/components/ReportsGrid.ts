...
export class ReportsGridStatusHeader extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-resources-reports-grid-status-header`;
...
export class ReportsGrid extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-resources-reports-grid`;
...
ComponentHelpers.CustomElements.defineComponent(
    'citizennotes-resources-reports-grid-status-header', ReportsGridStatusHeader);
ComponentHelpers.CustomElements.defineComponent('citizennotes-resources-reports-grid', ReportsGrid);

declare global {
  interface HTMLElementTagNameMap {
    'citizennotes-resources-reports-grid-status-header': ReportsGridStatusHeader;
    'citizennotes-resources-reports-grid': ReportsGrid;
  }
}
