...
export class SharedStorageAccessGrid extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-shared-storage-access-grid`;
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-shared-storage-access-grid', SharedStorageAccessGrid);

declare global {
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  interface HTMLElementTagNameMap {
    'citizennotes-shared-storage-access-grid': SharedStorageAccessGrid;
  }
}
