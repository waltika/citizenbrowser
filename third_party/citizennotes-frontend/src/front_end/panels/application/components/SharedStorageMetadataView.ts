...
class SharedStorageResetBudgetButton extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-shared-storage-reset-budget-button`;
...
export class SharedStorageMetadataView extends StorageMetadataView {
  static override readonly litTagName = LitHtml.literal`citizennotes-shared-storage-metadata-view`;
...
ComponentHelpers.CustomElements.defineComponent(
    'citizennotes-shared-storage-reset-budget-button', SharedStorageResetBudgetButton);
ComponentHelpers.CustomElements.defineComponent('citizennotes-shared-storage-metadata-view', SharedStorageMetadataView);

declare global {
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  interface HTMLElementTagNameMap {
    'citizennotes-shared-storage-metadata-view': SharedStorageMetadataView;
    'citizennotes-shared-storage-reset-budget-button': SharedStorageResetBudgetButton;
  }
}
