...
export class StackTraceRow extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-stack-trace-row`;
...
export class StackTraceLinkButton extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-stack-trace-link-button`;
  readonly #shadow = this.attachShadow({mode: 'open'});
...
export class StackTrace extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-resources-stack-trace`;
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-stack-trace-row', StackTraceRow);
ComponentHelpers.CustomElements.defineComponent('citizennotes-stack-trace-link-button', StackTraceLinkButton);
ComponentHelpers.CustomElements.defineComponent('citizennotes-resources-stack-trace', StackTrace);

declare global {
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  interface HTMLElementTagNameMap {
    'citizennotes-stack-trace-row': StackTraceRow;
    'citizennotes-stack-trace-link-button': StackTraceLinkButton;
    'citizennotes-resources-stack-trace': StackTrace;
  }
}
