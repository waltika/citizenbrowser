...
export class StorageMetadataView extends LegacyWrapper.LegacyWrapper.WrappableComponent {
  static readonly litTagName = LitHtml.literal`citizennotes-storage-metadata-view`;
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-storage-metadata-view', StorageMetadataView);

declare global {
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  interface HTMLElementTagNameMap {
    'citizennotes-storage-metadata-view': StorageMetadataView;
  }
}
