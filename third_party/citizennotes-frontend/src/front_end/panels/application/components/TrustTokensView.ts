...
class TrustTokensDeleteButton extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-trust-tokens-delete-button`;
...
export class TrustTokensView extends LegacyWrapper.LegacyWrapper.WrappableComponent {
  static readonly litTagName = LitHtml.literal`citizennotes-trust-tokens-storage-view`;
  readonly #shadow = this.attachShadow({mode: 'open'});
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-trust-tokens-delete-button', TrustTokensDeleteButton);
ComponentHelpers.CustomElements.defineComponent('citizennotes-trust-tokens-storage-view', TrustTokensView);

declare global {
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  interface HTMLElementTagNameMap {
    'citizennotes-trust-tokens-storage-view': TrustTokensView;
    'citizennotes-trust-tokens-delete-button': TrustTokensDeleteButton;
  }
}
