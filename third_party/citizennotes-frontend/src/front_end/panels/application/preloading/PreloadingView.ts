...
class PreloadingUIUtils {
  ...
  static ruleSetLocationShort(ruleSet: Protocol.Preload.RuleSet, pageURL: Platform.CitizenNotesPath.UrlString): string {
...
function pageURL(): Platform.CitizenNotesPath.UrlString {
  return SDK.TargetManager.TargetManager.instance().scopeTarget()?.inspectedURL() ||
      ('' as Platform.CitizenNotesPath.UrlString);
}
...
export class PreloadingRuleSetView extends UI.Widget.VBox {
  ...
  constructor(model: SDK.PreloadingModel.PreloadingModel) {
    ...
    this.hsplit = this.contentElement.querySelector('citizennotes-split-view') as SplitView.SplitView.SplitView;
  }
