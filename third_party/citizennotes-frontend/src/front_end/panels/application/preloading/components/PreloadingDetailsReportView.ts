...
export class PreloadingDetailsReportView extends LegacyWrapper.LegacyWrapper.WrappableComponent<UI.Widget.VBox> {
  static readonly litTagName = LitHtml.literal`citizennotes-resources-preloading-details-report-view`;
  ...
  #renderRuleSet(ruleSet: Protocol.Preload.RuleSet, pageURL: Platform.CitizenNotesPath.UrlString): LitHtml.LitTemplate {
...
ComponentHelpers.CustomElements.defineComponent(
    'citizennotes-resources-preloading-details-report-view', PreloadingDetailsReportView);
