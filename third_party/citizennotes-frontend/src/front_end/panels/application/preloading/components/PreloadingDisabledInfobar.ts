...
export class PreloadingDisabledInfobar extends LegacyWrapper.LegacyWrapper.WrappableComponent<UI.Widget.VBox> {
  static readonly litTagName = LitHtml.literal`citizennotes-resources-preloading-disabled-infobar`;
  ...
  #dialogContents(): LitHtml.LitTemplate {
    ...
    const iconLink = UI.Fragment.html`
      <x-link class="icon-link citizennotes-link" tabindex="0" href="${LINK}"></x-link>
    ` as UI.XLink.XLink;
  ...
  #maybeDisalebByPreference(): LitHtml.LitTemplate {
    ...
    preloadingSettingLink.href = 'chrome://settings/performance' as Platform.CitizenNotesPath.UrlString;
    ...
    extensionsSettingLink.href = 'chrome://extensions' as Platform.CitizenNotesPath.UrlString;
...
ComponentHelpers.CustomElements.defineComponent(
    'citizennotes-resources-preloading-disabled-infobar', PreloadingDisabledInfobar);
