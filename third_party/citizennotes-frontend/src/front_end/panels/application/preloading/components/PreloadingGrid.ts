...
export class PreloadingGrid extends LegacyWrapper.LegacyWrapper.WrappableComponent<UI.Widget.VBox> {
  static readonly litTagName = LitHtml.literal`citizennotes-resources-preloading-grid`;
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-resources-preloading-grid', PreloadingGrid);

declare global {
  interface HTMLElementTagNameMap {
    'citizennotes-resources-preloading-grid': PreloadingGrid;
  }
}
