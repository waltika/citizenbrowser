...
export class PreloadingMismatchedHeadersGrid extends LegacyWrapper.LegacyWrapper.WrappableComponent<UI.Widget.VBox> {
  static readonly litTagName = LitHtml.literal`citizennotes-resources-preloading-mismatched-headers-grid`;
...
ComponentHelpers.CustomElements.defineComponent(
    'citizennotes-resources-preloading-mismatched-headers-grid', PreloadingMismatchedHeadersGrid);
