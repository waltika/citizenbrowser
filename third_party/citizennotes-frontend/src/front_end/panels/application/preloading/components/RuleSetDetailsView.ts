...
ComponentHelpers.CustomElements.defineComponent('citizennotes-resources-rulesets-details-view', RuleSetDetailsView);

declare global {
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  interface HTMLElementTagNameMap {
    'citizennotes-resources-rulesets-details-view': RuleSetDetailsView;
  }
}
