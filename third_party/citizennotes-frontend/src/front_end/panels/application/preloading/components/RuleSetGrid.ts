...
export class RuleSetGrid extends LegacyWrapper.LegacyWrapper.WrappableComponent<UI.Widget.VBox> {
  static readonly litTagName = LitHtml.literal`citizennotes-resources-ruleset-grid`;
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-resources-ruleset-grid', RuleSetGrid);

declare global {
  interface HTMLElementTagNameMap {
    'citizennotes-resources-ruleset-grid': RuleSetGrid;
  }
}

function ruleSetRenderer(
    ruleSet: Protocol.Preload.RuleSet, pageURL: Platform.CitizenNotesPath.UrlString): LitHtml.TemplateResult {
