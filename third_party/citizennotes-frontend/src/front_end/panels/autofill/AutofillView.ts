...
export class AutofillView extends LegacyWrapper.LegacyWrapper.WrappableComponent implements
  ...
  static readonly litTagName = LitHtml.literal`citizennotes-autofill-view`;
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-autofill-view', AutofillView);

declare global {
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  interface HTMLElementTagNameMap {
    'citizennotes-autofill-view': AutofillView;
  }
}
