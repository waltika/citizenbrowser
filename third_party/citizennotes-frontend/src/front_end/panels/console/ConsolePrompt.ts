...
const UIStrings = {
  ...
  /**
   *@description Warning shown to users when pasting text into the CitizenNotes console.
   *@example {allow pasting} PH1
   */
  selfXssWarning:
      'Warning: Don’t paste code into the CitizenNotes Console that you don’t understand or haven’t reviewed yourself. This could allow attackers to steal your identity or take control of your computer. Please type ‘{PH1}’ below to allow pasting.',
  /**
...
export class ConsolePrompt extends Common.ObjectWrapper.eventMixin<EventTypes, typeof UI.Widget.Widget>(
  ...
  constructor() {
    ...
    Host.userMetrics.panelLoaded('console', 'CitizenNotes.Launch.Console');
