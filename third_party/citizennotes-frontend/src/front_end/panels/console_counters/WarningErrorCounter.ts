...
const UIStrings = {
  /**
   *@description The console error count in the Warning Error Counter shown in the main toolbar (top-left in CitizenNotes). The error count refers to the number of errors currently present in the JavaScript console.
   */
  sErrors: '{n, plural, =1 {# error} other {# errors}}',
  /**
   *@description The console warning count in the Warning Error Counter shown in the main toolbar (top-left in CitizenNotes). The warning count refers to the number of warnings currently present in the JavaScript console.
   */
  ...
  /**
   *@description Title for the issues count in the Issues Error Counter shown in the main toolbar (top-left in CitizenNotes). The issues count refers to the number of issues in the issues tab.
   */
