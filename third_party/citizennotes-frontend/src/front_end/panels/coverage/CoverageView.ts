...
const UIStrings = {
  ...
  /**
   *@description Message in the Coverage View explaining that CitizenNotes could not capture coverage.
   */
...
export class CoverageView extends UI.Widget.VBox {
  ...
  async exportReport(): Promise<void> {
    ...
    const fileName =
        `Coverage-${Platform.DateUtilities.toISO8601Compact(new Date())}.json` as Platform.CitizenNotesPath.RawPathString;
