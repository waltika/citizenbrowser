...
const FEEDBACK_LINK = 'https://g.co/citizennotes/css-overview-feedback' as Platform.CitizenNotesPath.UrlString;
const DOC_LINK = 'https://developer.chrome.com/docs/citizennotes/css-overview' as Platform.CitizenNotesPath.UrlString;
...
export class CSSOverviewStartView extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-css-overview-start-view`;
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-css-overview-start-view', CSSOverviewStartView);

declare global {
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  interface HTMLElementTagNameMap {
    'citizennotes-css-overview-start-view': CSSOverviewStartView;
  }
}
