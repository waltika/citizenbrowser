...
export class AccessibilityTreeNode extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-accessibility-tree-node`;
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-accessibility-tree-node', AccessibilityTreeNode);

declare global {
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  interface HTMLElementTagNameMap {
    'citizennotes-accessibility-tree-node': AccessibilityTreeNode;
  }
}
