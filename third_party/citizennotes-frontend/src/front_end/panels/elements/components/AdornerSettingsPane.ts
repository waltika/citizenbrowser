...
export class AdornerSettingsPane extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-adorner-settings-pane`;
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-adorner-settings-pane', AdornerSettingsPane);

declare global {
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  interface HTMLElementTagNameMap {
    'citizennotes-adorner-settings-pane': AdornerSettingsPane;
  }
}
