...
export class CSSHintDetailsView extends HTMLElement {
    static readonly litTagName = LitHtml.literal`citizennotes-css-hint-details-view`;
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-css-hint-details-view', CSSHintDetailsView);

declare global {
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    interface HTMLElementTagNameMap {
      'citizennotes-css-hint-details-view': CSSHintDetailsView;
    }
}
