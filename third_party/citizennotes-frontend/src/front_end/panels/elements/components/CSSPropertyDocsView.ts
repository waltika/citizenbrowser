...
export class CSSPropertyDocsView extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-css-property-docs-view`;
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-css-property-docs-view', CSSPropertyDocsView);

declare global {
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  interface HTMLElementTagNameMap {
    'citizennotes-css-property-docs-view': CSSPropertyDocsView;
  }
}
