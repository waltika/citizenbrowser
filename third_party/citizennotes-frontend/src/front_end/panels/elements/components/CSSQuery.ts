...
export class CSSQuery extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-css-query`;
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-css-query', CSSQuery);

declare global {
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  interface HTMLElementTagNameMap {
    'citizennotes-css-query': CSSQuery;
  }
}
