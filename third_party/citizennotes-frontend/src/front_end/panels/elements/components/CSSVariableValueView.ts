...
export class CSSVariableParserError extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-css-variable-parser-error`;
...
export class CSSVariableValueView extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-css-variable-value-view`;
  readonly #shadow = this.attachShadow({mode: 'open'});
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-css-variable-value-view', CSSVariableValueView);
ComponentHelpers.CustomElements.defineComponent('citizennotes-css-variable-parser-error', CSSVariableParserError);

declare global {
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  interface HTMLElementTagNameMap {
    'citizennotes-css-variable-value-view': CSSVariableValueView;
    'citizennotes-css-variable-parser-error': CSSVariableParserError;
  }
}
