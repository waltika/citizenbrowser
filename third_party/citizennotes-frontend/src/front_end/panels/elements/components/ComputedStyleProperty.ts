...
export class ComputedStyleProperty extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-computed-style-property`;
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-computed-style-property', ComputedStyleProperty);

declare global {
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  interface HTMLElementTagNameMap {
    'citizennotes-computed-style-property': ComputedStyleProperty;
  }
}
