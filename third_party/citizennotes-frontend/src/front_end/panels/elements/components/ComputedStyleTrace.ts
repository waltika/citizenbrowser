...
export class ComputedStyleTrace extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-computed-style-trace`;
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-computed-style-trace', ComputedStyleTrace);

declare global {
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  interface HTMLElementTagNameMap {
    'citizennotes-computed-style-trace': ComputedStyleTrace;
  }
}
