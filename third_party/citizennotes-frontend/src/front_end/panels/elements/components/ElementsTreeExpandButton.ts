...
export class ElementsTreeExpandButton extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-elements-tree-expand-button`;
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-elements-tree-expand-button', ElementsTreeExpandButton);

declare global {
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  interface HTMLElementTagNameMap {
    'citizennotes-elements-tree-expand-button': ElementsTreeExpandButton;
  }
}
