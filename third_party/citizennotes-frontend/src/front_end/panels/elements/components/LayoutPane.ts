...
export class LayoutPane extends LegacyWrapper.LegacyWrapper.WrappableComponent {
  static readonly litTagName = LitHtml.literal`citizennotes-layout-pane`;
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-layout-pane', LayoutPane);

declare global {
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  interface HTMLElementTagNameMap {
    'citizennotes-layout-pane': LayoutPane;
  }
}
