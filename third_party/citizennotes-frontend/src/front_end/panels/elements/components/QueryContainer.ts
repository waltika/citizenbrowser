...
export class QueryContainer extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-query-container`;
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-query-container', QueryContainer);

declare global {
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  interface HTMLElementTagNameMap {
    'citizennotes-query-container': QueryContainer;
  }
}
