...
ComponentHelpers.CustomElements.defineComponent('citizennotes-flexbox-editor', FlexboxEditor);

declare global {
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  interface HTMLElementTagNameMap {
    'citizennotes-flexbox-editor': FlexboxEditor;
  }
}
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-grid-editor', GridEditor);

declare global {
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  interface HTMLElementTagNameMap {
    'citizennotes-grid-editor': GridEditor;
  }
}
