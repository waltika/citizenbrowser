...
const UIStrings = {
  ...
  /**
   * @description A menu command in the Device Mode Toolbar that closes CitizenNotes.
   */
  closeCitizennotes: 'Close CitizenNotes',
  /**
 ...
 * than in the CitizenNotes panel itself. Therefore, we need to fall back to using the
...
export class DeviceModeToolbar {
  ...
  private experimentalClicked(): void {
    Host.InspectorFrontendHost.InspectorFrontendHostInstance.openInNewTab(
        'chrome://flags/#enable-experimental-web-platform-features' as Platform.CitizenNotesPath.UrlString);
  }
