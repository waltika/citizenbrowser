...
const UIStrings = {
  ...
  /**
   * @description The text appearing before the list of sources that CitizenNotes
...
function buildRatingFormLink(
    ...
    relatedCode: string, networkData: string): Platform.CitizenNotesPath.UrlString {
  ...
  return `http://go/console-insights-experiment-rating?usp=pp_url&${
             Object.keys(params)
                 ...
                 .join('&')}` as Platform.CitizenNotesPath.UrlString;
}
...
export class ConsoleInsight extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-console-insight`;
  ...
  #onPopoverRequest(event: MouseEvent): UI.PopoverHelper.PopoverRequest|null {
    ...
    return {
      ...
      show: async(popover: UI.GlassPane.GlassPane): Promise<boolean> => {
        ...
        const list = document.createElement('citizennotes-console-insight-sources-list');
...
class ConsoleInsightSourcesList extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-console-insight-sources-list`;
  readonly #shadow = this.attachShadow({mode: 'open'});
  #sources: Source[] = [];
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-console-insight', ConsoleInsight);
ComponentHelpers.CustomElements.defineComponent('citizennotes-console-insight-sources-list', ConsoleInsightSourcesList);

declare global {
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  interface HTMLElementTagNameMap {
    'citizennotes-console-insight': ConsoleInsight;
    'citizennotes-console-insight-sources-list': ConsoleInsightSourcesList;
  }
}
