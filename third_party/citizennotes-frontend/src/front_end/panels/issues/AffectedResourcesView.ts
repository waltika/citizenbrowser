...
export abstract class AffectedResourcesView extends UI.TreeOutline.TreeElement {
  ...
  protected async createElementCell(
    ...
    const cellElement = document.createElement('td');
    cellElement.classList.add('affected-resource-element', 'citizennotes-link');
  ...
  protected appendSourceLocation(
    ...
    if (sourceLocation) {
      ...
      const sourceAnchor = linkifier.linkifyScriptLocation(
          target || null, sourceLocation.scriptId || null, sourceLocation.url as Platform.CitizenNotesPath.UrlString,
