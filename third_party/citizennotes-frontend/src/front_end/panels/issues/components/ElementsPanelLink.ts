...
export class ElementsPanelLink extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-elements-panel-link`;
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-elements-panel-link', ElementsPanelLink);

declare global {
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  interface HTMLElementTagNameMap {
    'citizennotes-elements-panel-link': ElementsPanelLink;
  }
}
