...
export class HideIssuesMenu extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-hide-issues-menu`;
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-hide-issues-menu', HideIssuesMenu);

declare global {
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  interface HTMLElementTagNameMap {
    'citizennotes-hide-issues-menu': HideIssuesMenu;
  }
}
