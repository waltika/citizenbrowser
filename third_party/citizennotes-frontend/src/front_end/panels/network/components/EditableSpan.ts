...
export class EditableSpan extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-editable-span`;
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-editable-span', EditableSpan);
