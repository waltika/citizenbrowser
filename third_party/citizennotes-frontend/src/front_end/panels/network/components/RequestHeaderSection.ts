...
export class RequestHeaderSection extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-request-header-section`;
      ...
      <div class="call-to-action">
        <div class="call-to-action-body">
          <div class="explanation" title=${cautionTitle}>
            ...
            ${cautionText} <x-link href="https://developer.chrome.com/docs/citizennotes/network/reference/#provisional-headers" class="link">${i18nString(UIStrings.learnMore)}</x-link>
          </div>
        </div>
      </div>
    `;
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-request-header-section', RequestHeaderSection);

declare global {
  interface HTMLElementTagNameMap {
    'citizennotes-request-header-section': RequestHeaderSection;
  }
}
