...
export class RequestHeadersView extends LegacyWrapper.LegacyWrapper.WrappableComponent {
  ...
  static readonly litTagName = LitHtml.literal`citizennotes-request-headers`;
  ...
  #renderHeaderOverridesLink(): LitHtml.LitTemplate {
    ...
    // clang-format off
    return html`
      <x-link href="https://goo.gle/citizennotes-override" class="link citizennotes-link">
      ...
      ></x-link>
      <x-link @click=${revealHeadersFile} class="link citizennotes-link" title=${UIStrings.revealHeaderOverrides}>
  ...
  #getHeaderOverridesFileUrl(): Platform.CitizenNotesPath.UrlString {
    if (!this.#request) {
    ...
    return fileUrl.substring(0, fileUrl.lastIndexOf('/')) + '/' +
        Persistence.NetworkPersistenceManager.HEADERS_FILENAME as Platform.CitizenNotesPath.UrlString;
  }
...
export class Category extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-request-headers-category`;
  readonly #shadow = this.attachShadow({mode: 'open'});
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-request-headers', RequestHeadersView);
ComponentHelpers.CustomElements.defineComponent('citizennotes-request-headers-category', Category);

declare global {
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  interface HTMLElementTagNameMap {
    'citizennotes-request-headers': RequestHeadersView;
    'citizennotes-request-headers-category': Category;
  }
}
