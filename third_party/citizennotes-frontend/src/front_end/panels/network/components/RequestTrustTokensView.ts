...
export class RequestTrustTokensView extends LegacyWrapper.LegacyWrapper.WrappableComponent {
  static readonly litTagName = LitHtml.literal`citizennotes-trust-token-report`;
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-trust-token-report', RequestTrustTokensView);

declare global {
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  interface HTMLElementTagNameMap {
    'citizennotes-trust-token-report': RequestTrustTokensView;
  }
}
