...
export class WebBundleInfoView extends LegacyWrapper.LegacyWrapper.WrappableComponent {
  static readonly litTagName = LitHtml.literal`citizennotes-web-bundle-info`;
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-web-bundle-info', WebBundleInfoView);

declare global {
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  interface HTMLElementTagNameMap {
    'citizennotes-web-bundle-info': WebBundleInfoView;
  }
}
