...
const UIStrings = {
  ...
  session: 'Session',
  /**
   *@description A placeholder for an input in Protocol Monitor. The input accepts commands that are sent to the backend on Enter. CDP stands for Chrome CitizenNotes Protocol.
   */
             ...
             row: Readonly<DataGrid.DataGridUtils.Row>): void => {
              ...
              menu.footerSection().appendItem(i18nString(UIStrings.documentation), () => {
                ...
                Host.InspectorFrontendHost.InspectorFrontendHostInstance.openInNewTab(
                    `https://chromecitizennotes.github.io/citizennotes-protocol/tot/${domain}#${type}-${method}` as
