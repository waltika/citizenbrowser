...
const UIStrings = {
   ...
   * viewing and inspecting 'protocol' messages which are sent/received by CitizenNotes. 'protocol' here
   * could be left untranslated as this refers to the Chrome CitizenNotes Protocol (CDP) which is a
   * specific API name.
   */
