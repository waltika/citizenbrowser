...
declare global {
  interface HTMLElementTagNameMap {
    'citizennotes-create-recording-view': CreateRecordingView;
  }
...
export class CreateRecordingView extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-create-recording-view`;
      ...
      LitHtml.html`
        <div class="wrapper">
          ...
          <label class="row-label" for="selector-attribute">
            ...
            <x-link class="link" href="https://g.co/citizennotes/recorder#selector">
...
ComponentHelpers.CustomElements.defineComponent(
    'citizennotes-create-recording-view',
    CreateRecordingView,
);
