...
declare global {
  interface HTMLElementTagNameMap {
    'citizennotes-recorder-extension-view': ExtensionView;
  }
...
export class ExtensionView extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-recorder-extension-view`;
...
ComponentHelpers.CustomElements.defineComponent(
    'citizennotes-recorder-extension-view',
    ExtensionView,
);
