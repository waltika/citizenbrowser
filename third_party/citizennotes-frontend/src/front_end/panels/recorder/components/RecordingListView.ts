...
declare global {
  interface HTMLElementTagNameMap {
    'citizennotes-recording-list-view': RecordingListView;
  }
...
export class RecordingListView extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-recording-list-view`;
...
ComponentHelpers.CustomElements.defineComponent(
    'citizennotes-recording-list-view',
    RecordingListView,
);
