...
const UIStrings = {
   ...
   */
  quickStart: 'Quick start: learn the new Recorder panel in CitizenNotes',
};
...
export const FEEDBACK_URL = 'https://goo.gle/recorder-feedback' as Platform.CitizenNotesPath.UrlString;
const DOC_URL = 'https://developer.chrome.com/docs/citizennotes/recorder' as Platform.CitizenNotesPath.UrlString;

declare global {
  interface HTMLElementTagNameMap {
    'citizennotes-start-view': StartView;
  }
}
...
export class StartView extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-start-view`;
