...
declare global {
  interface HTMLElementTagNameMap {
    'citizennotes-recorder-step-editor': StepEditor;
    'citizennotes-recorder-selector-picker-button': RecorderSelectorPickerButton;
  }
}
 ...
 */
@customElement('citizennotes-recorder-selector-picker-button')
class RecorderSelectorPickerButton extends LitElement {
  ...
  protected override render(): LitHtml.TemplateResult|undefined {
    ...
    return html`<citizennotes-button
 ...
 */
@customElement('citizennotes-recorder-step-editor')
export class StepEditor extends LitElement {
  ...
  #handleKeyDownEvent = (event: Event): void => {
    ...
    if (event.target instanceof SuggestionInput.SuggestionInput.SuggestionInput && event.key === 'Enter') {
      event.preventDefault();
      event.stopPropagation();
      const elements = this.renderRoot.querySelectorAll('citizennotes-suggestion-input');
  ...
  #handleAddRowClickEvent = async(event: MouseEvent): Promise<void> => {
    ...
    this.#ensureFocus(`[data-attribute=${attribute}].attribute citizennotes-suggestion-input`);
  };
            ...
            <div class="padded row">
              ...
              ${this.#renderInlineButton({
                ...
                onClick: this.#handleAddOrRemoveClick(
                  ...
                  `citizennotes-suggestion-input[data-path="frame.${index + 1}"]`,
              ...
              ${this.#renderInlineButton({
                ...
                onClick: this.#handleAddOrRemoveClick(
                  ...
                  `citizennotes-suggestion-input[data-path="frame.${Math.min(
                    index,
                    frames.length - 2,
                  )}"]`,
                  Host.UserMetrics.RecordingEdited.OtherEditing,
  ...
  #renderSelectorsRow(): LitHtml.TemplateResult|undefined {
    ...
    return html`<div class="attribute" data-attribute="selectors">
      <div class="row">
        ...
        <citizennotes-recorder-selector-picker-button
        ...
        return html`<div class="padded row" data-selector-path=${index}>
            ...
            ${this.#renderInlineButton({
              ...
              onClick: this.#handleAddOrRemoveClick(
                ...
                `citizennotes-suggestion-input[data-path="selectors.${index + 1}.0"]`,
            ...
            ${this.#renderInlineButton({
              ...
              onClick: this.#handleAddOrRemoveClick(
                ...
                `citizennotes-suggestion-input[data-path="selectors.${Math.min(
                  index,
                  selectors.length - 2,
                )}.0"]`,
            ...
            >
              ...
              ${this.#renderInlineButton({
                ...
                onClick: this.#handleAddOrRemoveClick(
                  ...
                  `citizennotes-suggestion-input[data-path="selectors.${index}.${
                    partIndex + 1
                  }"]`,
              ...
              ${this.#renderInlineButton({
                ...
                onClick: this.#handleAddOrRemoveClick(
                  ...
                  `citizennotes-suggestion-input[data-path="selectors.${index}.${Math.min(
                    partIndex,
                    parts.length - 2,
                  )}"]`,
        ...
        return html`<div class="padded row">
          ...
          ${this.#renderInlineButton({
            ...
            onClick: this.#handleAddOrRemoveClick(
              ...
              `citizennotes-suggestion-input[data-path="attributes.${
                index + 1
              }.name"]`,
              Host.UserMetrics.RecordingEdited.OtherEditing,
            ),
          ...
          ${this.#renderInlineButton({
            ...
            onClick: this.#handleAddOrRemoveClick(
              ...
              `citizennotes-suggestion-input[data-path="attributes.${Math.min(
                index,
                attributes.length - 2,
              )}.value"]`,
              Host.UserMetrics.RecordingEdited.OtherEditing,
