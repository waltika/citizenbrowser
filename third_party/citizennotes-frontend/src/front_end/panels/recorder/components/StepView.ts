...
declare global {
  interface HTMLElementTagNameMap {
    'citizennotes-step-view': StepView;
  }
}
...
export class StepView extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-step-view`;
    ...
    LitHtml.render(
      ...
      <${TimelineSection.litTagName} .data=${
        ...
        <div class="details">
          ${
            this.#step &&
            LitHtml.html`<citizennotes-recorder-step-editor
            class=${this.#isSelected ? 'is-selected' : ''}
            .step=${this.#step}
            .disabled=${this.#isPlaying}
            @stepedited=${this.#stepEdited}>
          </citizennotes-recorder-step-editor>`
          }
          ${
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-step-view', StepView);
