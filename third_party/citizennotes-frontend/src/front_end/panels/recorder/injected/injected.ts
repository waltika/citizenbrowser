...
declare global {
  interface Window {
    ...
    CitizenNotesRecorder: CitizenNotesRecorder;
  }
}

class CitizenNotesRecorder {
...
if (!window.CitizenNotesRecorder) {
  window.CitizenNotesRecorder = new CitizenNotesRecorder();
}
