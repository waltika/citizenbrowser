...
const UIStrings = {
   ...
   */
  FullListOfCitizennotesKeyboard: 'Full list of CitizenNotes keyboard shortcuts and gestures',
  /**
...
export class KeybindsSettingsTab extends UI.Widget.VBox implements UI.ListControl.ListDelegate<KeybindsItem> {
  ...
  constructor() {
    ...
    const docsLink = UI.XLink.XLink.create(
        'https://developer.chrome.com/docs/citizennotes/shortcuts/', i18nString(UIStrings.FullListOfCitizennotesKeyboard));
...
export class ShortcutListItem {
  ...
  private setupEditor(): void {
    this.addShortcutLinkContainer = this.element.createChild('div', 'keybinds-shortcut citizennotes-link');
    const addShortcutLink = this.addShortcutLinkContainer.createChild('span', 'citizennotes-link') as HTMLDivElement;
