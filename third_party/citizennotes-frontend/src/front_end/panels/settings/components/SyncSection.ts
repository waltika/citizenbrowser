...
const UIStrings = {
   ...
   * chrome settings. The link is shown in the CitizenNotes Settings UI.
   */
  settings: 'Go to Settings',
  /**
   * @description Label for the account email address. Shown in the CitizenNotes Settings UI in
...
export class SyncSection extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-sync-section`;
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-sync-section', SyncSection);

declare global {
  interface HTMLElementTagNameMap {
    'citizennotes-sync-section': SyncSection;
  }
}
