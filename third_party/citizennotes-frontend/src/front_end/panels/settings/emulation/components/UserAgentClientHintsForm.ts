...
const UIStrings = {
  ...
  /**
   * @description Label for button to submit client hints form in CitizenNotes.
   */
  update: 'Update',
  /**
...
export class UserAgentClientHintsForm extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-user-agent-client-hints-form`;
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-user-agent-client-hints-form', UserAgentClientHintsForm);

declare global {
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  interface HTMLElementTagNameMap {
    'citizennotes-user-agent-client-hints-form': UserAgentClientHintsForm;
  }
}
