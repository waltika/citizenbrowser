...
const UIStrings = {
   ...
   *See: https://developer.chrome.com/blog/new-in-citizennotes-73/#logpoints
   */
...
export class BreakpointEditDialog extends UI.Widget.Widget {
  ...
  constructor(
    ...
    const link = UI.Fragment.html`<x-link class="link citizennotes-link" tabindex="0" href='https://goo.gle/citizennotes-loc'>${
