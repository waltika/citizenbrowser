...
export class CoveragePlugin extends Plugin {
  ...
  private updateStats(): void {
    if (this.coverage) {
      ...
      const formatter = new Intl.NumberFormat(i18n.CitizenNotesLocale.CitizenNotesLocale.instance().locale, {
        style: 'percent',
...
function coverageGutter(url: Platform.CitizenNotesPath.UrlString): CodeMirror.Extension {
