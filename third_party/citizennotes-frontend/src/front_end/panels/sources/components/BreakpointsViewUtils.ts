...
function populateDifferentiatingPathMap(
    urls: Platform.CitizenNotesPath.UrlString[], urlToDifferentiator: Map<Platform.CitizenNotesPath.UrlString, string>): void {
...
export function getDifferentiatingPathMap(titleInfos: TitleInfo[]): Map<Platform.CitizenNotesPath.UrlString, string> {
  const nameToUrl = new Map<string, Platform.CitizenNotesPath.UrlString[]>();
  const urlToDifferentiatingPath = new Map<Platform.CitizenNotesPath.UrlString, Platform.CitizenNotesPath.UrlString>();
