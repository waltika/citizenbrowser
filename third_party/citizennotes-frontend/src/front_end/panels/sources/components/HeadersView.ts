...
export class HeadersViewComponent extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-sources-headers-view`;
  ...
  #render(): void {
    ...
    LitHtml.render(LitHtml.html`
      ...
      <div class="learn-more-row">
        <x-link href="https://goo.gle/citizennotes-override" class="link">${i18nString(UIStrings.learnMore)}</x-link>
      </div>
    `, this.#shadow, {host: this});
    // clang-format on
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-sources-headers-view', HeadersViewComponent);

declare global {
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  interface HTMLElementTagNameMap {
    'citizennotes-sources-headers-view': HeadersViewComponent;
  }
}
