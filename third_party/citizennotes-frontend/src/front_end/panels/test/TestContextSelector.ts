...
import testContextSelectorStyles from './testContextSelector.css.js';

const UIStrings = {
  /**
   *@description Title of toolbar item in test context selector of the test panel
   */
  javascriptContextNotSelected: 'JavaScript context: Not selected',
  /**
   *@description Text in Test Context Selector of the Test panel
   */
  extension: 'Extension',
  /**
   *@description Text in Test Context Selector of the Test panel
...
const str_ = i18n.i18n.registerUIStrings('panels/test/TestContextSelector.ts', UIStrings);
const i18nString = i18n.i18n.getLocalizedString.bind(undefined, str_);
export class TestContextSelector implements SDK.TargetManager.SDKModelObserver<SDK.RuntimeModel.RuntimeModel>,
  ...
  createElementForItem(item: SDK.RuntimeModel.ExecutionContext): Element {
    ...
    const shadowRoot = UI.Utils.createShadowRootWithCoreStyles(
        element, {cssFile: [testContextSelectorStyles], delegatesFocus: undefined});
