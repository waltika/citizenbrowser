...
export class BreadcrumbsUI extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-breadcrumbs-ui`;
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-breadcrumbs-ui', BreadcrumbsUI);

declare global {
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  interface HTMLElementTagNameMap {
    'citizennotes-breadcrumbs-ui': BreadcrumbsUI;
  }
}
