...
export class InteractionBreakdown extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-interaction-breakdown`;
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-interaction-breakdown', InteractionBreakdown);

declare global {
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  interface HTMLElementTagNameMap {
    'citizennotes-interaction-breakdown': InteractionBreakdown;
  }
}
