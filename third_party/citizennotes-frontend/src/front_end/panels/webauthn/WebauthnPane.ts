...
export class WebauthnPaneImpl extends UI.Widget.VBox implements
  ...
  #handleSaveNameButton(
      ...
      saveName: UI.Toolbar.ToolbarItem, activeLabel: UI.UIUtils.CitizenNotesRadioButton): void {
  ...
  #updateActiveLabelTitle(activeLabel: UI.UIUtils.CitizenNotesRadioButton, authenticatorName: string): void {
