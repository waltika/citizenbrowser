...
export class PerformanceTracing implements TraceEngine.TracingManager.TracingManagerClient {
  ...
  async start(): Promise<void> {
    ...
    // https://source.chromium.org/chromium/chromium/src/+/main:third_party/citizennotes-frontend/src/front_end/panels/timeline/TimelineController.ts
    ...
    const categories = [
      ...
      'disabled-by-default-citizennotes.timeline',
      'disabled-by-default-citizennotes.timeline.invalidationTracking',
      'disabled-by-default-citizennotes.timeline.frame',
      'disabled-by-default-citizennotes.timeline.stack',
