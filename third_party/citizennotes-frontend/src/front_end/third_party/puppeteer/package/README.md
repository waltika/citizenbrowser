...
> [CitizenNotes Protocol](https://chromecitizennotes.github.io/citizennotes-protocol/).
> Puppeteer runs in
...
- Create an automated testing environment using the latest JavaScript and
  browser features.
- Capture a
  [timeline trace](https://developers.google.com/web/tools/chrome-citizennotes/evaluate-performance/reference)
...
`puppeteer-core` is a _library_ to help drive anything that supports CitizenNotes
