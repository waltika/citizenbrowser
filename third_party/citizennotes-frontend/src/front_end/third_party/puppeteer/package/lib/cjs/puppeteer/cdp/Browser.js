...
class CdpBrowser extends Browser_js_1.Browser {
    ...
    #createTarget = (targetInfo, session) => {
        ...
        if (targetInfo.url?.startsWith('citizennotes://')) {
            return new Target_js_1.CitizenNotesTarget(targetInfo, session, context, this.#targetManager, createSession, this.#ignoreHTTPSErrors, this.#defaultViewport ?? null);
        }
