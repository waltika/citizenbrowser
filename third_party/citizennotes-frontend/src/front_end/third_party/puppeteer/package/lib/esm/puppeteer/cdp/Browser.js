...
import { CitizenNotesTarget, InitializationStatus, OtherTarget, PageTarget, WorkerTarget, } from './Target.js';
/**
 * @internal
 */
export class CdpBrowser extends BrowserBase {
    ...
    #createTarget = (targetInfo, session) => {
        ...
        if (targetInfo.url?.startsWith('citizennotes://')) {
            return new CitizenNotesTarget(targetInfo, session, context, this.#targetManager, createSession, this.#ignoreHTTPSErrors, this.#defaultViewport ?? null);
        }
