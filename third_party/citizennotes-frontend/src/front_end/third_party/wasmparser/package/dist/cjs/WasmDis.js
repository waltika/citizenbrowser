...
exports.CitizenNotesNameGenerator = exports.CitizenNotesNameResolver = exports.NameSectionReader = exports.WasmDisassembler = exports.LabelMode = exports.NumericNameResolver = exports.DefaultNameResolver = void 0;
...
var CitizenNotesExportMetadata = /** @class */ (function () {
    function CitizenNotesExportMetadata(functionExportNames, globalExportNames, memoryExportNames, tableExportNames, eventExportNames) {
    ...
    CitizenNotesExportMetadata.prototype.getFunctionExportNames = function (index) {
        var _a;
        return (_a = this._functionExportNames[index]) !== null && _a !== void 0 ? _a : EMPTY_STRING_ARRAY;
    };
    CitizenNotesExportMetadata.prototype.getGlobalExportNames = function (index) {
        var _a;
        return (_a = this._globalExportNames[index]) !== null && _a !== void 0 ? _a : EMPTY_STRING_ARRAY;
    };
    CitizenNotesExportMetadata.prototype.getMemoryExportNames = function (index) {
        var _a;
        return (_a = this._memoryExportNames[index]) !== null && _a !== void 0 ? _a : EMPTY_STRING_ARRAY;
    };
    CitizenNotesExportMetadata.prototype.getTableExportNames = function (index) {
        var _a;
        return (_a = this._tableExportNames[index]) !== null && _a !== void 0 ? _a : EMPTY_STRING_ARRAY;
    };
    CitizenNotesExportMetadata.prototype.getEventExportNames = function (index) {
        var _a;
        return (_a = this._eventExportNames[index]) !== null && _a !== void 0 ? _a : EMPTY_STRING_ARRAY;
    };
    return CitizenNotesExportMetadata;
}());
...
var CitizenNotesNameResolver = /** @class */ (function (_super) {
    __extends(CitizenNotesNameResolver, _super);
    function CitizenNotesNameResolver(functionNames, localNames, eventNames, typeNames, tableNames, memoryNames, globalNames, fieldNames) {
        return _super.call(this, functionNames, localNames, eventNames, typeNames, tableNames, memoryNames, globalNames, fieldNames) || this;
    }
    CitizenNotesNameResolver.prototype.getFunctionName = function (index, isImport, isRef) {
        var name = this._functionNames[index];
        if (!name)
            return isImport ? "$import" + index : "$func" + index;
        return isRef ? "$" + name : "$" + name + " (;" + index + ";)";
    };
    return CitizenNotesNameResolver;
}(NameSectionNameResolver));
exports.CitizenNotesNameResolver = CitizenNotesNameResolver;
var CitizenNotesNameGenerator = /** @class */ (function () {
    function CitizenNotesNameGenerator() {
        this._done = false;
        this._functionImportsCount = 0;
    ...
    CitizenNotesNameGenerator.prototype._addExportName = function (exportNames, index, name) {
    ...
    CitizenNotesNameGenerator.prototype._setName = function (names, index, name, isNameSectionName) {
        if (!name)
            return;
    ...
    CitizenNotesNameGenerator.prototype.read = function (reader) {
        var _this = this;
        if (this._done)
            throw new Error("Invalid state: disassembly process was already finished.");
        while (true) {
    ...
    CitizenNotesNameGenerator.prototype.getExportMetadata = function () {
        return new CitizenNotesExportMetadata(this._functionExportNames, this._globalExportNames, this._memoryExportNames, this._tableExportNames, this._eventExportNames);
    };
    CitizenNotesNameGenerator.prototype.getNameResolver = function () {
        return new CitizenNotesNameResolver(this._functionNames, this._functionLocalNames, this._eventNames, this._typeNames, this._tableNames, this._memoryNames, this._globalNames, this._fieldNames);
    };
    return CitizenNotesNameGenerator;
}());
exports.CitizenNotesNameGenerator = CitizenNotesNameGenerator;
