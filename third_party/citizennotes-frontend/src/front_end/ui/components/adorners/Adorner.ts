...
export class Adorner extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-adorner`;
  name = '';
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-adorner', Adorner);

declare global {
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  interface HTMLElementTagNameMap {
    'citizennotes-adorner': Adorner;
  }
}
