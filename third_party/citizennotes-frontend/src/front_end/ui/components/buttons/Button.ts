...
export class Button extends HTMLElement {
  ...
  static readonly litTagName = LitHtml.literal`citizennotes-button`;
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-button', Button);
