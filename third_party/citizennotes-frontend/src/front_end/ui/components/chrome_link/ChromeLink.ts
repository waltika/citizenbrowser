...
declare global {
  interface HTMLElementTagNameMap {
    'citizennotes-chrome-link': ChromeLink;
  }
}
...
export class ChromeLink extends HTMLElement {
  ...
  set href(href: Platform.CitizenNotesPath.UrlString) {
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-chrome-link', ChromeLink);
