...
export class DataGrid extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-data-grid`;
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-data-grid', DataGrid);

declare global {
  interface HTMLElementTagNameMap {
    'citizennotes-data-grid': DataGrid;
  }
}
