...
export class DataGridController extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-data-grid-controller`;
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-data-grid-controller', DataGridController);

declare global {
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  interface HTMLElementTagNameMap {
    'citizennotes-data-grid-controller': DataGridController;
  }
}
