...
declare global {
  ...
  interface HTMLElementTagNameMap {
    'citizennotes-icon-dialog': IconDialog;
  }
}
...
export class IconDialog extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-icon-dialog`;
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-icon-dialog', IconDialog);
