...
declare global {
  ...
  interface HTMLElementTagNameMap {
    'citizennotes-shortcut-dialog': ShortcutDialog;
  }
}
...
export class ShortcutDialog extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-shortcut-dialog`;
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-shortcut-dialog', ShortcutDialog);
