...
declare global {
  interface HTMLElementTagNameMap {
    'citizennotes-diff-view': DiffView;
  }
}
...
export class DiffView extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-diff-view`;
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-diff-view', DiffView);
