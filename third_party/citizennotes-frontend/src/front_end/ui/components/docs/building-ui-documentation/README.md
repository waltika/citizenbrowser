# Building UI elements in CitizenNotes

This is the documentation containing all the information you need to be able to build UI in CitizenNotes and get familiar with our front-end stack.
