...
export class ExpandableList extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-expandable-list`;
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-expandable-list', ExpandableList);

declare global {
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  interface HTMLElementTagNameMap {
    'citizennotes-expandable-list': ExpandableList;
  }
}
