...
export class Icon extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-icon`;
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-icon', Icon);

declare global {
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  interface HTMLElementTagNameMap {
    'citizennotes-icon': Icon;
  }
}
