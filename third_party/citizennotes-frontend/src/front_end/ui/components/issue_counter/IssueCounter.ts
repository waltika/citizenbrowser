...
export class IssueCounter extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-issue-counter`;
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-issue-counter', IssueCounter);

declare global {
  interface HTMLElementTagNameMap {
    'citizennotes-issue-counter': IssueCounter;
  }
}
