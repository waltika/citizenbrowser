...
export class IssueLinkIcon extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-issue-link-icon`;
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-issue-link-icon', IssueLinkIcon);

declare global {
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  interface HTMLElementTagNameMap {
    'citizennotes-issue-link-icon': IssueLinkIcon;
  }
}
