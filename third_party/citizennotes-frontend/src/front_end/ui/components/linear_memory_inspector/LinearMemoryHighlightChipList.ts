...
export class LinearMemoryHighlightChipList extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-linear-memory-highlight-chip-list`;
...
ComponentHelpers.CustomElements.defineComponent(
    'citizennotes-linear-memory-highlight-chip-list', LinearMemoryHighlightChipList);
