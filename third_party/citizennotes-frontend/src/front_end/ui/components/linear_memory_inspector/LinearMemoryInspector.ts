...
export class LinearMemoryInspector extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-linear-memory-inspector-inspector`;
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-linear-memory-inspector-inspector', LinearMemoryInspector);

declare global {
  interface HTMLElementTagNameMap {
    'citizennotes-linear-memory-inspector-inspector': LinearMemoryInspector;
  }
