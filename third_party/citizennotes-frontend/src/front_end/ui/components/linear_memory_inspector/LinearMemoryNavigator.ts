...
export class LinearMemoryNavigator extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-linear-memory-inspector-navigator`;
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-linear-memory-inspector-navigator', LinearMemoryNavigator);

declare global {
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  interface HTMLElementTagNameMap {
    'citizennotes-linear-memory-inspector-navigator': LinearMemoryNavigator;
  }
}
