...
export class LinearMemoryValueInterpreter extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-linear-memory-inspector-interpreter`;
...
ComponentHelpers.CustomElements.defineComponent(
    'citizennotes-linear-memory-inspector-interpreter', LinearMemoryValueInterpreter);
