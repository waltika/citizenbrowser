...
export class LinearMemoryViewer extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-linear-memory-inspector-viewer`;
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-linear-memory-inspector-viewer', LinearMemoryViewer);

declare global {
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
interface HTMLElementTagNameMap {
    'citizennotes-linear-memory-inspector-viewer': LinearMemoryViewer;
  }
}
