...
export class ValueInterpreterDisplay extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-linear-memory-inspector-interpreter-display`;
...
ComponentHelpers.CustomElements.defineComponent(
    'citizennotes-linear-memory-inspector-interpreter-display', ValueInterpreterDisplay);
