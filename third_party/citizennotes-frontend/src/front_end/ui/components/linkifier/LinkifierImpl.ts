...
export class Linkifier extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-linkifier`;
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-linkifier', Linkifier);

declare global {
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  interface HTMLElementTagNameMap {
    'citizennotes-linkifier': Linkifier;
  }
}
