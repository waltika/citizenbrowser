...
export class CodeBlock extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-code-block`;
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-code-block', CodeBlock);

declare global {
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  interface HTMLElementTagNameMap {
    'citizennotes-code-block': CodeBlock;
  }
}
