...
export class MarkdownImage extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-markdown-image`;
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-markdown-image', MarkdownImage);

declare global {
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  interface HTMLElementTagNameMap {
    'citizennotes-markdown-image': MarkdownImage;
  }
}
