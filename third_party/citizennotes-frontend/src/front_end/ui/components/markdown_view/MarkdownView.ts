...
export class MarkdownView extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-markdown-view`;
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-markdown-view', MarkdownView);

declare global {
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  interface HTMLElementTagNameMap {
    'citizennotes-markdown-view': MarkdownView;
  }
}
