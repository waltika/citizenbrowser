...
export class Menu extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-menu`;
...
export class MenuItem extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-menu-item`;
  readonly #shadow = this.attachShadow({mode: 'open'});
  readonly #renderBound = this.#render.bind(this);
  connectedCallback(): void {
...
export class MenuGroup extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-menu-group`;
  readonly #shadow = this.attachShadow({mode: 'open'});
  readonly #renderBound = this.#render.bind(this);
  connectedCallback(): void {
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-menu', Menu);
ComponentHelpers.CustomElements.defineComponent('citizennotes-menu-item', MenuItem);
ComponentHelpers.CustomElements.defineComponent('citizennotes-menu-group', MenuGroup);

declare global {
  interface HTMLElementTagNameMap {
    'citizennotes-menu': Menu;
    'citizennotes-menu-item': MenuItem;
    'citizennotes-menu-group': MenuGroup;
  }
