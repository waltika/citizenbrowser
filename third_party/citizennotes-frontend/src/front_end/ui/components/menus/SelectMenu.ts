...
export class SelectMenu extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-select-menu`;
  ...
  #getButton(): SelectMenuButton {
    if (!this.#button) {
      this.#button = this.#shadow.querySelector('citizennotes-select-menu-button');
      if (!this.#button) {
...
export class SelectMenuButton extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-select-menu-button`;
  readonly #shadow = this.attachShadow({mode: 'open'});
  readonly #renderBound = this.#render.bind(this);
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-select-menu', SelectMenu);
ComponentHelpers.CustomElements.defineComponent('citizennotes-select-menu-button', SelectMenuButton);

declare global {
  interface HTMLElementTagNameMap {
    'citizennotes-select-menu': SelectMenu;
    'citizennotes-select-menu-button': SelectMenuButton;
  }
