...
export class NodeText extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-node-text`;
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-node-text', NodeText);

declare global {
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  interface HTMLElementTagNameMap {
    'citizennotes-node-text': NodeText;
  }
}
