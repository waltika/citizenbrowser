...
export interface PanelFeedbackData {
  ...
  quickStartUrl: Platform.CitizenNotesPath.UrlString;
  quickStartLinkText: string;
}
export class PanelFeedback extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-panel-feedback`;
  readonly #shadow = this.attachShadow({mode: 'open'});
  readonly #boundRender = this.#render.bind(this);

  #props: PanelFeedbackData = {
    feedbackUrl: Platform.CitizenNotesPath.EmptyUrlString,
    quickStartUrl: Platform.CitizenNotesPath.EmptyUrlString,
    quickStartLinkText: '',
  };
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-panel-feedback', PanelFeedback);

declare global {
  interface HTMLElementTagNameMap {
    'citizennotes-panel-feedback': PanelFeedback;
  }
}
