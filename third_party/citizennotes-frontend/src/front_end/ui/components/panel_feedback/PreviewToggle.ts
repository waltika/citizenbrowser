...
export class PreviewToggle extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-preview-toggle`;
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-preview-toggle', PreviewToggle);

declare global {
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  interface HTMLElementTagNameMap {
    'citizennotes-preview-toggle': PreviewToggle;
  }
}
