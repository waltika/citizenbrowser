...
export class PanelIntroductionSteps extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-panel-introduction-steps`;
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-panel-introduction-steps', PanelIntroductionSteps);

declare global {
  interface HTMLElementTagNameMap {
    'citizennotes-panel-introduction-steps': PanelIntroductionSteps;
  }
}
