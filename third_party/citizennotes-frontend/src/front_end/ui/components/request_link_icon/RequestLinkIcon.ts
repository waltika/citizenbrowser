...
export const extractShortPath = (path: Platform.CitizenNotesPath.UrlString): string => {
...
export class RequestLinkIcon extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-request-link-icon`;
  ...
  #getUrlForDisplaying(): Platform.CitizenNotesPath.UrlString|undefined {
    if (!this.#request) {
      return this.#affectedRequest?.url as Platform.CitizenNotesPath.UrlString;
    }
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-request-link-icon', RequestLinkIcon);

declare global {
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  interface HTMLElementTagNameMap {
    'citizennotes-request-link-icon': RequestLinkIcon;
  }
}
