...
export class SettingDeprecationWarning extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-setting-deprecation-warning`;
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-setting-deprecation-warning', SettingDeprecationWarning);

declare global {
  interface HTMLElementTagNameMap {
    'citizennotes-setting-deprecation-warning': SettingDeprecationWarning;
  }
}
