...
export class SrgbOverlay extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-spectrum-srgb-overlay`;
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-spectrum-srgb-overlay', SrgbOverlay);

declare global {
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  interface HTMLElementTagNameMap {
    'citizennotes-spectrum-srgb-overlay': SrgbOverlay;
  }
}
