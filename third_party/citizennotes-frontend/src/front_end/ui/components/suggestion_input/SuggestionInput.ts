...
declare global {
  interface HTMLElementTagNameMap {
    'citizennotes-suggestion-input': SuggestionInput;
    'citizennotes-editable-content': EditableContent;
    'citizennotes-suggestion-box': SuggestionBox;
  }
}
...
@customElement('citizennotes-editable-content')
 ...
 */
@customElement('citizennotes-suggestion-box')
...
@customElement('citizennotes-suggestion-input')
export class SuggestionInput extends LitElement {
  ...
  /**
   * State passed to citizennotes-suggestion-box.
   */
  @property(jsonPropertyOptions) declare options: Readonly<string[]>;
  ...
  /**
   * State passed to citizennotes-editable-content.
   */
  ...
  get #editableContent(): EditableContent {
    ...
    const node = this.renderRoot.querySelector('citizennotes-editable-content');
    if (!node) {
  ...
  protected override render(): LitHtml.TemplateResult {
    // clang-format off
    return html`<citizennotes-editable-content
