...
export class SurveyLink extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-survey-link`;
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-survey-link', SurveyLink);

declare global {
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  interface HTMLElementTagNameMap {
    'citizennotes-survey-link': SurveyLink;
  }
}
