...
export class TextPrompt extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-text-prompt`;
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-text-prompt', TextPrompt);

declare global {
  interface HTMLElementTagNameMap {
    'citizennotes-text-prompt': TextPrompt;
  }
