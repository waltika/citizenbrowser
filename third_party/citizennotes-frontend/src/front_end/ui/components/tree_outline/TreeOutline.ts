...
export class TreeOutline<TreeNodeDataType> extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-tree-outline`;
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-tree-outline', TreeOutline);

declare global {
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  interface HTMLElementTagNameMap {
    'citizennotes-tree-outline': TreeOutline<unknown>;
  }
}
