...
export class TwoStatesCounter extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-two-states-counter`;
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-two-states-counter', TwoStatesCounter);

declare global {
  interface HTMLElementTagNameMap {
    'citizennotes-two-states-counter': TwoStatesCounter;
  }
}
