...
export class CSSAngleEditor extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-css-angle-editor`;
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-css-angle-editor', CSSAngleEditor);

declare global {
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  interface HTMLElementTagNameMap {
    'citizennotes-css-angle-editor': CSSAngleEditor;
  }
}
