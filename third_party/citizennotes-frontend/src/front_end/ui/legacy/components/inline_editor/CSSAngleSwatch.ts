...
export class CSSAngleSwatch extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-css-angle-swatch`;
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-css-angle-swatch', CSSAngleSwatch);

declare global {
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  interface HTMLElementTagNameMap {
    'citizennotes-css-angle-swatch': CSSAngleSwatch;
  }
}
