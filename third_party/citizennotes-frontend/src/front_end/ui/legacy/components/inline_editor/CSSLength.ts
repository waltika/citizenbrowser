...
export class CSSLength extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-css-length`;
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-css-length', CSSLength);

declare global {
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  interface HTMLElementTagNameMap {
    'citizennotes-css-length': CSSLength;
  }
}
