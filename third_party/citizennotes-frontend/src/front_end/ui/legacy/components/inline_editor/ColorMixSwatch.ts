...
export class ColorMixSwatch extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-color-mix-swatch`;
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-color-mix-swatch', ColorMixSwatch);

declare global {
  interface HTMLElementTagNameMap {
    'citizennotes-color-mix-swatch': ColorMixSwatch;
  }
}
