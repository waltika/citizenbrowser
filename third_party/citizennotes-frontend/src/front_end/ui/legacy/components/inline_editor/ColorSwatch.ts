...
export class ColorSwatch extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-color-swatch`;
  ...
  static isColorSwatch(element: Element): element is ColorSwatch {
    return element.localName === 'citizennotes-color-swatch';
  }
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-color-swatch', ColorSwatch);

declare global {
  interface HTMLElementTagNameMap {
    'citizennotes-color-swatch': ColorSwatch;
  }
