...
class BaseLinkSwatch extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-base-link-swatch`;
...
export class CSSVarSwatch extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-css-var-swatch`;
  protected readonly shadow = this.attachShadow({mode: 'open'});
...
export class LinkSwatch extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-link-swatch`;
  protected readonly shadow = this.attachShadow({mode: 'open'});
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-base-link-swatch', BaseLinkSwatch);
ComponentHelpers.CustomElements.defineComponent('citizennotes-link-swatch', LinkSwatch);
ComponentHelpers.CustomElements.defineComponent('citizennotes-css-var-swatch', CSSVarSwatch);

declare global {
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  interface HTMLElementTagNameMap {
    'citizennotes-base-link-swatch': BaseLinkSwatch;
    'citizennotes-link-swatch': LinkSwatch;
    'citizennotes-css-var-swatch': CSSVarSwatch;
  }
}
