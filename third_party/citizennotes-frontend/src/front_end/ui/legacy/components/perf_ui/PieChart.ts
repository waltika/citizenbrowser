...
export class PieChart extends HTMLElement {
  static readonly litTagName = LitHtml.literal`citizennotes-perf-piechart`;
...
ComponentHelpers.CustomElements.defineComponent('citizennotes-perf-piechart', PieChart);

declare global {
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  interface HTMLElementTagNameMap {
    'citizennotes-perf-piechart': PieChart;
  }
}
