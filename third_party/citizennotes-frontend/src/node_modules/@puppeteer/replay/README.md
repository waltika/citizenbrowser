...
> Puppeteer Replay is a library that provides an API to replay and stringify recordings created using [Chrome CitizenNotes Recorder](https://developer.chrome.com/docs/citizennotes/recorder/)
...
- [Replay with Sauce Labs](https://saucelabs.com/blog/how-to-create-test-scripts-using-chrome-citizennotes). You can replay the JSON files on [Sauce Labs](https://saucelabs.com/) using [saucectl](https://github.com/saucelabs/saucectl-replay-example).
...
You can create a Chrome extension for [Recorder](https://goo.gle/citizennotes-recorder). Refer to the [Chrome Extensions documentation](https://developer.chrome.com/docs/extensions/mv3/citizennotes/) for more details on how to extend CitizenNotes.
...
This repository contains an [example extension](https://github.com/puppeteer/replay/tree/main/examples/chrome-extension). Once installed, the Recorder will have a new export option **Export as a Custom JSON script** in the [export dropdown](https://developer.chrome.com/docs/citizennotes/recorder/#export-flows).

To load the example into Chrome CitizenNotes. Follow these steps:
...
3. [Open a recording](https://developer.chrome.com/docs/citizennotes/recorder/#record) in the Recorder.
4. Click on [export](https://developer.chrome.com/docs/citizennotes/recorder/#export-flows). Now you can see a new **Export as a Custom JSON script** option in the export menu.
