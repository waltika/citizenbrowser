...
export declare class NetworkRequest {
    ...
    /** @see https://chromecitizennotes.github.io/citizennotes-protocol/tot/Fetch/#method-failRequest */
    failRequest(networkId: Network.Request, errorReason: Protocol.Network.ErrorReason): Promise<void>;
    /** @see https://chromecitizennotes.github.io/citizennotes-protocol/tot/Fetch/#method-continueRequest */
