...
#
# Contributing to Chrome CitizenNotes Protocol: https://goo.gle/citizennotes-contribution-guide-cdp
...
experimental domain Accessibility
  ...
  type AXRelatedNode extends object
    properties
      # The BackendNodeId of the related CnDOM node.
      CnDOM.BackendNodeId backendDOMNodeId
  ...
  type AXNode extends object
    properties
      ...
      # The backend ID for the associated CnDOM node, if any.
      optional CnDOM.BackendNodeId backendDOMNodeId
      # The frame ID for the frame associated with this nodes document.
      optional CnPage.FrameId frameId
  ...
  # Fetches the accessibility node and partial accessibility tree for this CnDOM node, if it exists.
  experimental command getPartialAXTree
    parameters
      # Identifier of the node to get the partial accessibility tree for.
      optional CnDOM.NodeId nodeId
      # Identifier of the backend node to get the partial accessibility tree for.
      optional CnDOM.BackendNodeId backendNodeId
      # JavaScript object id of the node wrapper to get the partial accessibility tree for.
      optional CnRuntime.RemoteObjectId objectId
      # Whether to fetch this node's ancestors, siblings and children. Defaults to true.
      optional boolean fetchRelatives
    returns
      # The `Accessibility.AXNode` for this CnDOM node, if it exists, plus its ancestors, siblings and
  ...
  # Query a CnDOM node's accessibility subtree for accessible name and role.
  # This command computes the name and role for all nodes in the subtree, including those that are
  # ignored for accessibility, and returns those that mactch the specified name and role. If no CnDOM
  # node is specified, or the CnDOM node does not exist, the command returns an error. If neither
...
experimental domain Animation
  ...
  command resolveAnimation
    ...
    returns
      ...
      CnRuntime.RemoteObject remoteObject
...
experimental domain Audits
  ...
  type AffectedRequest extends object
    properties
      ...
      CnNetork.RequestId requestId
      optional string url

  # Information about the frame affected by an inspector issue.
  type AffectedFrame extends object
    properties
      CnPage.FrameId frameId
  ...
  type SourceCodeLocation extends object
    properties
      optional CnRuntime.ScriptId scriptId
      string url
      integer lineNumber
  ...
  type ContentSecurityPolicyIssueDetails extends object
    properties
      ...
      optional CnDOM.BackendNodeId violatingNodeId
  ...
  type LowTextContrastIssueDetails extends object
    properties
      CnDOM.BackendNodeId violatingNodeId
  ...
  type CorsIssueDetails extends object
    properties
      CnNetork.CorsErrorStatus corsErrorStatus
      boolean isWarning
      AffectedRequest request
      optional SourceCodeLocation location
      optional string initiatorOrigin
      optional CnNetork.IPAddressSpace resourceIPAddressSpace
      optional CnNetork.ClientSecurityState clientSecurityState
...
# or Limited Quirks Mode that affects page layouting.
  type QuirksModeIssueDetails extends object
    properties
      ...
      CnDOM.BackendNodeId documentNodeId
      string url
      CnPage.FrameId frameId
      CnNetork.LoaderId loaderId
  ...
  type FailedRequestInfo extends object
    properties
      ...
      optional CnNetork.RequestId requestId
...
experimental domain CnBackgroundService
  ...
  type CnBackgroundServiceEvent extends object
    properties
      # Timestamp of the event (in seconds).
      CnNetork.TimeSinceEpoch timestamp
      # The origin this event belongs to.
      string origin
      # The Service Worker ID that initiated the event.
      CnServiceWorker.RegistrationID serviceWorkerRegistrationId
      ...
      # CnStorage key this event belongs to.
      string storageKey

  # Called with all existing CnBackgroundServiceEvents when enabled, and all new
  # events afterwards if enabled and recording.
  event CnBackgroundServiceEventReceived
    parameters
      CnBackgroundServiceEvent CnBackgroundServiceEvent

# The CnBrowser domain defines methods and events for browser managing.
domain CnBrowser
  ...
  # CnBrowser window bounds information
  ...
  # CnBrowser command ids used by executeBrowserCommand.
  ...
  experimental command getWindowForTarget
    parameters
      ...
      optional CnTarget.TargetID targetId
    returns
      # CnBrowser window id.
      WindowID windowId
      # Bounds information of the window. When window state is 'minimized', the restored window
...
# CSS objects can be loaded using the `get*ForNode()` calls (which accept a CnDOM node id). A client
...
experimental domain CSS
  ...
  type CSSStyleSheetHeader extends object
    properties
      ...
      optional CnDOM.BackendNodeId ownerNode
  ...
  experimental type CSSContainerQuery extends object
    properties
      ...
      optional CnDOM.PhysicalAxes physicalAxes
      # Optional logical axes queried for the container.
      optional CnDOM.LogicalAxes logicalAxes
  ...
  # Returns the computed style for a CnDOM node identified by `nodeId`.
  command getComputedStyleForNode
    parameters
      CnDOM.NodeId nodeId
    returns
      # Computed style for the specified CnDOM node.
      array of CSSComputedStyleProperty computedStyle

  # Returns the styles defined inline (explicitly in the "style" attribute and implicitly, using CnDOM
  # attributes) for a CnDOM node identified by `nodeId`.
  command getInlineStylesForNode
    parameters
      CnDOM.NodeId nodeId
    returns
      # Inline style for the specified CnDOM node.
      optional CSSStyle inlineStyle
      # Attribute-defined element style (e.g. resulting from "width=20 height=100%").
      optional CSSStyle attributesStyle

  # Returns requested styles for a CnDOM node identified by `nodeId`.
  command getMatchedStylesForNode
    ...
    returns
      ...
      # A chain of inherited styles (from the immediate node parent up to the CnDOM tree root).
      optional array of InheritedStyleEntry inherited
      # A chain of inherited pseudo element styles (from the immediate node parent up to the CnDOM tree root).
      ...
      experimental optional CnDOM.NodeId parentLayoutNodeId
  ...
  # Given a CnDOM element identified by nodeId, getLayersForNode returns the root
  ...
  # by the CnDOM agent. If no changes to the tracked properties occur after the node has been pushed
...
experimental domain CacheStorage
  ...
  type Cache extends object
    properties
      ...
      CacheId cacheId
      # CnSecurity origin of the cache.
      string securityOrigin
      # CnStorage key of the cache.
      string storageKey
      # CnStorage bucket of the cache.
      optional CnStorage.StorageBucket storageBucket
  ...
  command requestCacheNames
    parameters
      ...
      # CnStorage bucket. If not specified, it uses the default bucket.
      optional CnStorage.StorageBucket storageBucket
    returns
...
# This domain exposes CnDOM read/write operations. Each CnDOM Node is represented with its mirror object
# that has an `id`. This `id` can be used to get additional information on the Node, resolve it into
# the JavaScript object wrapper, etc. It is important that client receives CnDOM events only for the
...
domain CnDOM
  ...
  # Unique CnDOM node identifier.
  type NodeId extends integer

  # Unique CnDOM node identifier used to reference a node that may not have been pushed to the
  # front-end.
  ...
  # CnDOM interaction is implemented in terms of mirror objects that represent the actual CnDOM nodes.
  # DOMNode is a base node mirror type.
  type Node extends object
    properties
      # Node identifier that is passed into the rest of the CnDOM messages as the `nodeId`. Backend
      # will only push node with given `id` once. It is aware of all requested nodes and will only
      # fire CnDOM events for nodes known to the client.
      NodeId nodeId
  ...
  # Disables CnDOM agent for the given page.
  command disable
  ...
  # Enables CnDOM agent for the given page.
  command enable
    parameters
  ...
  # Returns the root CnDOM node (and optionally the subtree) to the caller.
  # Implicitly enables the CnDOM domain events for the current target.
  command getDocument
    parameters
      # The maximum depth at which children should be retrieved, defaults to 1. Use -1 for the
      # entire subtree or provide an integer larger than 0.
  ...
  # Returns the root CnDOM node (and optionally the subtree) to the caller.
  # Deprecated, as it is not designed to work well with the rest of the CnDOM agent.
  ...
  # Returns node id at given location. Depending on whether CnDOM domain is enabled, nodeId is
  ...
  command hideHighlight
    # Use 'CnOverlay.hideHighlight' instead
    redirect CnOverlay

  # Highlights CnDOM node.
  command highlightNode
    # Use 'CnOverlay.highlightNode' instead
    redirect CnOverlay

  # Highlights given rectangle.
  command highlightRect
    # Use 'CnOverlay.highlightRect' instead
    redirect CnOverlay
  ...
  # Searches for a given string in the CnDOM tree. Use `getSearchResults` to access search results or
  # `cancelSearch` to end this search session.
  experimental command performSearch
    parameters
      # Plain text or query selector or XPath search query.
      string query
      # True to search in user agent shadow CnDOM.
      optional boolean includeUserAgentShadowDOM
    returns
      # Unique search session identifier.
      string searchId
  ...
  command requestNode
    parameters
      ...
      CnRuntime.RemoteObjectId objectId
    returns
  ...
  command resolveNode
    parameters
      ...
      optional CnRuntime.ExecutionContextId executionContextId
    returns
      # JavaScript object wrapper for given node.
      CnRuntime.RemoteObject object
  ...
  experimental command getNodeStackTraces
    ...
    returns
      ...
      optional CnRuntime.StackTrace creation
  ...
  experimental command setInspectedNode
    parameters
      # CnDOM node id to be accessible by means of $x command line API.
      NodeId nodeId
  ...
  # Fired when backend wants to provide client with the missing CnDOM structure. This happens upon
...
# CnDOM debugging allows setting breakpoints on particular CnDOM operations and events. JavaScript
...
domain DOMDebugger
  ...
  type EventListener extends object
    properties
      ...
      CnRuntime.ScriptId scriptId
      # Line number in the script (0-based).
      integer lineNumber
      # Column number in the script (0-based).
      integer columnNumber
      # Event handler function value.
      optional CnRuntime.RemoteObject handler
      # Event original handler function value.
      optional CnRuntime.RemoteObject originalHandler
  ...
  # Removes CnDOM breakpoint that was set using `setDOMBreakpoint`.
  ...
  # Removes breakpoint on particular CnDOM event.
  ...
  # Sets breakpoint on particular operation with CnDOM.
  ...
  # Sets breakpoint on particular CnDOM event.
  command setEventListenerBreakpoint
    parameters
      # CnDOM Event name to stop on (any CnDOM event will do).
      string eventName
...
# events in targets that run JavaScript but do not have a CnDOM.
...
# This domain facilitates obtaining document snapshots with CnDOM, layout, and style information.
experimental domain DOMSnapshot
  ...
  type DOMNode extends object
    properties
      ...
      # `Node`'s id, corresponds to CnDOM.Node.backendNodeId.
      CnDOM.BackendNodeId backendNodeId
      ...
      optional CnDOM.PseudoType pseudoType
      # Shadow root type.
      optional CnDOM.ShadowRootType shadowRootType
      # Whether this CnDOM node responds to mouse clicks. This includes nodes that have had click
  ...
  # Details of an element in the CnDOM tree with a LayoutObject.
  type LayoutTreeNode extends object
    properties
      # The index of the related CnDOM node in the `domNodes` array returned by `getSnapshot`.
  ...
  type NodeTreeSnapshot extends object
    properties
      ...
      # `Node`'s id, corresponds to CnDOM.Node.backendNodeId.
      optional array of CnDOM.BackendNodeId backendNodeId
  ...
  # Table of details of an element in the CnDOM tree with a LayoutObject.
  ...
  # Disables CnDOM snapshot agent for the given page.
  command disable

  # Enables CnDOM snapshot agent for the given page.
  command enable

  # Returns a document snapshot, including the full CnDOM tree of the root node (including iframes,
  # template contents, and imported documents) in a flattened array, as well as layout and
  # white-listed computed style information for the nodes. Shadow CnDOM in the returned CnDOM tree is
  # flattened.
  deprecated command getSnapshot
    parameters
      # Whitelist of computed styles to return.
      array of string computedStyleWhitelist
      # Whether or not to retrieve details of CnDOM listeners (default false).
    ...
    returns
      # The nodes in the CnDOM tree. The DOMNode at index 0 corresponds to the root document.
  ...
  command captureSnapshot
    parameters
      ...
      optional boolean includePaintOrder
      # Whether to include CnDOM rectangles (offsetRects, clientRects, scrollRects) into the snapshot
...
# Query and modify CnDOM storage.
experimental domain DOMStorage

  type SerializedStorageKey extends string

  # CnDOM CnStorage identifier.
  type StorageId extends object
    properties
      # CnSecurity origin for the storage.
      optional string securityOrigin
      # Represents a key by which CnDOM CnStorage keys its CachedStorageAreas
      optional SerializedStorageKey storageKey
      # Whether the storage is local storage (not session storage).
      boolean isLocalStorage

  # CnDOM CnStorage item.
...
domain CnEmulation
  ...
  command setDeviceMetricsOverride
    parameters
      ...
      experimental optional CnPage.Viewport viewport
  ...
  experimental command setVirtualTimePolicy
    parameters
      ...
      optional CnNetork.TimeSinceEpoch initialVirtualTime
    returns
  ...
  command setUserAgentOverride
    parameters
      # User agent to use.
      string userAgent
      # CnBrowser langugage to emulate.
...
experimental domain IndexedDB
  ...
  type DataEntry extends object
    properties
      # Key object.
      CnRuntime.RemoteObject key
      # Primary key object.
      CnRuntime.RemoteObject primaryKey
      # Value object.
      CnRuntime.RemoteObject value
...
domain Input
  ...
  command dispatchKeyEvent
    parameters
      ...
      # Unique CnDOM defined string value for each physical key (e.g., 'KeyA') (default: "").
      optional string code
      # Unique CnDOM defined string value describing the meaning of the key in the context of active
...
experimental domain CnInspector
...
experimental domain LayerTree
  ...
  type StickyPositionConstraint extends object
    properties
      ...
      CnDOM.Rect stickyBoxRect
      # Layout rectangle of the containing block of the sticky element
      CnDOM.Rect containingBlockRect
...
domain CnLog
  ...
  type LogEntry extends object
    properties
      ...
      CnRuntime.Timestamp timestamp
      # URL of the resource if known.
      optional string url
      # Line number in the resource.
      optional integer lineNumber
      # JavaScript stack trace.
      optional CnRuntime.StackTrace stackTrace
      # Identifier of the network request associated with this entry.
      optional CnNetork.RequestId networkRequestId
      # Identifier of the worker associated with this entry.
      optional string workerId
      # Call arguments.
      optional array of CnRuntime.RemoteObject args
...
experimental domain CnMemory

  # CnMemory pressure level.
  ...
  command simulatePressureNotification
    parameters
      # CnMemory pressure level of the notification.
      PressureLevel level
...
# CnNetork domain allows tracking network activities of the page. It exposes information about http,
# file, data and other requests and responses, their headers, bodies, timing, etc.
domain CnNetork
  depends on Debugger
  depends on CnRuntime
  depends on CnSecurity
  ...
  # CnNetork level fetch failure reason.
  ...
  type ResourceTiming extends object
    properties
      ...
      number sslEnd
      # Started running CnServiceWorker.
      experimental number workerStart
      # Finished Starting CnServiceWorker.
  ...
  type Request extends object
    properties
      ...
      optional CnSecurity.MixedContentType mixedContentType
  ...
  # CnSecurity details about a request.
  type SecurityDetails extends object
    properties
      ...
      CnSecurity.CertificateId certificateId
  ...
  type CorsError extends string
    enum
      ...
      # not carry `Private-CnNetork-Access-Id` in the preflight response.
      # https://github.com/WICG/private-network-access/blob/main/permission_prompt/explainer.md
      PreflightMissingPrivateNetworkAccessId
      # Request was a private network request and needed user permission yet did
      # not carry `Private-CnNetork-Access-Name` in the preflight response.
      # https://github.com/WICG/private-network-access/blob/main/permission_prompt/explainer.md
  ...
  type Response extends object
    properties
      ...
      Headers headers
      # HTTP response headers text. This has been replaced by the headers in CnNetork.responseReceivedExtraInfo.
      deprecated optional string headersText
      # Resource mimeType as determined by the browser.
      string mimeType
      # Refined HTTP request headers that were actually transmitted over the network.
      optional Headers requestHeaders
      # HTTP request headers text. This has been replaced by the headers in CnNetork.requestWillBeSentExtraInfo.
      ...
      # Specifies that the request was served from the CnServiceWorker.
  ...
  type Initiator extends object
    properties
      ...
      optional CnRuntime.StackTrace stack
  ...
  experimental type SignedExchangeInfo extends object
    properties
      ...
      # CnSecurity details for the signed exchange header.
      optional SecurityDetails securityDetails
  ...
  # Response to CnNetork.requestIntercepted which either modifies the request to continue with any
  # modifications, or blocks it, or completes it with the provided response bytes. If a network
  # fetch occurs as a result which encounters a redirect an additional CnNetork.requestIntercepted
  # event will be sent with the same InterceptionId.
  # Deprecated, use CnFetch.continueRequest, CnFetch.fulfillRequest and CnFetch.failRequest instead.
  ...
  # Deprecated. Use CnStorage.getCookies instead.
  ...
  # Deprecated, please use CnFetch.enable instead.
  ...
  command setUserAgentOverride
    ...
    parameters
      ...
      optional string platform
      # To be sent in Sec-CH-UA-* headers and returned in navigator.userAgentData
      experimental optional CnEmulation.UserAgentMetadata userAgentMetadata
  ...
  # mocked.
  # Deprecated, use CnFetch.requestPaused instead.
  ...
  experimental type LoadNetworkResourcePageResult extends object
    properties
      ...
      # Response headers.
      optional CnNetork.Headers headers
...
experimental domain CnOverlay
  ...
  type SourceOrderConfig extends object
    properties
      ...
      CnDOM.RGBA parentOutlineColor
      # the color to outline the child elements in.
      CnDOM.RGBA childOutlineColor
  ...
  type GridHighlightConfig extends object
    properties
      ...
      optional CnDOM.RGBA gridBorderColor
      # The cell border color (default: transparent). Deprecated, please use rowLineColor and columnLineColor instead.
      deprecated optional CnDOM.RGBA cellBorderColor
      # The row line color (default: transparent).
      optional CnDOM.RGBA rowLineColor
      # The column line color (default: transparent).
      optional CnDOM.RGBA columnLineColor
      ...
      optional CnDOM.RGBA rowGapColor
      # The row gap hatching fill color (default: transparent).
      optional CnDOM.RGBA rowHatchColor
      # The column gap highlight fill color (default: transparent).
      optional CnDOM.RGBA columnGapColor
      # The column gap hatching fill color (default: transparent).
      optional CnDOM.RGBA columnHatchColor
      # The named grid areas border color (Default: transparent).
      optional CnDOM.RGBA areaBorderColor
      # The grid container background color (Default: transparent).
      optional CnDOM.RGBA gridBackgroundColor
  ...
  type BoxStyle extends object
    properties
      ...
      optional CnDOM.RGBA fillColor
      # The hatching color for the box (default: transparent)
      optional CnDOM.RGBA hatchColor
  ...
  type HighlightConfig extends object
    properties
      ...
      optional CnDOM.RGBA contentColor
      # The padding highlight fill color (default: transparent).
      optional CnDOM.RGBA paddingColor
      # The border highlight fill color (default: transparent).
      optional CnDOM.RGBA borderColor
      # The margin highlight fill color (default: transparent).
      optional CnDOM.RGBA marginColor
      # The event target element highlight fill color (default: transparent).
      optional CnDOM.RGBA eventTargetColor
      # The shape outside fill color (default: transparent).
      optional CnDOM.RGBA shapeColor
      # The shape margin fill color (default: transparent).
      optional CnDOM.RGBA shapeMarginColor
      # The grid layout color (default: transparent).
      optional CnDOM.RGBA cssGridColor
  ...
  type ScrollSnapContainerHighlightConfig extends object
    properties
      ...
      # The margin highlight fill color (default: transparent).
      optional CnDOM.RGBA scrollMarginColor
      # The padding highlight fill color (default: transparent).
      optional CnDOM.RGBA scrollPaddingColor
  ...
  type HingeConfig extends object
    properties
      ...
      optional CnDOM.RGBA outlineColor
  ...
  type IsolationModeHighlightConfig extends object
    properties
      ...
      optional CnDOM.RGBA resizerColor
      # The fill color for resizer handles (default: transparent).
      optional CnDOM.RGBA resizerHandleColor
      # The fill color for the mask covering non-isolated elements (default: transparent).
      optional CnDOM.RGBA maskColor
  ...
  deprecated command highlightFrame
    parameters
      ...
      optional CnDOM.RGBA contentColor
      # The content box highlight outline color (default: transparent).
      optional CnDOM.RGBA contentOutlineColor

  # Highlights CnDOM node with given id or with the given JavaScript object wrapper. Either nodeId or
  ...
  # Highlights the source order of the children of the CnDOM node with given id or with the given
...
domain CnPage
  ...
  experimental type AdScriptId extends object
    properties
      ...
      CnRuntime.UniqueDebuggerId debuggerId
  ...
  experimental type OriginTrialToken extends object
    properties
      ...
      string trialName
      CnNetork.TimeSinceEpoch expiryTime
  ...
  experimental type FrameResource extends object
    properties
      ...
      string url
      # Type of this resource.
      CnNetork.ResourceType type
      # Resource mimeType as determined by the browser.
      string mimeType
      # last-modified timestamp as reported by server.
      optional CnNetork.TimeSinceEpoch lastModified
  ...
  experimental type ScreencastFrameMetadata extends object
    properties
      ...
      optional CnNetork.TimeSinceEpoch timestamp
  ...
  type VisualViewport extends object
    properties
      ...
      number scale
      # CnPage zoom factor (CSS to device independent pixels ratio).
  ...
  # Per-script compilation cache parameters for `CnPage.produceCompilationCache`
  ...
  # iframes, shadow CnDOM, external resources, and element-inline styles.
  ...
  experimental deprecated command clearDeviceMetricsOverride
    # Use 'CnEmulation.clearDeviceMetricsOverride' instead
    redirect CnEmulation
  ...
  deprecated command clearGeolocationOverride
    # Use 'CnEmulation.clearGeolocationOverride' instead
    redirect CnEmulation
  ...
  command createIsolatedWorld
    ...
    returns
      ...
      CnRuntime.ExecutionContextId executionContextId

  # Deletes browser cookie with given name, domain and path.
  experimental deprecated command deleteCookie
    # Use 'CnNetork.deleteCookie' instead
    redirect CnNetork
    parameters
  ...
  experimental deprecated command getCookies
    # Use 'CnNetork.getCookies' instead
    redirect CnNetork
    returns
      # Array of cookie objects.
      array of CnNetork.Cookie cookies
  ...
  command navigate
    ...
    returns
      ...
      optional CnNetork.LoaderId loaderId
  ...
  # Enable page Content CnSecurity Policy by-passing.
  ...
  experimental deprecated command setDeviceMetricsOverride
    # Use 'CnEmulation.setDeviceMetricsOverride' instead
    redirect CnEmulation
    parameters
      # Overriding width value in pixels (minimum 0, maximum 10000000). 0 disables the override.
      integer width
      ...
      # Screen orientation override.
      optional CnEmulation.ScreenOrientation screenOrientation
  ...
  deprecated command setGeolocationOverride
    # Use 'CnEmulation.setGeolocationOverride' instead
    redirect CnEmulation
    parameters
      # Mock latitude
      optional number latitude
  ...
  experimental deprecated command setTouchEmulationEnabled
    # Use 'CnEmulation.setTouchEmulationEnabled' instead
    redirect CnEmulation
    parameters
      # Whether the touch event emulation should be enabled.
      boolean enabled
  ...
  # See also: `CnPage.compilationCacheProduced`.
...
# Sets the Secure Payment Confirmation transaction mode.
  ...
  # Pauses page execution. Can be resumed using generic CnRuntime.runIfWaitingForDebugger.
  experimental command waitForDebugger

  # Intercept file chooser requests and transfer control to protocol clients.
  # When file chooser interception is enabled, native file chooser dialog is not shown.
  # Instead, a protocol event `CnPage.fileChooserOpened` is emitted.
  ...
  event domContentEventFired
    parameters
      CnNetork.MonotonicTime timestamp
  ...
  event fileChooserOpened
    parameters
      ...
      experimental optional CnDOM.BackendNodeId backendNodeId
  ...
  event frameDetached
    parameters
      ...
      experimental enum reason
        # The frame is removed from the CnDOM.
        remove
        # The frame is being swapped out in favor of an out-of-process iframe.
        # A new frame target will be created (see CnTarget.attachedToTarget).
        swap
  ...
  # Fired when page is about to start a download.
  # Deprecated. Use CnBrowser.downloadWillBegin instead.
  ...
  # Fired when download makes progress. Last call has |done| == true.
  # Deprecated. Use CnBrowser.downloadProgress instead.
  ...
  event javascriptDialogOpening
    parameters
      ...
      # dialog handler for given target, calling alert while CnPage domain is engaged will stall
      # the page execution. Execution can be resumed via calling CnPage.handleJavaScriptDialog.
  ...
  # not assume any ordering with the CnPage.frameNavigated event. This event is fired only for
  ...
  # if CnPage.setGenerateCompilationCache is enabled.
...
experimental domain PerformanceTimeline
  ...
  type LargestContentfulPaint extends object
    properties
      CnNetork.TimeSinceEpoch renderTime
      CnNetork.TimeSinceEpoch loadTime
      ...
      optional string url
      optional CnDOM.BackendNodeId nodeId

  type LayoutShiftAttribution extends object
    properties
      CnDOM.Rect previousRect
      CnDOM.Rect currentRect
      optional CnDOM.BackendNodeId nodeId
  ...
  type LayoutShift extends object
    properties
      ...
      CnNetork.TimeSinceEpoch lastInputTime
...
domain CnSecurity
  ...
  experimental type CertificateSecurityState extends object
    properties
      ...
      string issuer
      # Certificate valid from date.
      CnNetork.TimeSinceEpoch validFrom
      # Certificate valid to (expiration) date
      CnNetork.TimeSinceEpoch validTo
  ...
  # CnSecurity state information about the page.
  experimental type VisibleSecurityState extends object
    properties
      # The security level of the page.
      SecurityState securityState
      # CnSecurity state details about the page certificate.
  ...
  type SecurityStateExplanation extends object
    properties
      # CnSecurity state representing the severity of the factor being explained.
      SecurityState securityState
...
experimental domain CnServiceWorker
  depends on CnTarget

  type RegistrationID extends string

  # CnServiceWorker registration.
  ...
  type ServiceWorkerVersion extends object
    properties
      ...
      optional array of CnTarget.TargetID controlledClients
      optional CnTarget.TargetID targetId

  # CnServiceWorker error message.
...
experimental domain CnStorage
  depends on CnBrowser
  depends on CnNetork
  ...
  type InterestGroupDetails extends object
    properties
      string ownerOrigin
      string name
      CnNetork.TimeSinceEpoch expirationTime
  ...
  type SharedStorageMetadata extends object
    properties
      CnNetork.TimeSinceEpoch creationTime
      integer length
  ...
  type StorageBucketInfo extends object
    properties
      ...
      string id
      CnNetork.TimeSinceEpoch expiration
      # CnStorage quota (bytes).
      number quota
      boolean persistent
  ...
  command getCookies
    parameters
      # CnBrowser context to use when called on the browser endpoint.
      optional CnBrowser.BrowserContextID browserContextId
    returns
      # Array of cookie objects.
      array of CnNetork.Cookie cookies
  ...
  command setCookies
    parameters
      # Cookies to be set.
      array of CnNetork.CookieParam cookies
      # CnBrowser context to use when called on the browser endpoint.
      optional CnBrowser.BrowserContextID browserContextId
  ...
  command getUsageAndQuota
    ...
    returns
      ...
      # CnStorage usage per type (bytes).
  ...
  # Deletes the CnStorage Bucket with the given storage key and bucket name.
  ...
  event cacheStorageContentUpdated
    parameters
      # Origin to update.
      string origin
      # CnStorage key to update.
      string storageKey
      # CnStorage bucket to update.
      string bucketId
  ...
  event interestGroupAccessed
    parameters
      CnNetork.TimeSinceEpoch accessTime
  ...
  event sharedStorageAccessed
    parameters
      # Time of the access.
      CnNetork.TimeSinceEpoch accessTime
      # Enum value indicating the Shared CnStorage API method invoked.
      SharedStorageAccessType type
      # CitizenNotes Frame Token for the primary frame tree's root.
      CnPage.FrameId mainFrameId
      # Serialized origin for the context that invoked the Shared CnStorage API.
      string ownerOrigin
...
# The CnSystemInfo domain defines methods and events for querying low-level system information.
experimental domain CnSystemInfo
...
domain CnTarget
  ...
  type TargetInfo extends object
    properties
      ...
      experimental optional CnPage.FrameId openerFrameId
      experimental optional CnBrowser.BrowserContextID browserContextId
  ...
  experimental command exposeCitizenNotesProtocol
    parameters
      TargetID targetId
  ...
  experimental command createBrowserContext
    ...
    returns
      ...
      CnBrowser.BrowserContextID browserContextId

  # Returns all browser contexts created with `CnTarget.createBrowserContext` method.
  experimental command getBrowserContexts
    returns
      # An array of browser context ids.
      array of CnBrowser.BrowserContextID browserContextIds
  ...
  experimental command setAutoAttach
    parameters
      ...
      boolean autoAttach
      # Whether to pause new targets when attaching to them. Use `CnRuntime.runIfWaitingForDebugger`
  ...
  # `setAutoAttach`. Only available at the CnBrowser target.
...
# The CnTethering domain defines methods and events for browser port binding.
experimental domain CnTethering
...
experimental domain CnTracing
  ...
  # `auto` chooses `system` when the perfettoConfig provided to CnTracing.start
...
domain CnFetch
  ...
  type RequestPattern extends object
    properties
      ...
      optional string urlPattern
      # If set, only requests for matching resource types will be intercepted.
      optional CnNetork.ResourceType resourceType
      # Stage at which to begin intercepting requests. Default is Request.
  ...
  command failRequest
    parameters
      ...
      CnNetork.ErrorReason errorReason
  ...
  event requestPaused
    parameters
      ...
      CnNetork.Request request
      # The id of the frame that initiated the request.
      CnPage.FrameId frameId
      # How the requested resource will be used.
      CnNetork.ResourceType resourceType
      # Response error if intercepted at response stage.
      optional CnNetork.ErrorReason responseErrorReason
      ...
      optional array of HeaderEntry responseHeaders
      # If the intercepted request had a corresponding CnNetork.requestWillBeSent event fired for it,
      # then this networkId will be the same as the requestId present in the requestWillBeSent event.
      optional CnNetork.RequestId networkId
...
# Protocol object for AudioListener
  ...
  # CnFetch the realtime data from the registered contexts.
...
# This domain allows configuring virtual authenticators to test the CnWebAuthn
# API.
experimental domain CnWebAuthn
  ...
  # Enable the CnWebAuthn domain and start intercepting credential storage and
  # retrieval with a virtual authenticator.
  command enable
    parameters
      # Whether to enable the CnWebAuthn user interface. Enabling the UI is
...
experimental domain CnDeviceAccess
  # Device request id.
  type RequestId extends string
  ...
  # Select a device in response to a CnDeviceAccess.deviceRequestPrompted event.
  command selectPrompt
    parameters
      RequestId id
      DeviceId deviceId

  # Cancel a prompt in response to a CnDeviceAccess.deviceRequestPrompted event.
...
experimental domain CnPreload
  ...
  type RuleSet extends object
    properties
      ...
      # from, and also RequestId if CnNetork domain is enabled.
      #
      # See also:
  ...
  type PreloadingAttemptSource extends object
    properties
      ...
      array of CnDOM.BackendNodeId nodeIds
  ...
  type PrerenderFinalStatus extends string
    enum
      ...
      PrerenderingDisabledByCitizenNotes
  ...
  event prerenderAttemptCompleted
    parameters
      ...
      CnPage.FrameId initiatingFrameId
...
# This domain allows interacting with the CnFedCM dialog.
experimental domain CnFedCM
  ...
  command enable
    parameters
      ...
      # (step 4 of https://fedidcg.github.io/CnFedCM/#browser-api-rp-sign-in)
  ...
  # Resets the cooldown time, if any, to allow the next CnFedCM call to show
