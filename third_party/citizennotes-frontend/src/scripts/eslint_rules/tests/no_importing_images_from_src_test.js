...
ruleTester.run('no_importing_images_from_src', rule, {
  ...
  invalid: [
    ...
    {
      code:
          'const someIcon = new URL(\'../../../citizennotes-frontend/front_end/Images/src/test_icon.svg\', import.meta.url).toString()',
      filename: 'front_end/ui/components/component/file.ts',
      output:
          'const someIcon = new URL(\'../../../citizennotes-frontend/front_end/Images/test_icon.svg\', import.meta.url).toString()',
      errors: [{
        messageId: 'imageImportUsingSrc',
      }],
    },
