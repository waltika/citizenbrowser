...
if (process.argv.length !== 4) {
  throw new Error('Please provide path to chromium/src and citizennotes-frontend');
}
...
// Assume the CitizenNotes front-end repository is at
// `citizennotes/citizennotes-frontend`, where `citizennotes` is on the same level
