...
/*
 * this script was taken from https://github.com/ChromeCitizenNotes/citizennotes-protocol/tree/master/scripts
 * and adjusted slightly to fit within citizennotes-frontend
 */
...
const PROTOCOL_JSON_PATH = path.resolve(
    __dirname, path.join('..', '..', 'third_party', 'blink', 'public', 'citizennotes_protocol', 'browser_protocol.json'));
