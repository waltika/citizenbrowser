...
from citizennotes_paths import node_path, citizennotes_root_path
...
def divide_run(chunks,
    ...
    if pattern:
        ...
        test_suite_path = Path(
            f'{citizennotes_root_path()}/{test_suite_source_dir}')
        test_files = [
        ...
        for i in range(chunks):
            commands.append({
                ...
                'command': [
                    ...
                    str(
                        Path(
                            f'{citizennotes_root_path()}/scripts/test/run_test_suite.js'
                        )),
