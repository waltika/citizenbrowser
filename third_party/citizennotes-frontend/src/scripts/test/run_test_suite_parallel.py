...
if __name__ == '__main__':
    ...
    for i in range(len(commands)):
        if not args.no_failure_screenshots_file:
            env["HTML_OUTPUT_FILE"] = f'{citizennotes_paths.citizennotes_root_path()}/out/failure_screenshots_{i}.html'
    ...
    if not args.no_failure_screenshots_file and failed_tests:
        merge_files([
            f'{citizennotes_paths.citizennotes_root_path()}/out/failure_screenshots_{i}.html'
            for i in range(len(commands))
        ], f'{citizennotes_paths.citizennotes_root_path()}/out/failure_screenshots.html'
                    )
        cprint(
            f'Failure screenshots: {citizennotes_paths.citizennotes_root_path()}/out/failure_screenshots.html',
            'white')
        print()
