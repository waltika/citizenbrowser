...
def run_tests(chrome_binary, target, no_text_coverage, no_html_coverage,
    ...
    exec_command = [
        ...
        citizennotes_paths.karma_path(), 'start',
    ...
    env = os.environ.copy()
    env['NODE_PATH'] = citizennotes_paths.node_path()
...
def run_unit_tests_on_ninja_build_target(target,
    ...
    if not chrome_binary:
        ...
        downloaded_chrome_binary = citizennotes_paths.downloaded_chrome_binary_path(
        )
    ...
    if not cwd:
        cwd = citizennotes_paths.citizennotes_root_path()
...
def main():
    ...
    parser.add_argument('--cwd',
                        ...
                        default=citizennotes_paths.citizennotes_root_path())
