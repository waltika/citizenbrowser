...
# Add the scripts path, so that we can import the citizennotes_paths
...
def popen(arguments, cwd=citizennotes_paths.citizennotes_root_path(), env=os.environ.copy()):
