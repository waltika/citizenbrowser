#!/usr/bin/env python3
# Copyright 2023 The CitizenNotes Authors. All rights reserved.
...
class ProjectConfig:
    def __init__(self,
                 ...
                 gs_root='gs://citizennotes-frontend-screenshots',
                 builder_prefix='citizennotes_screenshot',
                 platforms=None,
...
WARNING_GSUTIL_CONNECTIVITY = (
    ...
    'in the citizennotes-dev@google.com group.\n'
