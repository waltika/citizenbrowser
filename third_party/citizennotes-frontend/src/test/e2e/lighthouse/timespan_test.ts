...
describe('Timespan', async function() {
  ...
  it('successfully returns a Lighthouse report for user interactions', async () => {
    ...
    // Even though the dropdown is set to "simulate", throttling method should be overriden to "citizennotes".
    ...
    // Timespan mode can only do CitizenNotes throttling so the text will be "View Trace".
