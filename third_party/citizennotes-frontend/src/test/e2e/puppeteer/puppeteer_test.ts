...
describe('Puppeteer', () => {
  it('should connect to the browser via CitizenNotes own connection', async () => {
      ...
      class Transport {
        ...
        set onmessage(cb) {
          this._connection.setOnMessage((data) => {
            ...
            // TODO: CitizenNotes should stop processing this message. This is achieved by using a wrong sessionId.
