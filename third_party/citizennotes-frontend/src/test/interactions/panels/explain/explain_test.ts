...
describe('ConsoleInsight', function() {
  ...
  itScreenshot('renders initial state', async () => {
    ...
    await assertElementScreenshotUnchanged(await waitFor('citizennotes-console-insight'), 'explain/console_insight.png', 3);
  });
  ...
  itScreenshot('renders refined state', async () => {
    ...
    await assertElementScreenshotUnchanged(
        await waitFor('citizennotes-console-insight'), 'explain/console_insight_refined.png', 3);
  });
  ...
  itScreenshot('renders tooltip', async () => {
    ...
    await hover('.info');
    await assertElementScreenshotUnchanged(
        await waitFor('[data-citizennotes-glass-pane]'), 'explain/console_insight_info.png', 3);
  });
