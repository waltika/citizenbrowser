...
### Debugging with CitizenNotes

To run tests under the CitizenNotes debugger use `DEBUG_TEST` environment variable.
...
appear and click it. A new page will open, here you can open CitizenNotes, set
