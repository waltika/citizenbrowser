...
This folder contains traces saved by the CitizenNotes Performance Panel that can be used in tests.
...
If you have created an example website to generate a trace, consider contributing it to the [Performance Stories repository](https://github.com/ChromeCitizenNotes/performance-stories).
...
Generated from the [long-interaction story](https://github.com/ChromeCitizenNotes/performance-stories/tree/main/long-interaction). Contains one slow interaction which is the user clicking on a button.

## slow-interaction-keydown

Generated from the [long-interaction story](https://github.com/ChromeCitizenNotes/performance-stories/tree/main/long-interaction). Contains one slow interaction which is the user typing into the input field. There is also another interaction representing the user clicking into the text field to focus it, but this is not a long interaction.
...
Generated from https://github.com/ChromeCitizenNotes/performance-stories/tree/main/user-timings

### lcp-web-font

Generated from https://github.com/ChromeCitizenNotes/performance-stories/tree/main/lcp-web-font

### lcp-images

Generated from https://github.com/ChromeCitizenNotes/performance-stories/tree/main/lcp-large-image
...
Generated by https://github.com/ChromeCitizenNotes/performance-stories/tree/main/animation.

### many-requests

Generated by https://github.com/ChromeCitizenNotes/performance-stories/tree/main/lots-of-network-requests. Loads 20 images from the placeholder API and an extra script and stylesheet. Trace was recorded on 3G throttling, so some of the requests have not even finished.
...
Generated from https://github.com/ChromeCitizenNotes/performance-stories/tree/main/forced-layout-main-thread. Has a large layout event (126ms) and a smaller recalc style event (4.07ms).

### large-recalc-style

Generated from https://github.com/ChromeCitizenNotes/performance-stories/tree/main/forced-layout-main-thread. Has a large recalc style event.

### two-workers

Generated from https://github.com/ChromeCitizenNotes/performance-stories/tree/main/two-workers. Runs two workers that both calculcate fibonnaci numbers.
