...
function fnExpectingUrlString(urlString: Platform.CitizenNotesPath.UrlString): void {
  urlString;
}

function fnExpectingRawPathString(rawPathString: Platform.CitizenNotesPath.RawPathString): void {
  rawPathString;
}

function fnExpectingEncodedPathString(encPathString: Platform.CitizenNotesPath.EncodedPathString): void {
  encPathString;
}
...
const urlString = 'urlStr' as Platform.CitizenNotesPath.UrlString;
...
const rawPathString = 'rawPathStr' as Platform.CitizenNotesPath.RawPathString;
...
const encPathString = 'encPathStr' as Platform.CitizenNotesPath.EncodedPathString;
