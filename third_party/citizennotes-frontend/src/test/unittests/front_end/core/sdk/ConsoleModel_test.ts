...
describeWithMockConnection('ConsoleMessage', () => {
  ...
  it('compares using url', () => {
    const a = newMessage({});
    const b = newMessage({url: 'http://a.b/c' as Platform.CitizenNotesPath.UrlString});
    const c = newMessage({url: 'http://a.b/c' as Platform.CitizenNotesPath.UrlString});
    const d = newMessage({url: 'http://a.b/d' as Platform.CitizenNotesPath.UrlString});
