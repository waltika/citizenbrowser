...
describe('NetworkRequest', () => {
  ...
  it('parses reponse cookies from headers', () => {
    const request = SDK.NetworkRequest.NetworkRequest.createWithoutBackendRequest(
        'requestId', 'url' as Platform.CitizenNotesPath.UrlString, 'documentURL' as Platform.CitizenNotesPath.UrlString, null);
  ...
  it('infers status text from status code if none given', () => {
    const fakeRequest = SDK.NetworkRequest.NetworkRequest.createWithoutBackendRequest(
        ...
        'documentURL' as Platform.CitizenNotesPath.UrlString,
        null,
    );
  ...
  it('can handle the case of duplicate cookies with only 1 of them being blocked', async () => {
    const request = SDK.NetworkRequest.NetworkRequest.create(
        'requestId' as Protocol.Network.RequestId, 'url' as Platform.CitizenNotesPath.UrlString,
        'documentURL' as Platform.CitizenNotesPath.UrlString, null, null, null);
    request.addExtraResponseInfo({
