...
describeWithMockConnection('OverlayWindowControls', () => {
  const DOCUMENT_URL_FOR_TEST = 'https://example.com/' as Platform.CitizenNotesPath.UrlString;
  ...
  it('initializes the style sheet text', async () => {
    ...
    const styleSheetIds =
        cssModel.getStyleSheetIdsForURL(`${DOCUMENT_URL_FOR_TEST}styles.css` as Platform.CitizenNotesPath.UrlString);
