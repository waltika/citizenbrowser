...
const initiator = {
  ...
  initiatorUrl: Platform.CitizenNotesPath.EmptyUrlString,
};

describeWithLocale('PageResourceLoader', () => {
  const foo1Url = 'foo1' as Platform.CitizenNotesPath.UrlString;
  const foo2Url = 'foo2' as Platform.CitizenNotesPath.UrlString;
  const foo3Url = 'foo3' as Platform.CitizenNotesPath.UrlString;
...
describeWithEnvironment('PageResourceLoader', () => {
  it('blocks UNC file paths with the default setting', async () => {
    ...
    const message =
        await loader
            .loadResource('file:////127.0.0.1/share/source-map.js.map' as Platform.CitizenNotesPath.UrlString, initiator)
            .catch(e => e.message);
  ...
  it('blocks remote file paths with the default setting', async () => {
    ...
    const message =
        await loader.loadResource('file://host/source-map.js.map' as Platform.CitizenNotesPath.UrlString, initiator)
            .catch(e => e.message);
  ...
  it('allows UNC paths on Windows with the setting enabled', async () => {
    ...
    const response = await loader.loadResource(
        'file:////127.0.0.1/share/source-map.js.map' as Platform.CitizenNotesPath.UrlString, initiator);
...
describeWithMockConnection('PageResourceLoader', () => {
  describe('loadResource', () => {
    ...
    const initiatorUrl = 'htp://example.com' as Platform.CitizenNotesPath.UrlString;
    const url = `${initiatorUrl}/test.txt` as Platform.CitizenNotesPath.UrlString;
