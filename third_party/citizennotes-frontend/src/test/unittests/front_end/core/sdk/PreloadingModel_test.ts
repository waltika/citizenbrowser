    ...
    assert.deepEqual(model.getPreloadingAttempts(null), [
      {
        ...
        value: {
          ...
          key: {
            loaderId: 'loaderId:1' as Protocol.Network.LoaderId,
            action: Protocol.Preload.SpeculationAction.Prefetch,
            url: 'https://example.com/subresource.js' as Platform.CitizenNotesPath.UrlString,
          },
          status: SDK.PreloadingModel.PreloadingStatus.Running,
          prefetchStatus: null,
      ...
      },
      {
        ...
        value: {
          ...
          key: {
            loaderId: 'loaderId:1' as Protocol.Network.LoaderId,
            action: Protocol.Preload.SpeculationAction.Prerender,
            url: 'https://example.com/page.html' as Platform.CitizenNotesPath.UrlString,
          },
          status: SDK.PreloadingModel.PreloadingStatus.Running,
    ...
    assert.deepEqual(model.getPreloadingAttempts(null), [
      {
        ...
        value: {
          ...
          key: {
            loaderId: 'loaderId:2' as Protocol.Network.LoaderId,
            action: Protocol.Preload.SpeculationAction.Prefetch,
            url: 'https://example.com/subresource2.js' as Platform.CitizenNotesPath.UrlString,
          },
          status: SDK.PreloadingModel.PreloadingStatus.Running,
          prefetchStatus: null,
          requestId: 'requestId:1' as Protocol.Network.RequestId,
    ...
    assert.deepEqual(model.getPreloadingAttempts(null), [
      {
        ...
        value: {
          ...
          key: {
            loaderId: 'loaderId:1' as Protocol.Network.LoaderId,
            action: Protocol.Preload.SpeculationAction.Prefetch,
            url: 'https://example.com/subresource12.js' as Platform.CitizenNotesPath.UrlString,
          },
          status: SDK.PreloadingModel.PreloadingStatus.Running,
          prefetchStatus: null,
          requestId: 'requestId:1' as Protocol.Network.RequestId,
