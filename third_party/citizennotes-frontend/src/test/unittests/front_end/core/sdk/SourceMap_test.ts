...
const sourceUrlFoo = '<foo>' as Platform.CitizenNotesPath.UrlString;

describe('SourceMapEntry', () => {
  it('can be instantiated correctly', () => {
    const sourceMapEntry = new SDK.SourceMap.SourceMapEntry(
        1, 1, 'http://www.example.com/' as Platform.CitizenNotesPath.UrlString, 1, 1, 'example');
    ...
    assert.strictEqual(
        sourceMapEntry.sourceURL, 'http://www.example.com/' as Platform.CitizenNotesPath.UrlString,
...
describeWithEnvironment('SourceMap', () => {
  const compiledUrl = 'compiled.js' as Platform.CitizenNotesPath.UrlString;
  const sourceMapJsonUrl = 'source-map.json' as Platform.CitizenNotesPath.UrlString;
  const sourceUrlExample = 'example.js' as Platform.CitizenNotesPath.UrlString;
  const sourceUrlOther = 'other.js' as Platform.CitizenNotesPath.UrlString;
  ...
  it('can parse source maps with ClosureScript names', () => {
    /*
      ...
      (ns citizennotes-sample.chrome-issue-611738)
      ...
      (ns citizennotes-sample.chrome-issue-611738
      (:require-macros [citizennotes-sample.chrome-issue-611738 :refer [m]]))
      ...
      goog.provide('citizennotes_sample.chrome_issue_611738');
      ...
      {"version":3,"file":"\/Users\/darwin\/code\/cljs-citizennotes-sample\/resources\/public\/_compiled\/demo\/citizennotes_sample\/chrome_issue_611738.js","sources":["chrome_issue_611738.cljs"],"lineCount":7,"mappings":";AAAA;;AAGA,kBAAA,dAAMA;AAAN,AACE,IAAAC,uBAAA;AAAA,AAAA","names":["name1","generated31465"]}
      ------------------------------------------------------------------------------------
    */
    const sourceMap = new SDK.SourceMap.SourceMap(compiledUrl, sourceMapJsonUrl, {
      version: 3,
  ...
  it('resolves duplicate canonical urls', () => {
    ...
    const sourceMapJsonUrl = 'wp://test/source-map.json' as Platform.CitizenNotesPath.UrlString;
    const sourceMap = new SDK.SourceMap.SourceMap(compiledUrl, sourceMapJsonUrl, mappingPayload);
  ...
  describe('compatibleForURL', () => {
    const compiledURL = 'http://example.com/foo.js' as Platform.CitizenNotesPath.UrlString;
    const sourceMappingURL = `${compiledURL}.map` as Platform.CitizenNotesPath.UrlString;
    const sourceRoot = 'webpack:///src';
    const sourceURL = `${sourceRoot}/foo.ts` as Platform.CitizenNotesPath.UrlString;
  ...
  describe('source URL resolution', () => {
      ...
      it(`can resolve sourceURL "${sourceURL}" with sourceRoot "${sourceRoot}" and sourceMapURL "${sourceMapURL}"`,
         () => {
           ...
           const sourceMap = new SDK.SourceMap.SourceMap(
               compiledUrl, sourceMapURL as Platform.CitizenNotesPath.UrlString, mappingPayload);
    ...
    it('does not touch sourceURLs that conflict with the compiled URL', () => {
      const sourceURL = 'http://localhost:12345/index.js' as Platform.CitizenNotesPath.UrlString;
      const sourceMappingURL = `${sourceURL}.map` as Platform.CitizenNotesPath.UrlString;
  ...
  describe('automatic ignore-listing', () => {
    it('parses the known third parties from the `ignoreList` section', () => {
      ...
      assert.strictEqual(sourceMap.hasIgnoreListHint('wp:///vendor.js' as Platform.CitizenNotesPath.UrlString), true);
      assert.strictEqual(sourceMap.hasIgnoreListHint('wp:///main.js' as Platform.CitizenNotesPath.UrlString), false);
      assert.strictEqual(sourceMap.hasIgnoreListHint('wp:///example.js' as Platform.CitizenNotesPath.UrlString), false);
      assert.strictEqual(sourceMap.hasIgnoreListHint('wp:///other.js' as Platform.CitizenNotesPath.UrlString), true);
    });
    ...
    it('computes ranges for third party code in a simple case', () => {
      ...
      assert.strictEqual(sourceMap.hasIgnoreListHint('wp:///foo.js' as Platform.CitizenNotesPath.UrlString), false);
      assert.strictEqual(sourceMap.hasIgnoreListHint('wp:///vendor1.js' as Platform.CitizenNotesPath.UrlString), true);
      assert.strictEqual(sourceMap.hasIgnoreListHint('wp:///vendor2.js' as Platform.CitizenNotesPath.UrlString), true);
      assert.strictEqual(sourceMap.hasIgnoreListHint('wp:///vendor3.js' as Platform.CitizenNotesPath.UrlString), true);
    ...
    it('computes ranges for third party code when parts of the script are third-party', () => {
      ...
      assert.strictEqual(sourceMap.hasIgnoreListHint('wp:///foo.js' as Platform.CitizenNotesPath.UrlString), false);
      assert.strictEqual(sourceMap.hasIgnoreListHint('wp:///bar.js' as Platform.CitizenNotesPath.UrlString), false);
      assert.strictEqual(sourceMap.hasIgnoreListHint('wp:///baz.js' as Platform.CitizenNotesPath.UrlString), false);
      assert.strictEqual(sourceMap.hasIgnoreListHint('wp:///vendor1.js' as Platform.CitizenNotesPath.UrlString), true);
      assert.strictEqual(sourceMap.hasIgnoreListHint('wp:///vendor2.js' as Platform.CitizenNotesPath.UrlString), true);
      assert.strictEqual(sourceMap.hasIgnoreListHint('wp:///vendor3.js' as Platform.CitizenNotesPath.UrlString), true);
  ...
  describe('reverseMapTextRanges', () => {
    ...
    it('correctly handles overlapping mappings', () => {
      ...
      // CitizenNotes will currently resolve this case: It will purely go by the reverse
