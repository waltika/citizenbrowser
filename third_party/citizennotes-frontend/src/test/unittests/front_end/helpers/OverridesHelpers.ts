...
export async function createWorkspaceProject(
    baseUrl: Platform.CitizenNotesPath.UrlString, files: Array<{path: string, content: string, name: string}>) {
  ...
  for (const file of files) {
    const url = file.path.concat(file.name) as Platform.CitizenNotesPath.UrlString;
