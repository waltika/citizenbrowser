...
export function createFileSystemFileForPersistenceTests(
    fileSystemScript: {
      fileSystemFileUrl: Platform.CitizenNotesPath.UrlString,
      fileSystemPath: Platform.CitizenNotesPath.UrlString,
      type?: string,
    },
    networkScriptUrl: Platform.CitizenNotesPath.UrlString, content: string, target: SDK.Target.Target):
...
function dispatchDocumentOpened(target: SDK.Target.Target, origin: Platform.CitizenNotesPath.UrlString) {
...
function createResourceInMainFrame(
    target: SDK.Target.Target, networkScriptUrl: Platform.CitizenNotesPath.UrlString, mimeType: string, content: string) {
