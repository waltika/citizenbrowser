...
const sourceMapThirdPartyFolderUrl = 'http://a.b.c/lib' as Platform.CitizenNotesPath.UrlString;
const sourceMapThirdPartyUrl = 'http://a.b.c/lib/source1.ts' as Platform.CitizenNotesPath.UrlString;
const sourceMapNodeModulesUrl = 'http://a.b.c/node_modules/library/source3.ts' as Platform.CitizenNotesPath.UrlString;
const sourceMapFolderUrl = 'http://a.b.c/myapp' as Platform.CitizenNotesPath.UrlString;
const sourceMapFile1Url = 'http://a.b.c/myapp/file1.ts' as Platform.CitizenNotesPath.UrlString;
const sourceMapFile2Url = 'http://a.b.c/myapp/file2.ts' as Platform.CitizenNotesPath.UrlString;
...
describeWithMockConnection('IgnoreListManager', () => {
  ...
  //  </html>
  //
  const url = 'http://example.com/index.html' as Platform.CitizenNotesPath.UrlString;
  const webpackUrl = 'webpack:///src/subfolder/foo.js' as Platform.CitizenNotesPath.UrlString;
  const webpackFolderUrl = 'webpack:///src' as Platform.CitizenNotesPath.UrlString;
  const webpackSubfolderUrl = 'webpack:///src/subfolder' as Platform.CitizenNotesPath.UrlString;
  const contentScriptFolderUrl = 'chrome-extension://abc' as Platform.CitizenNotesPath.UrlString;
  const contentScriptUrl = 'chrome-extension://abc/content.js' as Platform.CitizenNotesPath.UrlString;
  const SCRIPTS = [
    {
  ...
  function getFolderContextMenu(url: Platform.CitizenNotesPath.UrlString):
      {items: Array<string>, callbacks: Map<string, () => void>} {
    const items: Array<string> = [];
    const callbacks: Map<string, () => void> = new Map();
    const workspace = Workspace.Workspace.WorkspaceImpl.instance();
  ...
  describe('isUserOrSourceMapIgnoreListedUISourceCode', () => {
    it('ignores UISourceCodes that are marked', () => {
      const {uiSourceCode} = createContentProviderUISourceCode({
        url: 'debugger://foo' as Platform.CitizenNotesPath.UrlString,
