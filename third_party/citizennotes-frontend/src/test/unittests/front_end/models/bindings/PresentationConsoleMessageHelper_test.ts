...
async function addUISourceCode(
    ...
    url: Platform.CitizenNotesPath.UrlString): Promise<Workspace.UISourceCode.UISourceCode> {
...
describeWithMockConnection('PresentationConsoleMessageHelper', () => {
  const url = 'http://example.test/test.css' as Platform.CitizenNotesPath.UrlString;
