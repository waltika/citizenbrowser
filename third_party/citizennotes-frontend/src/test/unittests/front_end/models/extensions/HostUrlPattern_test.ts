...
describe('HostUrlPattern', () => {
  ...
  it('Matches all pages for a given scheme', () => {
    ...
    assert.isTrue(pattern.matchesUrl('http://google.com' as Platform.CitizenNotesPath.UrlString));
    assert.isTrue(pattern.matchesUrl('http://yahoo.com' as Platform.CitizenNotesPath.UrlString));
    assert.isTrue(pattern.matchesUrl('http://google.com/foo' as Platform.CitizenNotesPath.UrlString));
    assert.isFalse(pattern.matchesUrl('https://google.com' as Platform.CitizenNotesPath.UrlString));
    assert.isTrue(pattern.matchesUrl('http://74.125.127.100/search' as Platform.CitizenNotesPath.UrlString));
  });
  ...
  it('Matches all domains', () => {
    ...
    assert.strictEqual('*', pattern.host);
    assert.isFalse(pattern.matchesAllUrls());
    assert.isTrue(pattern.matchesUrl('https://www.google.com/foo' as Platform.CitizenNotesPath.UrlString));
    assert.isTrue(pattern.matchesUrl('https://www.google.com/foobar' as Platform.CitizenNotesPath.UrlString));
    assert.isFalse(pattern.matchesUrl('http://www.google.com/foo' as Platform.CitizenNotesPath.UrlString));
    assert.isTrue(pattern.matchesUrl('https://www.google.com/' as Platform.CitizenNotesPath.UrlString));
  });
  ...
  it('Matches subdomains', () => {
    ...
    assert.isFalse(pattern.matchesAllUrls());
    assert.isTrue(pattern.matchesUrl('http://google.com/foobar' as Platform.CitizenNotesPath.UrlString));
    assert.isTrue(pattern.matchesUrl('http://www.google.com/foobar' as Platform.CitizenNotesPath.UrlString));
    assert.isTrue(pattern.matchesUrl('http://www.google.com/foo?bar' as Platform.CitizenNotesPath.UrlString));
    assert.isFalse(pattern.matchesUrl('http://wwwgoogle.com/foobar' as Platform.CitizenNotesPath.UrlString));
    assert.isTrue(pattern.matchesUrl('http://monkey.images.google.com/foooobar' as Platform.CitizenNotesPath.UrlString));
    assert.isFalse(pattern.matchesUrl('http://yahoo.com/foobar' as Platform.CitizenNotesPath.UrlString));
  });
  ...
  it('Matches ip addresses', () => {
    ...
    assert.isFalse(pattern.matchesAllUrls());
    assert.isTrue(pattern.matchesUrl('http://127.0.0.1' as Platform.CitizenNotesPath.UrlString));
  });
  ...
  it('Matches subdomain matching with ip addresses', () => {
    ...
    assert.isFalse(pattern.matchesAllUrls());
    assert.isFalse(pattern.matchesUrl('http://127.0.0.1' as Platform.CitizenNotesPath.UrlString));
  });
  ...
  it('Matches chrome://', () => {
    ...
    assert.isFalse(pattern.matchesAllUrls());
    assert.isTrue(pattern.matchesUrl('chrome://favicon/http://google.com' as Platform.CitizenNotesPath.UrlString));
    assert.isTrue(pattern.matchesUrl('chrome://favicon/https://google.com' as Platform.CitizenNotesPath.UrlString));
    assert.isFalse(pattern.matchesUrl('chrome://history' as Platform.CitizenNotesPath.UrlString));
  });
  ...
  it('Matches *://', () => {
    ...
    assert.isFalse(pattern.matchesAllUrls());
    assert.isTrue(pattern.matchesUrl('http://127.0.0.1' as Platform.CitizenNotesPath.UrlString));
    assert.isFalse(pattern.matchesUrl('chrome://favicon/http://google.com' as Platform.CitizenNotesPath.UrlString));
    assert.isFalse(pattern.matchesUrl('file:///foo/bar' as Platform.CitizenNotesPath.UrlString));
    assert.isFalse(pattern.matchesUrl('file://localhost/foo/bar' as Platform.CitizenNotesPath.UrlString));
  });
  ...
  it('Matches <all_urls>', () => {
    ...
    assert.isTrue(pattern.matchesUrl('chrome://favicon/http://google.com' as Platform.CitizenNotesPath.UrlString));
    assert.isTrue(pattern.matchesUrl('http://127.0.0.1' as Platform.CitizenNotesPath.UrlString));
    assert.isTrue(pattern.matchesUrl('file:///foo/bar' as Platform.CitizenNotesPath.UrlString));
    assert.isTrue(pattern.matchesUrl('file://localhost/foo/bar' as Platform.CitizenNotesPath.UrlString));
  });
  ...
  it('Matches SCHEME_ALL matches all schemes.', () => {
    ...
    assert.isTrue(pattern.matchesUrl('file:///foo/bar' as Platform.CitizenNotesPath.UrlString));
    assert.isTrue(pattern.matchesUrl('file://localhost/foo/bar' as Platform.CitizenNotesPath.UrlString));
    assert.isTrue(pattern.matchesUrl('chrome://newtab' as Platform.CitizenNotesPath.UrlString));
    assert.isTrue(pattern.matchesUrl('about:blank' as Platform.CitizenNotesPath.UrlString));
    assert.isTrue(pattern.matchesUrl('about:version' as Platform.CitizenNotesPath.UrlString));
    assert.isTrue(
        pattern.matchesUrl('data:text/html;charset=utf-8,<html>asdf</html>' as Platform.CitizenNotesPath.UrlString));
  });

  it('Doesn\'t Match Invalid', () => {
    const pattern = Extensions.HostUrlPattern.HostUrlPattern.parse('<all_urls>');
    Platform.assertNotNullOrUndefined(pattern);
    assert.isFalse(pattern.matchesUrl('http:' as Platform.CitizenNotesPath.UrlString));
  });
  ...
  it('Matches SCHEME_ALL and specific schemes.', () => {
    ...
    for (const {pattern, matches} of urlPatternTestCases) {
      const parsedPattern = Extensions.HostUrlPattern.HostUrlPattern.parse(pattern);
      Platform.assertNotNullOrUndefined(parsedPattern);
      assert.isTrue(parsedPattern.matchesUrl(matches as Platform.CitizenNotesPath.UrlString));
    }
  });
  ...
  it('Matches Specific port', () => {
    ...
    assert.isTrue(pattern.matchesUrl('http://www.example.com:80/foo' as Platform.CitizenNotesPath.UrlString));
    assert.isTrue(pattern.matchesUrl('http://www.example.com/foo' as Platform.CitizenNotesPath.UrlString));
    assert.isFalse(pattern.matchesUrl('http://www.example.com:8080/foo' as Platform.CitizenNotesPath.UrlString));
  });
  ...
  it('Matches Explicit port wildcard', () => {
    ...
    assert.isTrue(pattern.matchesUrl('http://www.example.com:80/foo' as Platform.CitizenNotesPath.UrlString));
    assert.isTrue(pattern.matchesUrl('http://www.example.com/foo' as Platform.CitizenNotesPath.UrlString));
    assert.isTrue(pattern.matchesUrl('http://www.example.com:8080/foo' as Platform.CitizenNotesPath.UrlString));
  });
  ...
  it('Matches chrome-extension://', () => {
    ...
    assert.isFalse(pattern.matchesAllUrls());
    assert.isTrue(pattern.matchesUrl('chrome-extension://ftw' as Platform.CitizenNotesPath.UrlString));
    assert.isTrue(pattern.matchesUrl('chrome-extension://ftw/http://google.com' as Platform.CitizenNotesPath.UrlString));
    assert.isTrue(pattern.matchesUrl('chrome-extension://ftw/https://google.com' as Platform.CitizenNotesPath.UrlString));
    assert.isFalse(pattern.matchesUrl('chrome-extension://foobar' as Platform.CitizenNotesPath.UrlString));
  });
  ...
  it('Ignore Ports', () => {
    ...
    assert.isFalse(pattern.matchesUrl('http://www.example.com:1234/foo' as Platform.CitizenNotesPath.UrlString));
  });

  it('Trailing Dot Domain', () => {
    const normalDomain = 'http://example.com/' as Platform.CitizenNotesPath.UrlString;
    const trailingDotDomain = 'http://example.com./' as Platform.CitizenNotesPath.UrlString;
  ...
  it('URLPattern properly canonicalizes uncanonicalized hosts', () => {
    ...
    Platform.assertNotNullOrUndefined(pattern);
    assert.isTrue(pattern.matchesUrl('https://google.com' as Platform.CitizenNotesPath.UrlString));
    assert.isTrue(pattern.matchesUrl('https://maps.google.com' as Platform.CitizenNotesPath.UrlString));
    assert.isFalse(pattern.matchesUrl('https://example.com' as Platform.CitizenNotesPath.UrlString));
    ...
    assert.isFalse(pattern2.matchesUrl('https://google.com' as Platform.CitizenNotesPath.UrlString));
    assert.isTrue(pattern2.matchesUrl(`https://${canonicalizedHost}/` as Platform.CitizenNotesPath.UrlString));
