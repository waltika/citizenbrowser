...
describe('issuesAssociatedWith', () => {
  ...
  it('should return no issues if no issues exist', () => {
    const request = SDK.NetworkRequest.NetworkRequest.create(
        requestId1, Platform.CitizenNotesPath.EmptyUrlString, Platform.CitizenNotesPath.EmptyUrlString, null, null, null);
  ...
  it('should correctly filter issues associated with a given request id', () => {
    ...
    const request2 = SDK.NetworkRequest.NetworkRequest.create(
        requestId2, Platform.CitizenNotesPath.EmptyUrlString, Platform.CitizenNotesPath.EmptyUrlString, null, null, null);
