...
function url(input: string): Platform.CitizenNotesPath.UrlString {
  return input as unknown as Platform.CitizenNotesPath.UrlString;
}
  ...
  describe('initiatorInfoForRequest', () => {
    ...
    it('uses the passed in initiator info if it exists', () => {
      ...
      assert.deepEqual(info, {
        ...
        url: Platform.CitizenNotesPath.EmptyUrlString,
  ...
  it('clears on main frame navigation', () => {
    ...
    const navigateTarget = (target: SDK.Target.Target) => {
      ...
      const frame = {
        ...
        unreachableUrl: () => Platform.CitizenNotesPath.EmptyUrlString,
