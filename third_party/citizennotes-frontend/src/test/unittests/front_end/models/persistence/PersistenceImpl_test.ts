...
describeWithMockConnection('PersistenceImpl', () => {
  ...
  const SCRIPT_DESCRIPTION = {
    url: 'http://www.google.com/script.js' as Platform.CitizenNotesPath.UrlString,
  ...
  it('moves breakpoint from file system uiSourceCode to the network uiSourceCode when binding is created', async () => {
    ...
    const fileSystemFileUrl = fileSystemPath + '/script.js' as Platform.CitizenNotesPath.UrlString;
  ...
  // Replaces web test: http/tests/citizennotes/persistence/automapping-bind-committed-network-sourcecode.js
  it('it marks the filesystem UISourceCode dirty when the network UISourceCode was committed before the binding was established',
     async () => {
       const url = 'https://example.com/script.js' as Platform.CitizenNotesPath.UrlString;
       ...
       const localUrl = 'file:///var/www/script.js' as Platform.CitizenNotesPath.UrlString;
