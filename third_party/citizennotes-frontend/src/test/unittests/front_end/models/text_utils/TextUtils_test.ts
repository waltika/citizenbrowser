...
describe('TextUtils', () => {
  ...
  describe('FilterParser', () => {
    ...
    describe('parse', () => {
      ...
      // Ported from a web test: http/tests/citizennotes/unit/parse-filter-query.js
...
function isMinified(text) {
    ...
    return (text.length - lineCount) / lineCount >= 80;
      ...
      // in go/chrome-citizennotes:indentation-markers-proposal
      assert.strictEqual(
...
export class ApiProxy {
    constructor(plugin, hook) {
        ...
        const localSettingsSaveId = \`__vue-citizennotes-plugin-settings__\${plugin.id}\`;
