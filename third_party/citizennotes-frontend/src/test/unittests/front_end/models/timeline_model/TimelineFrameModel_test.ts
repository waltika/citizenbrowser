...
describeWithMockConnection('TimelineFrameModel', () => {
  ...
  describe('LayerPaintEvent', () => {
    beforeEach(() => {
      // https://chromecitizennotes.github.io/citizennotes-protocol/tot/LayerTree/#method-loadSnapshot
    ...
    function setupLayerPaintEvent(): {
      ...
      const fakePaintEvent = makeFakeSDKEventFromPayload({
        ...
        categories: ['citizennotes.timeline', 'rail'],
        args: {
          data: {
            layerId: 'layer-1',
          },
      ...
      const pictureEventPayload = makeFakeEventPayload({
        ...
        ts: 999,
        categories: ['disabled-by-default-citizennotes.timeline.picture'],
        args: {
          snapshot: {
