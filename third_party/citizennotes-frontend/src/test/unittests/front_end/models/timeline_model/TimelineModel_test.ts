...
class TrackSummary {
  ...
  url: Platform.CitizenNotesPath.UrlString = Platform.CitizenNotesPath.EmptyUrlString;
  threadName: string = '';
  threadId: number = -1;
  processId: number = -1;
  processName: string = '';
...
describeWithEnvironment('TimelineModel', function() {
  ...
  describe('style invalidations', function() {
     ...
     * https://github.com/ChromeCitizenNotes/performance-stories/tree/main/style-invalidations.
