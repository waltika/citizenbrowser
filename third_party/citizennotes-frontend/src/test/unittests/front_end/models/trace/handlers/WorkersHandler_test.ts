...
describe('WorkersHandler', () => {
    ...
    assert.deepEqual(data.workerSessionIdEvents, [
      {
        ...
        cat: 'disabled-by-default-citizennotes.timeline',
        ...
        args: {
          data: {
            ...
            url: 'https://chromecitizennotes.github.io/performance-stories/two-workers/fib-worker.js',
  ...
  it('collects the url of workers', async function() {
    ...
    assert.strictEqual(worker1, 'https://chromecitizennotes.github.io/performance-stories/two-workers/fib-worker.js');
    assert.strictEqual(thread2, 'E59E70C44C7664657CE822BB7DC54085');
    assert.strictEqual(worker2, 'https://chromecitizennotes.github.io/performance-stories/two-workers/fib-worker.js');
  });
});
