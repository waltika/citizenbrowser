...
describeWithMockConnection('SharedStorageItemsView', function() {
  ...
  it('displays metadata and entries', async () => {
    ...
    const keys = getCleanTextContentFromElements(metadataView.shadowRoot, 'citizennotes-report-key');
    ...
    const values = getCleanTextContentFromElements(metadataView.shadowRoot, 'citizennotes-report-value');
