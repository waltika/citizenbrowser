  ...
  const tests = (targetFactory: () => SDK.Target.Target) => {
    ...
    beforeEach(() => {
      ...
      resourceTreeModel.mainFrame = {
        url: 'https://www.example.com/' as Platform.CitizenNotesPath.UrlString,
    ...
    it('renders status if restored from BFCache', async () => {
      ...
      assertShadowRoot(component.shadowRoot);
      const renderedStatus = component.shadowRoot.querySelector('citizennotes-report-section');
    ...
    it('renders explanations if not restorable from BFCache', async () => {
      ...
      const sectionHeaders = component.shadowRoot.querySelectorAll('citizennotes-report-section-header');
      ...
      const sections = component.shadowRoot.querySelectorAll('citizennotes-report-section');
    ...
    it('renders explanation tree', async () => {
      ...
      const treeOutline = component.shadowRoot.querySelector('citizennotes-tree-outline');
    ...
    it('renders blocking details if available', async () => {
      ...
      const details = component.shadowRoot.querySelector('.details-list citizennotes-expandable-list');
      ...
      button.click();
      const items = details?.shadowRoot.querySelectorAll('.expandable-list-items .citizennotes-link');
    ...
    it('can handle delayed navigation history when testing for BFcache availability', async () => {
      ...
      resourceTreeModel.navigate = (url: Platform.CitizenNotesPath.UrlString): Promise<void> => {
