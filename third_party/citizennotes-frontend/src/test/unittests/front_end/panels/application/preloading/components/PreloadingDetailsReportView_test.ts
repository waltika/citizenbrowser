...
describeWithEnvironment('PreloadingDetailsReportView', async () => {
  ...
  it('renders prerendering details', async () => {
    const url = 'https://example.com/prerendered.html' as Platform.CitizenNotesPath.UrlString;
...
`,
      ...
      pageURL: 'https://example.com/' as Platform.CitizenNotesPath.UrlString,
    };
...
`,
  ...
  it('renders prefetch details with cancelled reason', async () => {
    ...
    const url = 'https://example.com/prefetch.html' as Platform.CitizenNotesPath.UrlString;
    const data: PreloadingComponents.PreloadingDetailsReportView.PreloadingDetailsReportViewData = {
      preloadingAttempt: {
...
`,
    ...
    const keys = getCleanTextContentFromElements(report, 'citizennotes-report-key');
    const values = getCleanTextContentFromElements(report, 'citizennotes-report-value');
    values[0] = report.querySelector('citizennotes-report-value:nth-of-type(1) citizennotes-request-link-icon')
