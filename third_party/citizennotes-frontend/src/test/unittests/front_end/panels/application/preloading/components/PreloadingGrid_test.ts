          ...
          rows: [{
            ...
            attempt: {
              ...
              key: {
                loaderId: 'loaderId:1' as Protocol.Network.LoaderId,
                action: Protocol.Preload.SpeculationAction.Prefetch,
                url: 'https://cross-origin.example.com/prefetched.html' as Platform.CitizenNotesPath.UrlString,
              },
              status: SDK.PreloadingModel.PreloadingStatus.Running,
              prefetchStatus: null,
              requestId: 'requestId:1' as Protocol.Network.RequestId,
          ...
          rows: [
            {
              ...
              attempt: {
                ...
                key: {
                  loaderId: 'loaderId:1' as Protocol.Network.LoaderId,
                  action: Protocol.Preload.SpeculationAction.Prefetch,
                  url: 'https://example.com/rule-set-missing.html' as Platform.CitizenNotesPath.UrlString,
                },
                status: SDK.PreloadingModel.PreloadingStatus.Running,
                prefetchStatus: null,
                requestId: 'requestId:1' as Protocol.Network.RequestId,
            ...
            },
            {
              ...
              attempt: {
                ...
                key: {
                  loaderId: 'loaderId:1' as Protocol.Network.LoaderId,
                  action: Protocol.Preload.SpeculationAction.Prefetch,
                  url: 'https://example.com/multiple-rule-sets.html' as Platform.CitizenNotesPath.UrlString,
                },
                status: SDK.PreloadingModel.PreloadingStatus.Running,
                prefetchStatus: null,
