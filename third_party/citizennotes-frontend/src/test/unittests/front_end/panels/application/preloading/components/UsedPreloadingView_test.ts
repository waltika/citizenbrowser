...
describeWithEnvironment('UsedPreloadingView', async () => {
  it('renderes prefetch used', async () => {
    const data: PreloadingComponents.UsedPreloadingView.UsedPreloadingViewData = {
      pageURL: 'https://example.com/prefetched.html' as Platform.CitizenNotesPath.UrlString,
      previousAttempts: [
        {
          ...
          key: {
            ...
            action: Protocol.Preload.SpeculationAction.Prefetch,
            url: 'https://example.com/prefetched.html' as Platform.CitizenNotesPath.UrlString,
          },
        ...
        },
        {
          ...
          key: {
            loaderId: 'loaderId:1' as Protocol.Network.LoaderId,
            action: Protocol.Preload.SpeculationAction.Prerender,
            url: 'https://example.com/prerendered.html' as Platform.CitizenNotesPath.UrlString,
          },
    ...
    const headers = getElementsWithinComponent(
        component, 'citizennotes-report citizennotes-report-section-header', ReportView.ReportView.ReportSectionHeader);
    const sections = getElementsWithinComponent(
        component, 'citizennotes-report citizennotes-report-section', ReportView.ReportView.ReportSection);
  ...
  it('renderes prerender used', async () => {
    const data: PreloadingComponents.UsedPreloadingView.UsedPreloadingViewData = {
      pageURL: 'https://example.com/prerendered.html' as Platform.CitizenNotesPath.UrlString,
      previousAttempts: [
        {
          action: Protocol.Preload.SpeculationAction.Prefetch,
          key: {
  ...
  it('renderes prerender failed due to header mismatch', async () => {
    ...
    const grid = getElementWithinComponent(
        component, 'citizennotes-resources-preloading-mismatched-headers-grid',
  ...
  it('renderes prerender -> prefetch downgraded and used', async () => {
    const data: PreloadingComponents.UsedPreloadingView.UsedPreloadingViewData = {
      pageURL: 'https://example.com/downgraded.html' as Platform.CitizenNotesPath.UrlString,
      previousAttempts: [
        {
          action: Protocol.Preload.SpeculationAction.Prefetch,
          key: {
            loaderId: 'loaderId:1' as Protocol.Network.LoaderId,
            action: Protocol.Preload.SpeculationAction.Prefetch,
            url: 'https://example.com/downgraded.html' as Platform.CitizenNotesPath.UrlString,
          },
          status: SDK.PreloadingModel.PreloadingStatus.Success,
          prefetchStatus: null,
          requestId: 'requestId:1' as Protocol.Network.RequestId,
  ...
  it('renders no preloading attempts used', async () => {
    const data: PreloadingComponents.UsedPreloadingView.UsedPreloadingViewData = {
      pageURL: 'https://example.com/no-preloads.html' as Platform.CitizenNotesPath.UrlString,
      previousAttempts: [],
      currentAttempts: [],
    };
  ...
  it('ignores hash part of URL for prefetch', async () => {
    const data: PreloadingComponents.UsedPreloadingView.UsedPreloadingViewData = {
      pageURL: 'https://example.com/prefetched.html#alpha' as Platform.CitizenNotesPath.UrlString,
      previousAttempts: [
        {
          action: Protocol.Preload.SpeculationAction.Prefetch,
          key: {
            loaderId: 'loaderId:1' as Protocol.Network.LoaderId,
            action: Protocol.Preload.SpeculationAction.Prefetch,
            url: 'https://example.com/prefetched.html#beta' as Platform.CitizenNotesPath.UrlString,
          },
          status: SDK.PreloadingModel.PreloadingStatus.Success,
          prefetchStatus: null,
          requestId: 'requestId:1' as Protocol.Network.RequestId,
  ...
  it('doesn\'t ignore hash part of URL for prerender', async () => {
    ...
    const data: PreloadingComponents.UsedPreloadingView.UsedPreloadingViewData = {
      pageURL: 'https://example.com/prerendered.html#alpha' as Platform.CitizenNotesPath.UrlString,
      previousAttempts: [
        {
          action: Protocol.Preload.SpeculationAction.Prerender,
          key: {
            loaderId: 'loaderId:1' as Protocol.Network.LoaderId,
            action: Protocol.Preload.SpeculationAction.Prerender,
            url: 'https://example.com/prerendered.html#beta' as Platform.CitizenNotesPath.UrlString,
          },
          status: SDK.PreloadingModel.PreloadingStatus.Ready,
          prerenderStatus: null,
          disallowedMojoInterface: null,
    ...
    const grid = sections[2].querySelector('citizennotes-resources-mismatched-preloading-grid');
  ...
  it('renders no preloading attempts used with mismatch', async () => {
    ...
    assert.include(headers[2]?.textContent, 'URLs being speculatively loaded by the initiating page');
    assertNotNullOrUndefined(sections[2].querySelector('citizennotes-resources-mismatched-preloading-grid'));
      ...
      currentAttempts: [
        {
          ...
          key: {
            loaderId: 'loaderId:1' as Protocol.Network.LoaderId,
            action: Protocol.Preload.SpeculationAction.Prefetch,
            url: 'https://example.com/prefetch-not-triggered.html' as Platform.CitizenNotesPath.UrlString,
          },
        ...
        },
        {
          ...
          key: {
            loaderId: 'loaderId:1' as Protocol.Network.LoaderId,
            action: Protocol.Preload.SpeculationAction.Prefetch,
            url: 'https://example.com/prefetch-running.html' as Platform.CitizenNotesPath.UrlString,
          },
        ...
        },
        {
          ...
          key: {
            loaderId: 'loaderId:1' as Protocol.Network.LoaderId,
            action: Protocol.Preload.SpeculationAction.Prefetch,
            url: 'https://example.com/prefetch-ready.html' as Platform.CitizenNotesPath.UrlString,
          },
          status: SDK.PreloadingModel.PreloadingStatus.Ready,
          prefetchStatus: null,
        ...
        },
        {
          ...
          key: {
            loaderId: 'loaderId:1' as Protocol.Network.LoaderId,
            action: Protocol.Preload.SpeculationAction.Prefetch,
            url: 'https://example.com/prefetch-failure.html' as Platform.CitizenNotesPath.UrlString,
          },
          status: SDK.PreloadingModel.PreloadingStatus.Failure,
          prefetchStatus: null,
        ...
        },
        {
          ...
          key: {
            loaderId: 'loaderId:1' as Protocol.Network.LoaderId,
            action: Protocol.Preload.SpeculationAction.Prerender,
            url: 'https://example.com/prerender-pending.html' as Platform.CitizenNotesPath.UrlString,
          },
        ...
        },
        {
          ...
          key: {
            loaderId: 'loaderId:1' as Protocol.Network.LoaderId,
            action: Protocol.Preload.SpeculationAction.Prerender,
            url: 'https://example.com/prerender-ready.html' as Platform.CitizenNotesPath.UrlString,
          },
          status: SDK.PreloadingModel.PreloadingStatus.Ready,
          prerenderStatus: null,
          mismatchedHeaders: null,
