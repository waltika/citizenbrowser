...
describeWithRealConnection('StylePropertyTreeElement', async () => {
  ...
  describe('updateTitle', () => {
    it('timing swatch, shadow swatch and length swatch are not shown for longhands expanded inside shorthands',
       async () => {
         ...
         assertNullSwatchOnChildAt(3, 'citizennotes-css-length');
       });
    ...
    describe('color-mix swatch', () => {
      it('should show color mix swatch when color-mix is used with a color', () => {
        ...
        const colorMixSwatch = stylePropertyTreeElement.valueElement?.querySelector('citizennotes-color-mix-swatch');
        const colorSwatches =
            Array.from(stylePropertyTreeElement.valueElement?.querySelectorAll('citizennotes-color-swatch') || []);
      ...
      it('should show color mix swatch when color-mix is used with a known variable as color', () => {
        ...
        const cssVarSwatches =
            Array.from(stylePropertyTreeElement.valueElement?.querySelectorAll('citizennotes-css-var-swatch') || []);
        assertNotNullOrUndefined(colorMixSwatch);
    ...
    describe('animation-name', () => {
      it('should link-swatch be rendered for animation-name declaration', () => {
        ...
        const animationNameSwatch = stylePropertyTreeElement.valueElement?.querySelector('citizennotes-link-swatch');
      ...
      it('should two link-swatches be rendered for animation-name declaration that contains two keyframe references',
         () => {
           ...
           const animationNameSwatches =
               stylePropertyTreeElement.valueElement?.querySelectorAll('citizennotes-link-swatch');
  ...
  describe('CSSVarSwatch', () => {
    it('should render a CSSVarSwatch for variable usage without fallback', () => {
      ...
      const cssVarSwatch = stylePropertyTreeElement.valueElement?.querySelector('citizennotes-css-var-swatch');
      assertNotNullOrUndefined(cssVarSwatch);

      const linkSwatch = cssVarSwatch.shadowRoot?.querySelector('citizennotes-base-link-swatch');
    ...
    it('should render a CSSVarSwatch inside CSSVarSwatch for variable usage with another variable fallback', () => {
      ...
      const firstLinkSwatch = cssVarSwatch.shadowRoot?.querySelector('citizennotes-base-link-swatch');
      const insideCssVarSwatch = cssVarSwatch.shadowRoot?.querySelector('citizennotes-css-var-swatch');
      const secondLinkSwatch = insideCssVarSwatch?.shadowRoot?.querySelector('citizennotes-base-link-swatch');
    ...
    it('should render a CSSVarSwatch inside CSSVarSwatch for variable usage with color but not render color swatch',
       () => {
         ...
         const colorSwatch = cssVarSwatch.shadowRoot?.querySelector('citizennotes-color-swatch');
    ...
    it('should render CSSVarSwatches for multiple var() usages in the same property declaration', () => {
      ...
      const cssVarSwatches = stylePropertyTreeElement.valueElement?.querySelectorAll('citizennotes-css-var-swatch');
