...
describeWithLocale('PromptBuilder', () => {
  ...
  const NETWORK_REQUEST = {
    url() {
      return 'https://example.com' as Platform.CitizenNotesPath.UrlString;
    },
    requestHeaders() {
      return [{
        name: 'Origin',
...
Response status: 404 Not found`);
  ...
  describeWithMockConnection('buildPrompt', () => {
    ...
    const PREAMBLE = `You are an expert software engineer looking at a console message in CitizenNotes.
