...
describeWithEnvironment('NetworkLogView', () => {
  ...
  it('show media icon', async () => {
    const request = SDK.NetworkRequest.NetworkRequest.create(
        ...
        'https://www.example.com/test.mp3' as Platform.CitizenNotesPath.UrlString, '' as Platform.CitizenNotesPath.UrlString,
        null, null, null);
  ...
  it('show wasm icon', async () => {
    const request = SDK.NetworkRequest.NetworkRequest.create(
        'requestId' as Protocol.Network.RequestId,
        'https://www.example.com/test.wasm' as Platform.CitizenNotesPath.UrlString, '' as Platform.CitizenNotesPath.UrlString,
        null, null, null);
  ...
  it('show websocket icon', async () => {
    const request = SDK.NetworkRequest.NetworkRequest.create(
        'requestId' as Protocol.Network.RequestId, 'https://www.example.com/ws' as Platform.CitizenNotesPath.UrlString,
        '' as Platform.CitizenNotesPath.UrlString, null, null, null);
  ...
  it('shows fetch icon', async () => {
    const request = SDK.NetworkRequest.NetworkRequest.create(
        'requestId' as Protocol.Network.RequestId,
        'https://www.example.com/test.json?keepalive=false' as Platform.CitizenNotesPath.UrlString,
        '' as Platform.CitizenNotesPath.UrlString, null, null, null);
  ...
  it('mime win: show image preview icon for xhr-image', async () => {
    const request = SDK.NetworkRequest.NetworkRequest.create(
        'requestId' as Protocol.Network.RequestId,
        'https://www.example.com/test.svg' as Platform.CitizenNotesPath.UrlString, '' as Platform.CitizenNotesPath.UrlString,
        null, null, null);
    request.setResourceType(Common.ResourceType.resourceTypes.XHR);
  ...
  it('mime win: show document icon for fetch-html', async () => {
    const request = SDK.NetworkRequest.NetworkRequest.create(
        'requestId' as Protocol.Network.RequestId, 'https://www.example.com/page' as Platform.CitizenNotesPath.UrlString,
        '' as Platform.CitizenNotesPath.UrlString, null, null, null);
    request.setResourceType(Common.ResourceType.resourceTypes.Fetch);
  ...
  it('mime win: show generic icon for preflight-text', async () => {
    const request = SDK.NetworkRequest.NetworkRequest.create(
        'requestId' as Protocol.Network.RequestId,
        'https://www.example.com/api/test' as Platform.CitizenNotesPath.UrlString, '' as Platform.CitizenNotesPath.UrlString,
        null, null, null);
  ...
  it('mime win: show script icon for other-javascript)', async () => {
    const request = SDK.NetworkRequest.NetworkRequest.create(
        'requestId' as Protocol.Network.RequestId, 'https://www.example.com/ping' as Platform.CitizenNotesPath.UrlString,
        '' as Platform.CitizenNotesPath.UrlString, null, null, null);
  ...
  it('mime win: shows json icon for fetch-json', async () => {
    const request = SDK.NetworkRequest.NetworkRequest.create(
        'requestId' as Protocol.Network.RequestId,
        'https://www.example.com/api/list' as Platform.CitizenNotesPath.UrlString, '' as Platform.CitizenNotesPath.UrlString,
        null, null, null);
    request.setResourceType(Common.ResourceType.resourceTypes.Fetch);
