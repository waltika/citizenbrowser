...
describeWithLocale('NetworkSearchScope', () => {
  ...
  beforeEach(() => {
    const fakeRequest1 = SDK.NetworkRequest.NetworkRequest.createWithoutBackendRequest(
        'fakeId1', 'http://example.com/main.js' as Platform.CitizenNotesPath.UrlString,
        'http://example.com/index.html' as Platform.CitizenNotesPath.UrlString, null);
    ...
    const fakeRequest2 = SDK.NetworkRequest.NetworkRequest.createWithoutBackendRequest(
        'fakeId1', 'http://example.com/bundle.min.js' as Platform.CitizenNotesPath.UrlString,
        'http://example.com/index.html' as Platform.CitizenNotesPath.UrlString, null);
