...
describe('FilePathScoreFunction', () => {
  describe('score', () => {
    ...
    it('should match highlights and score', () => {
      // ported from third_party/blink/web_tests/http/tests/citizennotes/components/file-path-scoring.js
      const testQueries = [
        ['textepl', './Source/citizennotes/front_end/TextEditor.pl'],
        ['defted', './Source/citizennotes/front_end/DefaultTextEditor.pl'],
        ['CMTE', './Source/citizennotes/front_end/CodeMirrorTextEditor.pl'],
        ['frocmte', './Source/citizennotes/front_end/CodeMirrorTextEditor.pl'],
        ['cmtepl', './Source/citizennotes/front_end/CodeMirrorTextEditor.pl'],
        ['setscr', './Source/citizennotes/front_end/SettingsScreen.pl'],
        ['cssnfv', './Source/citizennotes/front_end/CSSNamedFlowView.pl'],
        ['jssf', './Source/citizennotes/front_end/JavaScriptSourceFrame.pl'],
        ['sofrapl', './Source/citizennotes/front_end/SourceFrame.pl'],
        ['inspeins', './Source/core/inspector/InspectorInstrumentation.z'],
        ['froscr', './Source/citizennotes/front_end/Script.pl'],
        ['adscon', './Source/citizennotes/front_end/AdvancedSearchController.pl'],
