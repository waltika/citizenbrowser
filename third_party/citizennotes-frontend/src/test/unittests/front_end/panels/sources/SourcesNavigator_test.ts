...
describeWithMockConnection('NetworkNavigatorView', () => {
  ...
  const revealMainTarget = (targetFactory: () => SDK.Target.Target) => {
    ...
    beforeEach(async () => {
      ...
      ({project} = createContentProviderUISourceCodes({
         items: [
           {url: 'http://example.com/' as Platform.CitizenNotesPath.UrlString, mimeType: 'text/html'},
           {url: 'http://example.com/favicon.ico' as Platform.CitizenNotesPath.UrlString, mimeType: 'image/x-icon'},
           {url: 'http://example.com/gtm.js' as Platform.CitizenNotesPath.UrlString, mimeType: 'application/javascript'},
         ],
    ...
    it('does not show XHR and Fetch requests', async () => {
      const {project} = createContentProviderUISourceCodes({
        items: [
          {
            url: 'http://example.com/list-xhr.json' as Platform.CitizenNotesPath.UrlString,
            mimeType: 'application/json',
            resourceType: Common.ResourceType.resourceTypes.XHR,
          },
          {
            url: 'http://example.com/list-fetch.json' as Platform.CitizenNotesPath.UrlString,
            mimeType: 'application/json',
    ...
    it('reveals main frame target on navigation', async () => {
      ...
      target.setInspectedURL('http://example.com/' as Platform.CitizenNotesPath.UrlString);
  ...
  it('updates in scope change', () => {
    ...
    const {project: anotherProject} = createContentProviderUISourceCodes({
      items: [
        {url: 'http://example.org/' as Platform.CitizenNotesPath.UrlString, mimeType: 'text/html'},
        {url: 'http://example.org/background.bmp' as Platform.CitizenNotesPath.UrlString, mimeType: 'image/x-icon'},
      ],
  ...
  describe('removing source codes selection throttling', () => {
    ...
    it('selects just once when removing multiple sibling source codes', () => {
      const {project} = createContentProviderUISourceCodes({
        items: [
          {url: 'http://example.com/a.js' as Platform.CitizenNotesPath.UrlString, mimeType: 'application/javascript'},
          {url: 'http://example.com/b.js' as Platform.CitizenNotesPath.UrlString, mimeType: 'application/javascript'},
        ],
        projectType: Workspace.Workspace.projectTypes.Network,
        target,
      });
      const {project: otherProject} = createContentProviderUISourceCodes({
        items: [
          {url: 'http://example.com/c.js' as Platform.CitizenNotesPath.UrlString, mimeType: 'application/javascript'},
        ],
        projectType: Workspace.Workspace.projectTypes.Network,
        projectId: 'other',
        target,
    ...
    it('selects sibling after removing folder children', async () => {
      const {project} = createContentProviderUISourceCodes({
        items: [
          {url: 'http://example.com/d/a.js' as Platform.CitizenNotesPath.UrlString, mimeType: 'application/javascript'},
          {url: 'http://example.com/d/b.js' as Platform.CitizenNotesPath.UrlString, mimeType: 'application/javascript'},
        ],
        projectType: Workspace.Workspace.projectTypes.Network,
        target,
      });
    ...
    it('selects sibling after removing individual folder children', async () => {
      const {project} = createContentProviderUISourceCodes({
        items: [
          {url: 'http://example.com/d/a.js' as Platform.CitizenNotesPath.UrlString, mimeType: 'application/javascript'},
          {url: 'http://example.com/e/b.js' as Platform.CitizenNotesPath.UrlString, mimeType: 'application/javascript'},
        ],
        projectType: Workspace.Workspace.projectTypes.Network,
        target,
      });
  ...
  describe('with ignore listing', async () => {
    ...
    it('shows folder with only ignore listed content as ignore listed', async () => {
      ...
      const {project} = createContentProviderUISourceCodes({
        items: [
          {
            url: 'http://example.com/ignored/a/a-hidden.js' as Platform.CitizenNotesPath.UrlString,
            mimeType: 'application/javascript',
          },
          {
            url: 'http://example.com/ignored/b/b-hidden.js' as Platform.CitizenNotesPath.UrlString,
            mimeType: 'application/javascript',
          },
          {
            url: 'http://example.com/mixed/a/a-hidden.js' as Platform.CitizenNotesPath.UrlString,
            mimeType: 'application/javascript',
          },
          {
            url: 'http://example.com/mixed/b/b.js' as Platform.CitizenNotesPath.UrlString,
            mimeType: 'application/javascript',
          },
        ],
        projectType: Workspace.Workspace.projectTypes.Network,
