...
describe('TabbedEditorContainer', () => {
  describe('HistoryItem', () => {
    ...
    const url = 'http://localhost' as Platform.CitizenNotesPath.UrlString;
  ...
  describe('History', () => {
    ...
    describe('toObject', () => {
      it('serializes correctly', () => {
        const history = new History([
          new HistoryItem(
              'http://localhost/foo.js' as Platform.CitizenNotesPath.UrlString, Common.ResourceType.resourceTypes.Script),
          new HistoryItem(
              'webpack:///src/foo.vue' as Platform.CitizenNotesPath.UrlString,
              Common.ResourceType.resourceTypes.SourceMapScript, undefined, 5),
          new HistoryItem(
              'http://localhost/foo.js' as Platform.CitizenNotesPath.UrlString,
    ...
    describe('update', () => {
      it('moves items referenced by keys to the beginning', () => {
        ...
        history.update([{
          url: 'http://localhost/foo.js' as Platform.CitizenNotesPath.UrlString,
