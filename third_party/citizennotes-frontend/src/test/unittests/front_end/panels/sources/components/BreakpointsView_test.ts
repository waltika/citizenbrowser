...
function createLocationTestData(
  ...
  return {
    url: url as Platform.CitizenNotesPath.UrlString,
    lineNumber,
    columnNumber,
    enabled,
    content,
...
async function renderSingleBreakpoint(
  ...
  const data: SourcesComponents.BreakpointsView.BreakpointsViewData = {
    ...
    groups: [
      {
        name: 'test1.js',
        url: 'https://google.com/test1.js' as Platform.CitizenNotesPath.UrlString,
        editable: true,
        expanded: true,
        breakpointItems: [
          {
...
async function renderMultipleBreakpoints(): Promise<{
  ...
  const data: SourcesComponents.BreakpointsView.BreakpointsViewData = {
    ...
    groups: [
      ...
      {
        name: 'test2.js',
        url: 'https://google.com/test2.js' as Platform.CitizenNotesPath.UrlString,
        editable: false,
        expanded: true,
        breakpointItems: [
          {
      ...
      {
        name: 'main.js',
        url: 'https://test.com/main.js' as Platform.CitizenNotesPath.UrlString,
        editable: true,
        expanded: false,
        breakpointItems: [
          {
...
describeWithRealConnection('BreakpointsSidebarController', () => {
  ...
  it('auto-expands if a user adds a new  breakpoint', async () => {
    ...
    const {uiSourceCode, project} = createContentProviderUISourceCode(
        {url: 'test.js' as Platform.CitizenNotesPath.UrlString, mimeType: 'text/javascript'});
    const controller = SourcesComponents.BreakpointsView.BreakpointsSidebarController.instance(
        {forceNew: true, breakpointManager, settings});
...
describeWithMockConnection('BreakpointsView', () => {
  ...
  it('renders breakpoint groups with a differentiator if the file names are not unique', async () => {
    ...
    const groupTemplate = {
      name: 'index.js',
      url: '' as Platform.CitizenNotesPath.UrlString,
      editable: true,
      expanded: true,
      breakpointItems: [
        {
    ...
    group1.url = 'https://google.com/lib/index.js' as Platform.CitizenNotesPath.UrlString;

    const group2 = {...groupTemplate};
    group2.url = 'https://google.com/src/index.js' as Platform.CitizenNotesPath.UrlString;
