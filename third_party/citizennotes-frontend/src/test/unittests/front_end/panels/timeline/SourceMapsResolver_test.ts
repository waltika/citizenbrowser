...
describeWithMockConnection('SourceMapsResolver', () => {
  ...
  it('resolves function names using a plugin when available', async () => {
    ...
    class Plugin extends TestPlugin {
      ...
      override getFunctionInfo(_rawLocation: Chrome.CitizenNotes.RawLocation):
          Promise<{frames: Chrome.CitizenNotes.FunctionInfo[], missingSymbolFiles?: string[]|undefined}> {
