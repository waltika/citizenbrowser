...
describeWithEnvironment('ThreadAppender', function() {
  ...
  it('assigns correct names to worker threads', async function() {
    ...
    const expectedTrackNames = [
      'Main — https://chromecitizennotes.github.io/performance-stories/two-workers/index.html',
      'Worker — https://chromecitizennotes.github.io/performance-stories/two-workers/fib-worker.js',
      'Worker — https://chromecitizennotes.github.io/performance-stories/two-workers/fib-worker.js',
      'Thread Pool',
      'Thread Pool Worker 1',
      'Thread Pool Worker 2',
  ...
  it('does not append a track if there are no visible events on it', async function() {
    ...
    const expectedTrackNames = [
      'Main — https://chromecitizennotes.github.io/performance-stories/long-interaction/index.html?x=40',
      'Thread Pool',
  ...
  describe('ignore listing', () => {
    ...
    it('removes entries from the data that match the ignored URL', async function() {
      ...
      const SCRIPT_TO_IGNORE =
          'https://unpkg.com/react@18.2.0/umd/react.development.js' as Platform.CitizenNotesPath.UrlString;
    ...
    it('appends a tree that contains ignore listed entries correctly', async function() {
      const SCRIPT_TO_IGNORE = 'https://some-framework/bundled.js' as Platform.CitizenNotesPath.UrlString;
