...
const NAVIGATOR_SELECTOR = 'citizennotes-linear-memory-inspector-navigator';
const VIEWER_SELECTOR = 'citizennotes-linear-memory-inspector-viewer';
const INTERPRETER_SELECTOR = 'citizennotes-linear-memory-inspector-interpreter';
...
describeWithLocale('LinearMemoryInspector', () => {
  ...
  it('updates current address if user triggers a jumptopointeraddress event', () => {
    ...
    const display = getElementWithinComponent(
        interpreter, 'citizennotes-linear-memory-inspector-interpreter-display',
