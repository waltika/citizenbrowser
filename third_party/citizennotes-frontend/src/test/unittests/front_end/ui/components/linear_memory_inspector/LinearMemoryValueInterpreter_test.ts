...
const DISPLAY_SELECTOR = 'citizennotes-linear-memory-inspector-interpreter-display';
const SETTINGS_SELECTOR = 'citizennotes-linear-memory-inspector-interpreter-settings';
